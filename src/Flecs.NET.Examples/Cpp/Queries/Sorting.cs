...
public static unsafe class Cpp_Queries_Sorting
{
    public static void Main()
    {
        ...
        Entity e = world.Entity().Set<Position>(new Position(1, 0));
        world.Entity().Set<Position>(new Position(6, 0));
        world.Entity().Set<Position>(new Position(2, 0));
        world.Entity().Set<Position>(new Position(5, 0));
        world.Entity().Set<Position>(new Position(4, 0));
        ...
        e.Set<Position>(new Position(7, 0));
        ...
        world.Entity().Set<Position>(new Position(3, 0 ));
