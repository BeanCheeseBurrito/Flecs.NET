...
public unsafe class QueryTests
{
    ...
    private void EachManagedClass()
    {
        ...
        query.Each(static (Iter _, int _, ref ManagedClass component) => { Assert.Equal(10, component.Value); });
    }
    ...
    private void EachManagedStruct()
    {
        ...
        query.Each(static (Iter _, int _, ref ManagedStruct component) => { Assert.Equal(10, component.Value); });
    }
