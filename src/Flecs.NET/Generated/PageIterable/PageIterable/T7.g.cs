// /_/src/Flecs.NET/Generated/PageIterable/PageIterable/T7.g.cs
...
public unsafe partial struct PageIterable<T0, T1, T2, T3, T4, T5, T6> : IEquatable<PageIterable<T0, T1, T2, T3, T4, T5, T6>>
{
    ...
    public bool Equals(PageIterable<T0, T1, T2, T3, T4, T5, T6> other)
    {
    ...
    {
        return obj is PageIterable<T0, T1, T2, T3, T4, T5, T6> other && Equals(other);
    }
    ...
    public static bool operator ==(PageIterable<T0, T1, T2, T3, T4, T5, T6> left, PageIterable<T0, T1, T2, T3, T4, T5, T6> right)
    {
...
public unsafe partial struct PageIterable<T0, T1, T2, T3, T4, T5, T6> : IPageIterable
{
    ref PageIterable IPageIterable.Underlying => ref Underlying;
}

// IIterableBase Interface
public unsafe partial struct PageIterable<T0, T1, T2, T3, T4, T5, T6> : IIterableBase
{
...
public unsafe partial struct PageIterable<T0, T1, T2, T3, T4, T5, T6> : IIterable<T0, T1, T2, T3, T4, T5, T6>
{
