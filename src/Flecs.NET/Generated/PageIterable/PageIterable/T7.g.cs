...
public partial struct PageIterable<T0, T1, T2, T3, T4, T5, T6> : IEquatable<PageIterable<T0, T1, T2, T3, T4, T5, T6>>
{
...
public unsafe partial struct PageIterable<T0, T1, T2, T3, T4, T5, T6> : IIterable<T0, T1, T2, T3, T4, T5, T6>
{
    ...
    {
        return new PageIterable<T0, T1, T2, T3, T4, T5, T6>(_pageIterable.Page(offset, limit));
    }
    
    /// <inheritdoc cref="PageIterable.Worker(int, int)"/>
    public WorkerIterable<T0, T1, T2, T3, T4, T5, T6> Worker(int index, int count)
    {
        return new WorkerIterable<T0, T1, T2, T3, T4, T5, T6>(_pageIterable.Worker(index, count));
    }
