...
public unsafe partial struct PageIterable<T0, T1, T2, T3, T4> : IEquatable<PageIterable<T0, T1, T2, T3, T4>>
{
...
public unsafe partial struct PageIterable<T0, T1, T2, T3, T4> : IPageIterable
{
