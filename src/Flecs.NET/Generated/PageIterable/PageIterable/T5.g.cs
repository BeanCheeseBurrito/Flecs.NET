// /_/src/Flecs.NET/Generated/PageIterable/PageIterable/T5.g.cs
...
public partial struct PageIterable<T0, T1, T2, T3, T4> : IEquatable<PageIterable<T0, T1, T2, T3, T4>>
{
    ...
    public bool Equals(PageIterable<T0, T1, T2, T3, T4> other)
    {
    ...
    {
        return obj is PageIterable<T0, T1, T2, T3, T4> other && Equals(other);
    }
    ...
    public static bool operator ==(PageIterable<T0, T1, T2, T3, T4> left, PageIterable<T0, T1, T2, T3, T4> right)
    {
...
public unsafe partial struct PageIterable<T0, T1, T2, T3, T4> : IIterableBase
{
...
public unsafe partial struct PageIterable<T0, T1, T2, T3, T4> : IIterable<T0, T1, T2, T3, T4>
{
    /// <inheritdoc cref="PageIterable.Page(int, int)"/>
    public PageIterable<T0, T1, T2, T3, T4> Page(int offset, int limit)
    {
        return new PageIterable<T0, T1, T2, T3, T4>(_pageIterable.Page(offset, limit));
    }
    
    /// <inheritdoc cref="PageIterable.Worker(int, int)"/>
    public WorkerIterable<T0, T1, T2, T3, T4> Worker(int index, int count)
    {
        return new WorkerIterable<T0, T1, T2, T3, T4>(_pageIterable.Worker(index, count));
    }
