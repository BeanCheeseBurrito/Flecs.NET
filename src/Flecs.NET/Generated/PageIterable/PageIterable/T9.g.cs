// /_/src/Flecs.NET/Generated/PageIterable/PageIterable/T9.g.cs
...
public partial struct PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8> : IEquatable<PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8>>
{
    ...
    public bool Equals(PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8> other)
    {
    ...
    {
        return obj is PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8> other && Equals(other);
    }
    ...
    public static bool operator ==(PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8> left, PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8> right)
    {
...
public unsafe partial struct PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8> : IIterableBase
{
...
public unsafe partial struct PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8> : IIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8>
{
    /// <inheritdoc cref="PageIterable.Page(int, int)"/>
    public PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8> Page(int offset, int limit)
    {
        return new PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8>(_pageIterable.Page(offset, limit));
    }
    
    /// <inheritdoc cref="PageIterable.Worker(int, int)"/>
    public WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8> Worker(int index, int count)
    {
        return new WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8>(_pageIterable.Worker(index, count));
    }
