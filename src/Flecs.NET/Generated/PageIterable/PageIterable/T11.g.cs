// /_/src/Flecs.NET/Generated/PageIterable/PageIterable/T11.g.cs
...
public unsafe partial struct PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : IEquatable<PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>
{
    ...
    public bool Equals(PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> other)
    {
    ...
    {
        return obj is PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> other && Equals(other);
    }
    ...
    public static bool operator ==(PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> left, PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> right)
    {
...
public unsafe partial struct PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : IPageIterable
{
    ref PageIterable IPageIterable.Underlying => ref Underlying;
}

// IIterableBase Interface
public unsafe partial struct PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : IIterableBase
{
...
public unsafe partial struct PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : IIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
{
