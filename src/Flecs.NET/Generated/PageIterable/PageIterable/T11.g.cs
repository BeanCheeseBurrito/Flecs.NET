...
public partial struct PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : IEquatable<PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>
{
...
public unsafe partial struct PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : IIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
{
    ...
    {
        return new PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(_pageIterable.Page(offset, limit));
    }
    ...
    {
        return new WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(_pageIterable.Worker(index, count));
    }
