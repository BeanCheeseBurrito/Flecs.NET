// /_/src/Flecs.NET/Generated/PageIterable/PageIterable/T3.g.cs
...
public partial struct PageIterable<T0, T1, T2> : IEquatable<PageIterable<T0, T1, T2>>
{
    ...
    public bool Equals(PageIterable<T0, T1, T2> other)
    {
    ...
    {
        return obj is PageIterable<T0, T1, T2> other && Equals(other);
    }
    ...
    public static bool operator ==(PageIterable<T0, T1, T2> left, PageIterable<T0, T1, T2> right)
    {
...
public unsafe partial struct PageIterable<T0, T1, T2> : IIterableBase
{
...
public unsafe partial struct PageIterable<T0, T1, T2> : IIterable<T0, T1, T2>
{
    /// <inheritdoc cref="PageIterable.Page(int, int)"/>
    public PageIterable<T0, T1, T2> Page(int offset, int limit)
    {
        return new PageIterable<T0, T1, T2>(_pageIterable.Page(offset, limit));
    }
    
    /// <inheritdoc cref="PageIterable.Worker(int, int)"/>
    public WorkerIterable<T0, T1, T2> Worker(int index, int count)
    {
        return new WorkerIterable<T0, T1, T2>(_pageIterable.Worker(index, count));
    }
