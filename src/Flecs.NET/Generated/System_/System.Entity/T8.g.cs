// /_/src/Flecs.NET/Generated/System_/System.Entity/T8.g.cs
...
public unsafe partial struct System<T0, T1, T2, T3, T4, T5, T6, T7>
{
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Add(ulong id)
    {
        Entity.Add(id);
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Add(ulong first, ulong second)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Add<T>()
    {
        Entity.Add<T>();
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Add<TFirst>(ulong second)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Add<T>(T value) where T : Enum
    {
        Entity.Add(value);
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Add<TFirst, TSecond>()
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Add<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Add<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> AddSecond<TSecond>(ulong first)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> AddIf(bool cond, ulong id)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> AddIf(bool cond, ulong first, ulong second)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> AddIf<T>(bool cond)
    {
        Entity.AddIf<T>(cond);
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> AddIf<T>(bool cond, T value) where T : Enum
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> AddIf<TFirst>(bool cond, ulong second)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> AddIf<TFirst, TSecond>(bool cond)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> AddIf<TFirst, TSecond>(bool cond, TSecond second) where TSecond : Enum
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> AddIf<TFirst, TSecond>(bool cond, TFirst first) where TFirst : Enum
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> AddIfSecond<TSecond>(bool cond, ulong first)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> IsA(ulong id)
    {
        Entity.IsA(id);
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> IsA<T>()
    {
        Entity.IsA<T>();
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> IsA<T>(T value) where T : Enum
    {
        Entity.IsA(value);
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> ChildOf(ulong second)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> ChildOf<T>()
    {
        Entity.ChildOf<T>();
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> ChildOf<T>(T value) where T : Enum
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> DependsOn(ulong second)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> DependsOn<T>()
    {
        Entity.DependsOn<T>();
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> DependsOn<T>(T value) where T : Enum
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SlotOf(ulong id)
    {
        Entity.SlotOf(id);
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SlotOf<T>()
    {
        Entity.SlotOf<T>();
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SlotOf<T>(T value) where T : Enum
    {
        Entity.SlotOf(value);
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Slot()
    {
        Entity.Slot();
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Remove(ulong id)
    {
        Entity.Remove(id);
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Remove(ulong first, ulong second)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Remove<T>()
    {
        Entity.Remove<T>();
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Remove<T>(T value) where T : Enum
    {
        Entity.Remove(value);
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Remove<TFirst>(ulong second)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Remove<TFirst, TSecond>()
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Remove<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Remove<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> RemoveSecond<TSecond>(ulong first)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> AutoOverride(ulong id)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> AutoOverride(ulong first, ulong second)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> AutoOverride<T>()
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> AutoOverride<T>(T value) where T : Enum
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> AutoOverride<TFirst>(ulong second)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> AutoOverride<TFirst, TSecond>()
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> AutoOverride<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> AutoOverride<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> AutoOverrideSecond<TSecond>(ulong first)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Enable()
    {
        Entity.Enable();
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Enable(ulong id)
    {
        Entity.Enable(id);
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Enable(ulong first, ulong second)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Enable<T>()
    {
        Entity.Enable<T>();
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Enable<T>(T value) where T : Enum
    {
        Entity.Enable(value);
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Enable<TFirst>(ulong second)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Enable<TFirst, TSecond>()
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Enable<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Enable<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> EnableSecond<TSecond>(ulong first)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Disable()
    {
        Entity.Disable();
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Disable(ulong id)
    {
        Entity.Disable(id);
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Disable(ulong first, ulong second)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Disable<T>()
    {
        Entity.Disable<T>();
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Disable<T>(T value) where T : Enum
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Disable<TFirst>(ulong second)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Disable<TFirst, TSecond>()
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Disable<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Disable<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> DisableSecond<TSecond>(ulong first)
    {
    ...
    ///
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SetUntyped(ulong id, int size, void* data)
    {
    ...
    ///
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SetUntyped(ulong id, void* data)
    {
    ...
    ///
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SetUntyped(ulong first, ulong second, int size, void* data)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SetPtr<T>(T* data)
    {
        Entity.SetPtr(data);
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SetPtr<TFirst>(ulong second, TFirst* data)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SetPtr<TFirst, TSecond>(TSecond* data)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SetPtr<TFirst, TSecond>(TFirst* data)
    {
        Entity.SetPtr<TFirst, TSecond>(data);
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SetPtr<TFirst, TSecond>(TSecond second, TFirst* data) where TSecond : Enum
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SetPtr<TFirst, TSecond>(TFirst first, TSecond* data) where TFirst : Enum
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SetPtrSecond<TSecond>(ulong first, TSecond* data)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> With(Action callback)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> With(ulong first, Action callback)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> With<TFirst>(Action callback)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> With(Ecs.WorldCallback callback)
    {
        Entity.With(callback);
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> With(ulong first, Ecs.WorldCallback callback)
    {
        Entity.With(first, callback);
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> With<TFirst>(Ecs.WorldCallback callback)
    {
        Entity.With<TFirst>(callback);
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Scope(Action callback)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Scope(Ecs.WorldCallback callback)
    {
        Entity.Scope(callback);
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SetName(string name)
    {
        Entity.SetName(name);
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SetAlias(string alias)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SetDocName(string name)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SetDocBrief(string brief)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SetDocDetail(string detail)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SetDocLink(string link)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SetDocColor(string color)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SetDocUuid(string uuid)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Unit(
        string symbol,
        ulong prefix = 0,
        ulong @base = 0,
        ulong over = 0,
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> UnitPrefix(string symbol, int factor = 0, int power = 0)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Quantity(ulong quantity)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Quantity<T>()
    {
        Entity.Quantity<T>();
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Quantity()
    {
        Entity.Quantity();
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SetJson(ulong e, string json, ecs_from_json_desc_t* desc = null)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SetJson(ulong first, ulong second, string json, ecs_from_json_desc_t* desc = null)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SetJson<T>(string json, ecs_from_json_desc_t* desc = null)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SetJson<TFirst>(ulong second, string json, ecs_from_json_desc_t* desc = null)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SetJson<TFirst, TSecond>(string json, ecs_from_json_desc_t* desc = null)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SetJson<TFirst, TSecond>(TSecond second, string json, ecs_from_json_desc_t* desc = null) where TSecond : Enum
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SetJson<TFirst, TSecond>(TFirst first, string json, ecs_from_json_desc_t* desc = null) where TFirst : Enum
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> SetJsonSecond<TSecond>(ulong first, string json, ecs_from_json_desc_t* desc = null)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Observe(ulong eventId, Action callback)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Observe(ulong eventId, Ecs.ObserveEntityCallback callback)
    {
        Entity.Observe(eventId, callback);
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Observe<T>(Action callback)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Observe<T>(Ecs.ObserveEntityCallback callback)
    {
        Entity.Observe<T>(callback);
        return ref this;
    }
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Observe<T>(Ecs.ObserveRefCallback<T> callback)
    {
    ...
    public ref System<T0, T1, T2, T3, T4, T5, T6, T7> Observe<T>(Ecs.ObserveEntityRefCallback<T> callback)
    {
        Entity.Observe(callback);
        return ref this;
    }
