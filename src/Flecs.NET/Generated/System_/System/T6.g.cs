// /_/src/Flecs.NET/Generated/System_/System/T6.g.cs
...
public unsafe partial struct System<T0, T1, T2, T3, T4, T5> : IDisposable, IEquatable<System<T0, T1, T2, T3, T4, T5>>, IEntity<System<T0, T1, T2, T3, T4, T5>>
{
    ...
    public static implicit operator ulong(System<T0, T1, T2, T3, T4, T5> system)
    {
        return ToUInt64(system);
    }

    /// <inheritdoc cref="System_.ToId"/>
    public static implicit operator Id(System<T0, T1, T2, T3, T4, T5> system)
    {
        return ToId(system);
    }
    ...
    /// <inheritdoc cref="System_.ToUInt64"/>
    public static ulong ToUInt64(System<T0, T1, T2, T3, T4, T5> system)
    {
        return system.Entity;
    }

    /// <inheritdoc cref="System_.ToId"/>
    public static Id ToId(System<T0, T1, T2, T3, T4, T5> system)
    {
        return system.Id;
    }
    ...
    public bool Equals(System<T0, T1, T2, T3, T4, T5> other)
    {
    ...
    {
        return obj is System<T0, T1, T2, T3, T4, T5> system && Equals(system);
    }
    ...
    public static bool operator ==(System<T0, T1, T2, T3, T4, T5> left, System<T0, T1, T2, T3, T4, T5> right)
    {
