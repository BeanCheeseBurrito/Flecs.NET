// /_/src/Flecs.NET/Generated/System_/System/T7.g.cs
...
/// <summary>
///     A type-safe wrapper around <see cref="System"/> that takes 7 type arguments.
/// </summary>
...
public unsafe partial struct System<T0, T1, T2, T3, T4, T5, T6> : IDisposable, IEquatable<System<T0, T1, T2, T3, T4, T5, T6>>, IEntity<System<T0, T1, T2, T3, T4, T5, T6>>
{
    ...
    public static implicit operator ulong(System<T0, T1, T2, T3, T4, T5, T6> system)
    {
        return ToUInt64(system);
    }

    /// <inheritdoc cref="System_.ToId"/>
    public static implicit operator Id(System<T0, T1, T2, T3, T4, T5, T6> system)
    {
        return ToId(system);
    }

    /// <inheritdoc cref="System_.ToEntity(System_)"/>
    public static implicit operator Entity(System<T0, T1, T2, T3, T4, T5, T6> system)
    {
        return ToEntity(system);
    }

    /// <inheritdoc cref="System_.ToUInt64"/>
    public static ulong ToUInt64(System<T0, T1, T2, T3, T4, T5, T6> system)
    {
        return system.Entity;
    }

    /// <inheritdoc cref="System_.ToId"/>
    public static Id ToId(System<T0, T1, T2, T3, T4, T5, T6> system)
    {
        return system.Id;
    }

    /// <inheritdoc cref="System_.ToEntity(System_)"/>
    public static Entity ToEntity(System<T0, T1, T2, T3, T4, T5, T6> system)
    {
        return system.Entity;
    }
    ...
    public bool Equals(System<T0, T1, T2, T3, T4, T5, T6> other)
    {
    ...
    {
        return obj is System<T0, T1, T2, T3, T4, T5, T6> system && Equals(system);
    }
    ...
    public static bool operator ==(System<T0, T1, T2, T3, T4, T5, T6> left, System<T0, T1, T2, T3, T4, T5, T6> right)
    {
