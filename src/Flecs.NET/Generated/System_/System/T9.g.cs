// /_/src/Flecs.NET/Generated/System_/System/T9.g.cs
...
/// <summary>
///     A type-safe wrapper around <see cref="System"/> that takes 9 type arguments.
/// </summary>
...
public unsafe partial struct System<T0, T1, T2, T3, T4, T5, T6, T7, T8> : IDisposable, IEquatable<System<T0, T1, T2, T3, T4, T5, T6, T7, T8>>, IEntity<System<T0, T1, T2, T3, T4, T5, T6, T7, T8>>
{
    ...
    public static implicit operator ulong(System<T0, T1, T2, T3, T4, T5, T6, T7, T8> system)
    {
        return ToUInt64(system);
    }

    /// <inheritdoc cref="System_.ToId"/>
    public static implicit operator Id(System<T0, T1, T2, T3, T4, T5, T6, T7, T8> system)
    {
        return ToId(system);
    }

    /// <inheritdoc cref="System_.ToEntity(System_)"/>
    public static implicit operator Entity(System<T0, T1, T2, T3, T4, T5, T6, T7, T8> system)
    {
        return ToEntity(system);
    }

    /// <inheritdoc cref="System_.ToUInt64"/>
    public static ulong ToUInt64(System<T0, T1, T2, T3, T4, T5, T6, T7, T8> system)
    {
        return system.Entity;
    }

    /// <inheritdoc cref="System_.ToId"/>
    public static Id ToId(System<T0, T1, T2, T3, T4, T5, T6, T7, T8> system)
    {
        return system.Id;
    }

    /// <inheritdoc cref="System_.ToEntity(System_)"/>
    public static Entity ToEntity(System<T0, T1, T2, T3, T4, T5, T6, T7, T8> system)
    {
        return system.Entity;
    }
    ...
    public bool Equals(System<T0, T1, T2, T3, T4, T5, T6, T7, T8> other)
    {
    ...
    {
        return obj is System<T0, T1, T2, T3, T4, T5, T6, T7, T8> system && Equals(system);
    }
    ...
    public static bool operator ==(System<T0, T1, T2, T3, T4, T5, T6, T7, T8> left, System<T0, T1, T2, T3, T4, T5, T6, T7, T8> right)
    {
