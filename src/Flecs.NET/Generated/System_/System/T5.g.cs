// /_/src/Flecs.NET/Generated/System_/System/T5.g.cs
...
/// <summary>
///     A type-safe wrapper around <see cref="System"/> that takes 5 type arguments.
/// </summary>
...
public unsafe partial struct System<T0, T1, T2, T3, T4> : IDisposable, IEquatable<System<T0, T1, T2, T3, T4>>, IEntity<System<T0, T1, T2, T3, T4>>
{
    ...
    public static implicit operator ulong(System<T0, T1, T2, T3, T4> system)
    {
        return ToUInt64(system);
    }

    /// <inheritdoc cref="System_.ToId"/>
    public static implicit operator Id(System<T0, T1, T2, T3, T4> system)
    {
        return ToId(system);
    }

    /// <inheritdoc cref="System_.ToEntity(System_)"/>
    public static implicit operator Entity(System<T0, T1, T2, T3, T4> system)
    {
        return ToEntity(system);
    }

    /// <inheritdoc cref="System_.ToUInt64"/>
    public static ulong ToUInt64(System<T0, T1, T2, T3, T4> system)
    {
        return system.Entity;
    }

    /// <inheritdoc cref="System_.ToId"/>
    public static Id ToId(System<T0, T1, T2, T3, T4> system)
    {
        return system.Id;
    }

    /// <inheritdoc cref="System_.ToEntity(System_)"/>
    public static Entity ToEntity(System<T0, T1, T2, T3, T4> system)
    {
        return system.Entity;
    }
    ...
    public bool Equals(System<T0, T1, T2, T3, T4> other)
    {
    ...
    {
        return obj is System<T0, T1, T2, T3, T4> system && Equals(system);
    }
    ...
    public static bool operator ==(System<T0, T1, T2, T3, T4> left, System<T0, T1, T2, T3, T4> right)
    {
