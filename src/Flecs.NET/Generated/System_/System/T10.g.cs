...
public unsafe partial struct System<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> : IEquatable<System<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>>, IEntity<System<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>>
{
