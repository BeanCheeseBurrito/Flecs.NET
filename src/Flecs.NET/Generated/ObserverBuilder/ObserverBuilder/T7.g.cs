...
public unsafe partial struct ObserverBuilder<T0, T1, T2, T3, T4, T5, T6> : IDisposable, IEquatable<ObserverBuilder<T0, T1, T2, T3, T4, T5, T6>>, IQueryBuilder<ObserverBuilder<T0, T1, T2, T3, T4, T5, T6>, Observer<T0, T1, T2, T3, T4, T5, T6>>
{
    ...
    private ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6> SetCallback<T>(T callback, nint invoker) where T : Delegate
    {
        _observerBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    private ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6> SetCallback(nint callback, nint invoker)
    {
        _observerBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    private ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6> SetRun<T>(T callback, nint invoker) where T : Delegate
    {
        _observerBuilder.SetRun(callback, invoker);
        return ref this;
    }

    private ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6> SetRun(nint callback, nint invoker)
    {
        _observerBuilder.SetRun(callback, invoker);
        return ref this;
    }
