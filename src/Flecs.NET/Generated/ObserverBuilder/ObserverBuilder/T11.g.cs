// /_/src/Flecs.NET/Generated/ObserverBuilder/ObserverBuilder/T11.g.cs
...
/// <summary>
///     A type-safe wrapper around <see cref="ObserverBuilder"/> that takes 11 type arguments.
/// </summary>
...
public unsafe partial struct ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : IDisposable, IEquatable<ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>, IQueryBuilder<ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>, Observer<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>
{
    ...
    {
        TypeHelper<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>.AssertNoTags();
        _observerBuilder = new ObserverBuilder(world).With<T0>().With<T1>().With<T2>().With<T3>().With<T4>().With<T5>().With<T6>().With<T7>().With<T8>().With<T9>().With<T10>();
    }
    ...
    {
        TypeHelper<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>.AssertNoTags();
        _observerBuilder = new ObserverBuilder(world, name).With<T0>().With<T1>().With<T2>().With<T3>().With<T4>().With<T5>().With<T6>().With<T7>().With<T8>().With<T9>().With<T10>();
    }
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> Event(ulong @event)
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> Event<T>()
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> YieldExisting(bool value = true)
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> Ctx<T>(T value)
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> Ctx<T>(T value, Ecs.UserContextFinish<T> callback)
    {
    ...
    /// <inheritdoc cref="ObserverBuilder.Ctx{T}(T, Ecs.UserContextFinish{T})"/>
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> Ctx<T>(T value, delegate*<ref T, void> callback)
    {
        _observerBuilder.Ctx(ref value, callback);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> Ctx<T>(ref T value)
    {
        _observerBuilder.Ctx(ref value);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> Ctx<T>(ref T value, Ecs.UserContextFinish<T> callback)
    {
        _observerBuilder.Ctx(ref value, callback);
        return ref this;
    }
    ...
    /// <inheritdoc cref="ObserverBuilder.Ctx{T}(ref T, Ecs.UserContextFinish{T})"/>
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> Ctx<T>(ref T value, delegate*<ref T, void> callback)
    {
        _observerBuilder.Ctx(ref value, callback);
        return ref this;
    }
    ...
    public Observer<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> Run(Action callback)
    {
        return new Observer<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(_observerBuilder.Run(callback));
    }
    
    /// <inheritdoc cref="ObserverBuilder.Run(System.Action)"/>
    public Observer<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> Run(delegate*<void> callback)
    {
        return new Observer<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(_observerBuilder.Run(callback));
    }
    ...
    private Observer<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> Build()
    {
        return new Observer<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(_observerBuilder.Build());
    }

    Observer<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> IQueryBuilder<ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>, Observer<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>.Build()
    {
        return Build();
    }

    /// <inheritdoc cref="ObserverBuilder.Equals(ObserverBuilder)"/>
    public bool Equals(ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> other)
    {
    ...
    {
        return obj is ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> other && Equals(other);
    }
    ...
    public static bool operator ==(ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> left, ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> right)
    {
