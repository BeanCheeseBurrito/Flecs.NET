...
public unsafe partial struct ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7> : IDisposable, IEquatable<ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7>>, IQueryBuilder<ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7>, Observer<T0, T1, T2, T3, T4, T5, T6, T7>>
{
    ...
    private ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7> SetCallback(InvokerCallback callback, delegate*<ecs_iter_t*, void> invoker)
    {
        _observerBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    private ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7> SetRun(InvokerCallback callback, delegate*<ecs_iter_t*, void> invoker)
    {
