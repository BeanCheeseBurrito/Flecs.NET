...
public unsafe partial struct ObserverBuilder<T0> : IDisposable, IEquatable<ObserverBuilder<T0>>, IQueryBuilder<ObserverBuilder<T0>, Observer<T0>>
{
    ...
    private ref ObserverBuilder<T0> SetCallback(InvokerCallback callback, delegate*<ecs_iter_t*, void> invoker)
    {
        _observerBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    private ref ObserverBuilder<T0> SetRun(InvokerCallback callback, delegate*<ecs_iter_t*, void> invoker)
    {
