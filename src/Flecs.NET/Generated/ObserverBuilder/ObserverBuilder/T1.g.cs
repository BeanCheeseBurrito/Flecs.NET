// /_/src/Flecs.NET/Generated/ObserverBuilder/ObserverBuilder/T1.g.cs
...
/// <summary>
///     A type-safe wrapper around <see cref="ObserverBuilder"/> that takes 1 type arguments.
/// </summary>
/// <typeparam name="T0">The T0 component type.</typeparam>
public unsafe partial struct ObserverBuilder<T0> : IDisposable, IEquatable<ObserverBuilder<T0>>, IQueryBuilder<ObserverBuilder<T0>, Observer<T0>>
{
    ...
    {
        TypeHelper<T0>.AssertNoTags();
        _observerBuilder = new ObserverBuilder(world).With<T0>();
    }
    ...
    {
        TypeHelper<T0>.AssertNoTags();
        _observerBuilder = new ObserverBuilder(world, name).With<T0>();
    }
    ...
    public ref ObserverBuilder<T0> Event(ulong @event)
    {
    ...
    public ref ObserverBuilder<T0> Event<T>()
    {
    ...
    public ref ObserverBuilder<T0> YieldExisting(bool value = true)
    {
    ...
    public ref ObserverBuilder<T0> Ctx<T>(T value)
    {
    ...
    public ref ObserverBuilder<T0> Ctx<T>(T value, Ecs.UserContextFinish<T> callback)
    {
    ...
    /// <inheritdoc cref="ObserverBuilder.Ctx{T}(T, Ecs.UserContextFinish{T})"/>
    public ref ObserverBuilder<T0> Ctx<T>(T value, delegate*<ref T, void> callback)
    {
        _observerBuilder.Ctx(ref value, callback);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0> Ctx<T>(ref T value)
    {
        _observerBuilder.Ctx(ref value);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0> Ctx<T>(ref T value, Ecs.UserContextFinish<T> callback)
    {
        _observerBuilder.Ctx(ref value, callback);
        return ref this;
    }
    ...
    /// <inheritdoc cref="ObserverBuilder.Ctx{T}(ref T, Ecs.UserContextFinish{T})"/>
    public ref ObserverBuilder<T0> Ctx<T>(ref T value, delegate*<ref T, void> callback)
    {
        _observerBuilder.Ctx(ref value, callback);
        return ref this;
    }
    ...
    public Observer<T0> Run(Action callback)
    {
        return new Observer<T0>(_observerBuilder.Run(callback));
    }
    
    /// <inheritdoc cref="ObserverBuilder.Run(System.Action)"/>
    public Observer<T0> Run(delegate*<void> callback)
    {
        return new Observer<T0>(_observerBuilder.Run(callback));
    }
    ...
    private Observer<T0> Build()
    {
        return new Observer<T0>(_observerBuilder.Build());
    }

    Observer<T0> IQueryBuilder<ObserverBuilder<T0>, Observer<T0>>.Build()
    {
        return Build();
    }

    /// <inheritdoc cref="ObserverBuilder.Equals(ObserverBuilder)"/>
    public bool Equals(ObserverBuilder<T0> other)
    {
    ...
    {
        return obj is ObserverBuilder<T0> other && Equals(other);
    }
    ...
    public static bool operator ==(ObserverBuilder<T0> left, ObserverBuilder<T0> right)
    {
