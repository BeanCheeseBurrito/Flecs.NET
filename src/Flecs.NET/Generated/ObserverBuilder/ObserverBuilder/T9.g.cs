...
public unsafe partial struct ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8> : IDisposable, IEquatable<ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8>>, IQueryBuilder<ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8>, Observer<T0, T1, T2, T3, T4, T5, T6, T7, T8>>
{
    ...
    {
        Types<T0, T1, T2, T3, T4, T5, T6, T7, T8, _, _, _, _, _, _, _>.AssertNoTags();
    ...
    private ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8> SetCallback(InvokerCallback callback, delegate*<ecs_iter_t*, void> invoker)
    {
        _observerBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    private ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8> SetRun(InvokerCallback callback, delegate*<ecs_iter_t*, void> invoker)
    {
