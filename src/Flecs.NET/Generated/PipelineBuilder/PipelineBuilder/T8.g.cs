// /_/src/Flecs.NET/Generated/PipelineBuilder/PipelineBuilder/T8.g.cs
...
/// <summary>
///     A type-safe wrapper around <see cref="PipelineBuilder"/> that takes 8 type arguments.
/// </summary>
...
public unsafe partial struct PipelineBuilder<T0, T1, T2, T3, T4, T5, T6, T7> : IEquatable<PipelineBuilder<T0, T1, T2, T3, T4, T5, T6, T7>>, IQueryBuilder<PipelineBuilder<T0, T1, T2, T3, T4, T5, T6, T7>, Pipeline<T0, T1, T2, T3, T4, T5, T6, T7>>
{
    ...
    {
        _pipelineBuilder = new PipelineBuilder(world).With<T0>().With<T1>().With<T2>().With<T3>().With<T4>().With<T5>().With<T6>().With<T7>();
    }

    /// <inheritdoc cref="PipelineBuilder(ecs_world_t*, ulong)"/>
    public PipelineBuilder(ecs_world_t* world, ulong entity)
    {
        _pipelineBuilder = new PipelineBuilder(world, entity).With<T0>().With<T1>().With<T2>().With<T3>().With<T4>().With<T5>().With<T6>().With<T7>();
    }

    /// <inheritdoc cref="PipelineBuilder(ecs_world_t*, string)"/>
    public PipelineBuilder(ecs_world_t* world, string name)
    {
        _pipelineBuilder = new PipelineBuilder(world, name).With<T0>().With<T1>().With<T2>().With<T3>().With<T4>().With<T5>().With<T6>().With<T7>();
    }

    /// <inheritdoc cref="PipelineBuilder.Build()"/>
    public Pipeline<T0, T1, T2, T3, T4, T5, T6, T7> Build()
    {
        return new Pipeline<T0, T1, T2, T3, T4, T5, T6, T7>(_pipelineBuilder.Build());
    }
    
    /// <inheritdoc cref="PipelineBuilder.Equals(PipelineBuilder)"/>
    public bool Equals(PipelineBuilder<T0, T1, T2, T3, T4, T5, T6, T7> other)
    {
    ...
    {
        return obj is PipelineBuilder<T0, T1, T2, T3, T4, T5, T6, T7>  other && Equals(other);
    }
    ...
    public static bool operator ==(PipelineBuilder<T0, T1, T2, T3, T4, T5, T6, T7> left, PipelineBuilder<T0, T1, T2, T3, T4, T5, T6, T7> right)
    {
