// /_/src/Flecs.NET/Generated/PipelineBuilder/PipelineBuilder/T2.g.cs
...
/// <summary>
///     A type-safe wrapper around <see cref="PipelineBuilder"/> that takes 2 type arguments.
/// </summary>
/// <typeparam name="T0">The T0 component type.</typeparam> <typeparam name="T1">The T1 component type.</typeparam>
public unsafe partial struct PipelineBuilder<T0, T1> : IEquatable<PipelineBuilder<T0, T1>>, IQueryBuilder<PipelineBuilder<T0, T1>, Pipeline<T0, T1>>
{
    ...
    {
        _pipelineBuilder = new PipelineBuilder(world).With<T0>().With<T1>();
    }

    /// <inheritdoc cref="PipelineBuilder(ecs_world_t*, ulong)"/>
    public PipelineBuilder(ecs_world_t* world, ulong entity)
    {
        _pipelineBuilder = new PipelineBuilder(world, entity).With<T0>().With<T1>();
    }

    /// <inheritdoc cref="PipelineBuilder(ecs_world_t*, string)"/>
    public PipelineBuilder(ecs_world_t* world, string name)
    {
        _pipelineBuilder = new PipelineBuilder(world, name).With<T0>().With<T1>();
    }

    /// <inheritdoc cref="PipelineBuilder.Build()"/>
    public Pipeline<T0, T1> Build()
    {
        return new Pipeline<T0, T1>(_pipelineBuilder.Build());
    }
    
    /// <inheritdoc cref="PipelineBuilder.Equals(PipelineBuilder)"/>
    public bool Equals(PipelineBuilder<T0, T1> other)
    {
    ...
    {
        return obj is PipelineBuilder<T0, T1>  other && Equals(other);
    }
    ...
    public static bool operator ==(PipelineBuilder<T0, T1> left, PipelineBuilder<T0, T1> right)
    {
