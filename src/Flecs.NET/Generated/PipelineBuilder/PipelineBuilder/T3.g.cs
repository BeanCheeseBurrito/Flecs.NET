// /_/src/Flecs.NET/Generated/PipelineBuilder/PipelineBuilder/T3.g.cs
...
/// <summary>
///     A type-safe wrapper around <see cref="PipelineBuilder"/> that takes 3 type arguments.
/// </summary>
...
public unsafe partial struct PipelineBuilder<T0, T1, T2> : IEquatable<PipelineBuilder<T0, T1, T2>>, IQueryBuilder<PipelineBuilder<T0, T1, T2>, Pipeline<T0, T1, T2>>
{
    ...
    {
        _pipelineBuilder = new PipelineBuilder(world).With<T0>().With<T1>().With<T2>();
    }

    /// <inheritdoc cref="PipelineBuilder(ecs_world_t*, ulong)"/>
    public PipelineBuilder(ecs_world_t* world, ulong entity)
    {
        _pipelineBuilder = new PipelineBuilder(world, entity).With<T0>().With<T1>().With<T2>();
    }

    /// <inheritdoc cref="PipelineBuilder(ecs_world_t*, string)"/>
    public PipelineBuilder(ecs_world_t* world, string name)
    {
        _pipelineBuilder = new PipelineBuilder(world, name).With<T0>().With<T1>().With<T2>();
    }

    /// <inheritdoc cref="PipelineBuilder.Build()"/>
    public Pipeline<T0, T1, T2> Build()
    {
        return new Pipeline<T0, T1, T2>(_pipelineBuilder.Build());
    }
    
    /// <inheritdoc cref="PipelineBuilder.Equals(PipelineBuilder)"/>
    public bool Equals(PipelineBuilder<T0, T1, T2> other)
    {
    ...
    {
        return obj is PipelineBuilder<T0, T1, T2>  other && Equals(other);
    }
    ...
    public static bool operator ==(PipelineBuilder<T0, T1, T2> left, PipelineBuilder<T0, T1, T2> right)
    {
