// /_/src/Flecs.NET/Generated/WorkerIterable/WorkerIterable/T5.g.cs
...
public partial struct WorkerIterable<T0, T1, T2, T3, T4> : IEquatable<WorkerIterable<T0, T1, T2, T3, T4>>
{
    ...
    public bool Equals(WorkerIterable<T0, T1, T2, T3, T4> other)
    {
    ...
    {
        return obj is WorkerIterable<T0, T1, T2, T3, T4> other && Equals(other);
    }
    ...
    public static bool operator ==(WorkerIterable<T0, T1, T2, T3, T4> left, WorkerIterable<T0, T1, T2, T3, T4> right)
    {
...
public unsafe partial struct WorkerIterable<T0, T1, T2, T3, T4> : IIterableBase
{
...
public unsafe partial struct WorkerIterable<T0, T1, T2, T3, T4> : IIterable<T0, T1, T2, T3, T4>
{
    /// <inheritdoc cref="WorkerIterable.Page(int, int)"/>
    public PageIterable<T0, T1, T2, T3, T4> Page(int offset, int limit)
    {
        return new PageIterable<T0, T1, T2, T3, T4>(_workerIterable.Page(offset, limit));
    }
    
    /// <inheritdoc cref="WorkerIterable.Worker(int, int)"/>
    public WorkerIterable<T0, T1, T2, T3, T4> Worker(int index, int count)
    {
        return new WorkerIterable<T0, T1, T2, T3, T4>(_workerIterable.Worker(index, count));
    }
