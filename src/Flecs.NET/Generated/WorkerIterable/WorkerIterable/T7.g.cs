// /_/src/Flecs.NET/Generated/WorkerIterable/WorkerIterable/T7.g.cs
...
public unsafe partial struct WorkerIterable<T0, T1, T2, T3, T4, T5, T6> : IEquatable<WorkerIterable<T0, T1, T2, T3, T4, T5, T6>>, IIterable<T0, T1, T2, T3, T4, T5, T6>
{
    ...
    public bool Equals(WorkerIterable<T0, T1, T2, T3, T4, T5, T6> other)
    {
    ...
    {
        return obj is WorkerIterable<T0, T1, T2, T3, T4, T5, T6> other && Equals(other);
    }
    ...
    public static bool operator ==(WorkerIterable<T0, T1, T2, T3, T4, T5, T6> left, WorkerIterable<T0, T1, T2, T3, T4, T5, T6> right)
    {
...
public unsafe partial struct WorkerIterable<T0, T1, T2, T3, T4, T5, T6> : IWorkerIterable
{
    ref WorkerIterable IWorkerIterable.Underlying => ref Underlying;
}

// IIterableBase Interface
public unsafe partial struct WorkerIterable<T0, T1, T2, T3, T4, T5, T6> : IIterableBase
{
...
public unsafe partial struct WorkerIterable<T0, T1, T2, T3, T4, T5, T6> : IIterable<T0, T1, T2, T3, T4, T5, T6>
{
