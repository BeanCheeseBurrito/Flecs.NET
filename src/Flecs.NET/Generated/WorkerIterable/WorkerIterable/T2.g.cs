...
public unsafe partial struct WorkerIterable<T0, T1> : IEquatable<WorkerIterable<T0, T1>>, IIterable<T0, T1>
{
...
public unsafe partial struct WorkerIterable<T0, T1> : IWorkerIterable
{
