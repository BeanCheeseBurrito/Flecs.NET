// /_/src/Flecs.NET/Generated/WorkerIterable/WorkerIterable/T2.g.cs
...
public partial struct WorkerIterable<T0, T1> : IEquatable<WorkerIterable<T0, T1>>
{
    ...
    public bool Equals(WorkerIterable<T0, T1> other)
    {
    ...
    {
        return obj is WorkerIterable<T0, T1> other && Equals(other);
    }
    ...
    public static bool operator ==(WorkerIterable<T0, T1> left, WorkerIterable<T0, T1> right)
    {
...
public unsafe partial struct WorkerIterable<T0, T1> : IIterableBase
{
...
public unsafe partial struct WorkerIterable<T0, T1> : IIterable<T0, T1>
{
    /// <inheritdoc cref="WorkerIterable.Page(int, int)"/>
    public PageIterable<T0, T1> Page(int offset, int limit)
    {
        return new PageIterable<T0, T1>(_workerIterable.Page(offset, limit));
    }
    
    /// <inheritdoc cref="WorkerIterable.Worker(int, int)"/>
    public WorkerIterable<T0, T1> Worker(int index, int count)
    {
        return new WorkerIterable<T0, T1>(_workerIterable.Worker(index, count));
    }
