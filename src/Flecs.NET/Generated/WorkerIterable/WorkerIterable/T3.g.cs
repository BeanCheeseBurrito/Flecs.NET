// /_/src/Flecs.NET/Generated/WorkerIterable/WorkerIterable/T3.g.cs
...
public partial struct WorkerIterable<T0, T1, T2> : IEquatable<WorkerIterable<T0, T1, T2>>
{
    ...
    public bool Equals(WorkerIterable<T0, T1, T2> other)
    {
    ...
    {
        return obj is WorkerIterable<T0, T1, T2> other && Equals(other);
    }
    ...
    public static bool operator ==(WorkerIterable<T0, T1, T2> left, WorkerIterable<T0, T1, T2> right)
    {
...
public unsafe partial struct WorkerIterable<T0, T1, T2> : IIterableBase
{
...
public unsafe partial struct WorkerIterable<T0, T1, T2> : IIterable<T0, T1, T2>
{
    /// <inheritdoc cref="WorkerIterable.Page(int, int)"/>
    public PageIterable<T0, T1, T2> Page(int offset, int limit)
    {
        return new PageIterable<T0, T1, T2>(_workerIterable.Page(offset, limit));
    }
    
    /// <inheritdoc cref="WorkerIterable.Worker(int, int)"/>
    public WorkerIterable<T0, T1, T2> Worker(int index, int count)
    {
        return new WorkerIterable<T0, T1, T2>(_workerIterable.Worker(index, count));
    }
