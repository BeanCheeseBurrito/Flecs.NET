...
public unsafe partial struct WorkerIterable<T0, T1, T2> : IEquatable<WorkerIterable<T0, T1, T2>>, IIterable<T0, T1, T2>
{
...
public unsafe partial struct WorkerIterable<T0, T1, T2> : IWorkerIterable
{
