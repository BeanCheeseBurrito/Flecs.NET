// /_/src/Flecs.NET/Generated/WorkerIterable/WorkerIterable/T11.g.cs
...
public unsafe partial struct WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : IEquatable<WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>, IIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
{
    ...
    public bool Equals(WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> other)
    {
    ...
    {
        return obj is WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> other && Equals(other);
    }
    ...
    public static bool operator ==(WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> left, WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> right)
    {
...
public unsafe partial struct WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : IWorkerIterable
{
    ref WorkerIterable IWorkerIterable.Underlying => ref Underlying;
}

// IIterableBase Interface
public unsafe partial struct WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : IIterableBase
{
...
public unsafe partial struct WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : IIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
{
