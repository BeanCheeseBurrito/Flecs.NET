// /_/src/Flecs.NET/Generated/WorkerIterable/WorkerIterable/T8.g.cs
...
public partial struct WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7> : IEquatable<WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7>>
{
    ...
    public bool Equals(WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7> other)
    {
    ...
    {
        return obj is WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7> other && Equals(other);
    }
    ...
    public static bool operator ==(WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7> left, WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7> right)
    {
...
public unsafe partial struct WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7> : IIterableBase
{
...
public unsafe partial struct WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7> : IIterable<T0, T1, T2, T3, T4, T5, T6, T7>
{
    /// <inheritdoc cref="WorkerIterable.Page(int, int)"/>
    public PageIterable<T0, T1, T2, T3, T4, T5, T6, T7> Page(int offset, int limit)
    {
        return new PageIterable<T0, T1, T2, T3, T4, T5, T6, T7>(_workerIterable.Page(offset, limit));
    }
    
    /// <inheritdoc cref="WorkerIterable.Worker(int, int)"/>
    public WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7> Worker(int index, int count)
    {
        return new WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7>(_workerIterable.Worker(index, count));
    }
