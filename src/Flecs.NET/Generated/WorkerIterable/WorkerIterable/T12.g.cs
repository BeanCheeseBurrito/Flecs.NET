// /_/src/Flecs.NET/Generated/WorkerIterable/WorkerIterable/T12.g.cs
...
public unsafe partial struct WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> : IEquatable<WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>>, IIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>
{
    ...
    public bool Equals(WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> other)
    {
    ...
    {
        return obj is WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> other && Equals(other);
    }
    ...
    public static bool operator ==(WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> left, WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> right)
    {
...
public unsafe partial struct WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> : IWorkerIterable
{
    ref WorkerIterable IWorkerIterable.Underlying => ref Underlying;
}

// IIterableBase Interface
public unsafe partial struct WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> : IIterableBase
{
...
public unsafe partial struct WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> : IIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>
{
