// /_/src/Flecs.NET/Generated/WorkerIterable/WorkerIterable/T1.g.cs
...
public unsafe partial struct WorkerIterable<T0> : IEquatable<WorkerIterable<T0>>, IIterable<T0>
{
    ...
    public bool Equals(WorkerIterable<T0> other)
    {
    ...
    {
        return obj is WorkerIterable<T0> other && Equals(other);
    }
    ...
    public static bool operator ==(WorkerIterable<T0> left, WorkerIterable<T0> right)
    {
...
public unsafe partial struct WorkerIterable<T0> : IWorkerIterable
{
    ref WorkerIterable IWorkerIterable.Underlying => ref Underlying;
}

// IIterableBase Interface
public unsafe partial struct WorkerIterable<T0> : IIterableBase
{
...
public unsafe partial struct WorkerIterable<T0> : IIterable<T0>
{
