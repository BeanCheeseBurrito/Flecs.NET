...
public partial struct WorkerIterable<T0> : IEquatable<WorkerIterable<T0>>
{
...
public unsafe partial struct WorkerIterable<T0> : IIterable<T0>
{
    ...
    {
        return new PageIterable<T0>(_workerIterable.Page(offset, limit));
    }
    
    /// <inheritdoc cref="WorkerIterable.Worker(int, int)"/>
    public WorkerIterable<T0> Worker(int index, int count)
    {
        return new WorkerIterable<T0>(_workerIterable.Worker(index, count));
    }
