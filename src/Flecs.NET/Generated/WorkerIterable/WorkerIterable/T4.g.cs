...
public unsafe partial struct WorkerIterable<T0, T1, T2, T3> : IEquatable<WorkerIterable<T0, T1, T2, T3>>, IIterable<T0, T1, T2, T3>
{
...
public unsafe partial struct WorkerIterable<T0, T1, T2, T3> : IWorkerIterable
{
