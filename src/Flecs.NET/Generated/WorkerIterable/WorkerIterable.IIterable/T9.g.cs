...
public unsafe partial struct WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8>
{
    ...
    public void Run(Ecs.RunCallback callback)
    {
        ...
        TypeHelper<T0, T1, T2, T3, T4, T5, T6, T7, T8>.AssertSparseTypes(Ecs.GetIterableWorld(ref this), true);
    ...
    {
        TypeHelper<T0, T1, T2, T3, T4, T5, T6, T7, T8>.AssertReferenceTypes(true);
        TypeHelper<T0, T1, T2, T3, T4, T5, T6, T7, T8>.AssertSparseTypes(Ecs.GetIterableWorld(ref this), false);
