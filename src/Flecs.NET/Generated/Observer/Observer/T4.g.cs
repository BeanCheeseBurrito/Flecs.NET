// /_/src/Flecs.NET/Generated/Observer/Observer/T4.g.cs
...
public unsafe partial struct Observer<T0, T1, T2, T3> : IDisposable, IEquatable<Observer<T0, T1, T2, T3>>, IEntity<Observer<T0, T1, T2, T3>>
{
    ...
    public Query<T0, T1, T2, T3> Query()
    {
        return new Query<T0, T1, T2, T3>(_observer.Query());
    }

    /// <inheritdoc cref="Observer.ToUInt64"/>
    public static implicit operator ulong(Observer<T0, T1, T2, T3> observer)
    {
        return ToUInt64(observer);
    }

    /// <inheritdoc cref="Observer.ToId"/>
    public static implicit operator Id(Observer<T0, T1, T2, T3> observer)
    {
    ...
    /// <inheritdoc cref="Observer.ToUInt64"/>
    public static ulong ToUInt64(Observer<T0, T1, T2, T3> observer)
    {
        return observer.Entity;
    }

    /// <inheritdoc cref="Observer.ToId"/>
    public static Id ToId(Observer<T0, T1, T2, T3> observer)
    {
        return observer.Id;
    }
    ...
    public bool Equals(Observer<T0, T1, T2, T3> other)
    {
    ...
    {
        return obj is Observer<T0, T1, T2, T3> other && Equals(other);
    }
    ...
    public static bool operator ==(Observer<T0, T1, T2, T3> left, Observer<T0, T1, T2, T3> right)
    {
