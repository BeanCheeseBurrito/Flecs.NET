// /_/src/Flecs.NET/Generated/Observer/Observer/T2.g.cs
...
public unsafe partial struct Observer<T0, T1> : IDisposable, IEquatable<Observer<T0, T1>>, IEntity<Observer<T0, T1>>
{
    ...
    public Query<T0, T1> Query()
    {
        return new Query<T0, T1>(_observer.Query());
    }

    /// <inheritdoc cref="Observer.ToUInt64"/>
    public static implicit operator ulong(Observer<T0, T1> observer)
    {
        return ToUInt64(observer);
    }

    /// <inheritdoc cref="Observer.ToId"/>
    public static implicit operator Id(Observer<T0, T1> observer)
    {
        return ToId(observer);
    }

    /// <inheritdoc cref="Observer.ToEntity(Observer)"/>
    public static implicit operator Entity(Observer<T0, T1> observer)
    {
        return ToEntity(observer);
    }

    /// <inheritdoc cref="Observer.ToUInt64"/>
    public static ulong ToUInt64(Observer<T0, T1> observer)
    {
        return observer.Entity;
    }

    /// <inheritdoc cref="Observer.ToId"/>
    public static Id ToId(Observer<T0, T1> observer)
    {
        return observer.Id;
    }

    /// <inheritdoc cref="Observer.ToEntity(Observer)"/>
    public static Entity ToEntity(Observer<T0, T1> observer)
    {
        return observer.Entity;
    }

    /// <inheritdoc cref="Observer.Equals(Observer)"/>
    public bool Equals(Observer<T0, T1> other)
    {
    ...
    {
        return obj is Observer<T0, T1> other && Equals(other);
    }
    ...
    public static bool operator ==(Observer<T0, T1> left, Observer<T0, T1> right)
    {
