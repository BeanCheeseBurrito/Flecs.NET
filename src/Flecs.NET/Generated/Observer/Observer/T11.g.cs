// /_/src/Flecs.NET/Generated/Observer/Observer/T11.g.cs
...
public unsafe partial struct Observer<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : IDisposable, IEquatable<Observer<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>, IEntity<Observer<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>
{
    ...
    public Query<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> Query()
    {
        return new Query<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(_observer.Query());
    }

    /// <inheritdoc cref="Observer.ToUInt64"/>
    public static implicit operator ulong(Observer<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> observer)
    {
        return ToUInt64(observer);
    }

    /// <inheritdoc cref="Observer.ToId"/>
    public static implicit operator Id(Observer<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> observer)
    {
        return ToId(observer);
    }

    /// <inheritdoc cref="Observer.ToEntity(Observer)"/>
    public static implicit operator Entity(Observer<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> observer)
    {
        return ToEntity(observer);
    }

    /// <inheritdoc cref="Observer.ToUInt64"/>
    public static ulong ToUInt64(Observer<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> observer)
    {
        return observer.Entity;
    }

    /// <inheritdoc cref="Observer.ToId"/>
    public static Id ToId(Observer<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> observer)
    {
        return observer.Id;
    }

    /// <inheritdoc cref="Observer.ToEntity(Observer)"/>
    public static Entity ToEntity(Observer<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> observer)
    {
        return observer.Entity;
    }

    /// <inheritdoc cref="Observer.Equals(Observer)"/>
    public bool Equals(Observer<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> other)
    {
    ...
    {
        return obj is Observer<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> other && Equals(other);
    }
    ...
    public static bool operator ==(Observer<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> left, Observer<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> right)
    {
