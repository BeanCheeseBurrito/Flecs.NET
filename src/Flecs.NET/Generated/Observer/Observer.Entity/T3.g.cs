// /_/src/Flecs.NET/Generated/Observer/Observer.Entity/T3.g.cs
...
public unsafe partial struct Observer<T0, T1, T2>
{
    ...
    public ref Observer<T0, T1, T2> Add(ulong id)
    {
        Entity.Add(id);
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> Add(ulong first, ulong second)
    {
    ...
    public ref Observer<T0, T1, T2> Add<T>()
    {
        Entity.Add<T>();
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> Add<TFirst>(ulong second)
    {
    ...
    public ref Observer<T0, T1, T2> Add<T>(T value) where T : Enum
    {
        Entity.Add(value);
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> Add<TFirst, TSecond>()
    {
    ...
    public ref Observer<T0, T1, T2> Add<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref Observer<T0, T1, T2> Add<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref Observer<T0, T1, T2> AddSecond<TSecond>(ulong first)
    {
    ...
    public ref Observer<T0, T1, T2> AddIf(bool cond, ulong id)
    {
    ...
    public ref Observer<T0, T1, T2> AddIf(bool cond, ulong first, ulong second)
    {
    ...
    public ref Observer<T0, T1, T2> AddIf<T>(bool cond)
    {
        Entity.AddIf<T>(cond);
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> AddIf<T>(bool cond, T value) where T : Enum
    {
    ...
    public ref Observer<T0, T1, T2> AddIf<TFirst>(bool cond, ulong second)
    {
    ...
    public ref Observer<T0, T1, T2> AddIf<TFirst, TSecond>(bool cond)
    {
    ...
    public ref Observer<T0, T1, T2> AddIf<TFirst, TSecond>(bool cond, TSecond second) where TSecond : Enum
    {
    ...
    public ref Observer<T0, T1, T2> AddIf<TFirst, TSecond>(bool cond, TFirst first) where TFirst : Enum
    {
    ...
    public ref Observer<T0, T1, T2> AddIfSecond<TSecond>(bool cond, ulong first)
    {
    ...
    public ref Observer<T0, T1, T2> IsA(ulong id)
    {
        Entity.IsA(id);
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> IsA<T>()
    {
        Entity.IsA<T>();
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> IsA<T>(T value) where T : Enum
    {
        Entity.IsA(value);
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> ChildOf(ulong second)
    {
    ...
    public ref Observer<T0, T1, T2> ChildOf<T>()
    {
        Entity.ChildOf<T>();
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> ChildOf<T>(T value) where T : Enum
    {
    ...
    public ref Observer<T0, T1, T2> DependsOn(ulong second)
    {
    ...
    public ref Observer<T0, T1, T2> DependsOn<T>()
    {
        Entity.DependsOn<T>();
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> DependsOn<T>(T value) where T : Enum
    {
    ...
    public ref Observer<T0, T1, T2> SlotOf(ulong id)
    {
        Entity.SlotOf(id);
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> SlotOf<T>()
    {
        Entity.SlotOf<T>();
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> SlotOf<T>(T value) where T : Enum
    {
        Entity.SlotOf(value);
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> Slot()
    {
        Entity.Slot();
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> Remove(ulong id)
    {
        Entity.Remove(id);
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> Remove(ulong first, ulong second)
    {
    ...
    public ref Observer<T0, T1, T2> Remove<T>()
    {
        Entity.Remove<T>();
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> Remove<T>(T value) where T : Enum
    {
        Entity.Remove(value);
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> Remove<TFirst>(ulong second)
    {
    ...
    public ref Observer<T0, T1, T2> Remove<TFirst, TSecond>()
    {
    ...
    public ref Observer<T0, T1, T2> Remove<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref Observer<T0, T1, T2> Remove<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref Observer<T0, T1, T2> RemoveSecond<TSecond>(ulong first)
    {
    ...
    public ref Observer<T0, T1, T2> AutoOverride(ulong id)
    {
    ...
    public ref Observer<T0, T1, T2> AutoOverride(ulong first, ulong second)
    {
    ...
    public ref Observer<T0, T1, T2> AutoOverride<T>()
    {
    ...
    public ref Observer<T0, T1, T2> AutoOverride<T>(T value) where T : Enum
    {
    ...
    public ref Observer<T0, T1, T2> AutoOverride<TFirst>(ulong second)
    {
    ...
    public ref Observer<T0, T1, T2> AutoOverride<TFirst, TSecond>()
    {
    ...
    public ref Observer<T0, T1, T2> AutoOverride<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref Observer<T0, T1, T2> AutoOverride<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref Observer<T0, T1, T2> AutoOverrideSecond<TSecond>(ulong first)
    {
    ...
    public ref Observer<T0, T1, T2> Enable()
    {
        Entity.Enable();
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> Enable(ulong id)
    {
        Entity.Enable(id);
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> Enable(ulong first, ulong second)
    {
    ...
    public ref Observer<T0, T1, T2> Enable<T>()
    {
        Entity.Enable<T>();
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> Enable<T>(T value) where T : Enum
    {
        Entity.Enable(value);
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> Enable<TFirst>(ulong second)
    {
    ...
    public ref Observer<T0, T1, T2> Enable<TFirst, TSecond>()
    {
    ...
    public ref Observer<T0, T1, T2> Enable<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref Observer<T0, T1, T2> Enable<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref Observer<T0, T1, T2> EnableSecond<TSecond>(ulong first)
    {
    ...
    public ref Observer<T0, T1, T2> Disable()
    {
        Entity.Disable();
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> Disable(ulong id)
    {
        Entity.Disable(id);
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> Disable(ulong first, ulong second)
    {
    ...
    public ref Observer<T0, T1, T2> Disable<T>()
    {
        Entity.Disable<T>();
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> Disable<T>(T value) where T : Enum
    {
    ...
    public ref Observer<T0, T1, T2> Disable<TFirst>(ulong second)
    {
    ...
    public ref Observer<T0, T1, T2> Disable<TFirst, TSecond>()
    {
    ...
    public ref Observer<T0, T1, T2> Disable<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref Observer<T0, T1, T2> Disable<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref Observer<T0, T1, T2> DisableSecond<TSecond>(ulong first)
    {
    ...
    ///
    public ref Observer<T0, T1, T2> SetUntyped(ulong id, int size, void* data)
    {
    ...
    ///
    public ref Observer<T0, T1, T2> SetUntyped(ulong id, void* data)
    {
    ...
    ///
    public ref Observer<T0, T1, T2> SetUntyped(ulong first, ulong second, int size, void* data)
    {
    ...
    public ref Observer<T0, T1, T2> SetPtr<T>(T* data)
    {
        Entity.SetPtr(data);
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> SetPtr<TFirst>(ulong second, TFirst* data)
    {
    ...
    public ref Observer<T0, T1, T2> SetPtr<TFirst, TSecond>(TSecond* data)
    {
    ...
    public ref Observer<T0, T1, T2> SetPtr<TFirst, TSecond>(TFirst* data)
    {
        Entity.SetPtr<TFirst, TSecond>(data);
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> SetPtr<TFirst, TSecond>(TSecond second, TFirst* data) where TSecond : Enum
    {
    ...
    public ref Observer<T0, T1, T2> SetPtr<TFirst, TSecond>(TFirst first, TSecond* data) where TFirst : Enum
    {
    ...
    public ref Observer<T0, T1, T2> SetPtrSecond<TSecond>(ulong first, TSecond* data)
    {
    ...
    public ref Observer<T0, T1, T2> With(Action callback)
    {
    ...
    public ref Observer<T0, T1, T2> With(ulong first, Action callback)
    {
    ...
    public ref Observer<T0, T1, T2> With<TFirst>(Action callback)
    {
    ...
    public ref Observer<T0, T1, T2> With(Ecs.WorldCallback callback)
    {
        Entity.With(callback);
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> With(ulong first, Ecs.WorldCallback callback)
    {
        Entity.With(first, callback);
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> With<TFirst>(Ecs.WorldCallback callback)
    {
        Entity.With<TFirst>(callback);
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> Scope(Action callback)
    {
    ...
    public ref Observer<T0, T1, T2> Scope(Ecs.WorldCallback callback)
    {
        Entity.Scope(callback);
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> SetName(string name)
    {
        Entity.SetName(name);
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> SetAlias(string alias)
    {
    ...
    public ref Observer<T0, T1, T2> SetDocName(string name)
    {
    ...
    public ref Observer<T0, T1, T2> SetDocBrief(string brief)
    {
    ...
    public ref Observer<T0, T1, T2> SetDocDetail(string detail)
    {
    ...
    public ref Observer<T0, T1, T2> SetDocLink(string link)
    {
    ...
    public ref Observer<T0, T1, T2> SetDocColor(string color)
    {
    ...
    public ref Observer<T0, T1, T2> SetDocUuid(string uuid)
    {
    ...
    public ref Observer<T0, T1, T2> Unit(
        string symbol,
        ulong prefix = 0,
        ulong @base = 0,
        ulong over = 0,
    ...
    public ref Observer<T0, T1, T2> UnitPrefix(string symbol, int factor = 0, int power = 0)
    {
    ...
    public ref Observer<T0, T1, T2> Quantity(ulong quantity)
    {
    ...
    public ref Observer<T0, T1, T2> Quantity<T>()
    {
        Entity.Quantity<T>();
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> Quantity()
    {
        Entity.Quantity();
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> SetJson(ulong e, string json, ecs_from_json_desc_t* desc = null)
    {
    ...
    public ref Observer<T0, T1, T2> SetJson(ulong first, ulong second, string json, ecs_from_json_desc_t* desc = null)
    {
    ...
    public ref Observer<T0, T1, T2> SetJson<T>(string json, ecs_from_json_desc_t* desc = null)
    {
    ...
    public ref Observer<T0, T1, T2> SetJson<TFirst>(ulong second, string json, ecs_from_json_desc_t* desc = null)
    {
    ...
    public ref Observer<T0, T1, T2> SetJson<TFirst, TSecond>(string json, ecs_from_json_desc_t* desc = null)
    {
    ...
    public ref Observer<T0, T1, T2> SetJson<TFirst, TSecond>(TSecond second, string json, ecs_from_json_desc_t* desc = null) where TSecond : Enum
    {
    ...
    public ref Observer<T0, T1, T2> SetJson<TFirst, TSecond>(TFirst first, string json, ecs_from_json_desc_t* desc = null) where TFirst : Enum
    {
    ...
    public ref Observer<T0, T1, T2> SetJsonSecond<TSecond>(ulong first, string json, ecs_from_json_desc_t* desc = null)
    {
    ...
    public ref Observer<T0, T1, T2> Observe(ulong eventId, Action callback)
    {
    ...
    public ref Observer<T0, T1, T2> Observe(ulong eventId, Ecs.ObserveEntityCallback callback)
    {
        Entity.Observe(eventId, callback);
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> Observe<T>(Action callback)
    {
    ...
    public ref Observer<T0, T1, T2> Observe<T>(Ecs.ObserveEntityCallback callback)
    {
        Entity.Observe<T>(callback);
        return ref this;
    }
    ...
    public ref Observer<T0, T1, T2> Observe<T>(Ecs.ObserveRefCallback<T> callback)
    {
    ...
    public ref Observer<T0, T1, T2> Observe<T>(Ecs.ObserveEntityRefCallback<T> callback)
    {
        Entity.Observe(callback);
        return ref this;
    }
