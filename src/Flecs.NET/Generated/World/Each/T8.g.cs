// /_/src/Flecs.NET/Generated/World/Each/T8.g.cs
...
public unsafe partial struct World
{
    ...
    {
        using Query<T0, T1, T2, T3, T4, T5, T6, T7> query = Query<T0, T1, T2, T3, T4, T5, T6, T7>();
        query.Each(callback);   
    }
    ...
    /// <param name="callback">The callback.</param>
    /// <typeparam name="T0">The T0 component type.</typeparam> <typeparam name="T1">The T1 component type.</typeparam> <typeparam name="T2">The T2 component type.</typeparam> <typeparam name="T3">The T3 component type.</typeparam> <typeparam name="T4">The T4 component type.</typeparam> <typeparam name="T5">The T5 component type.</typeparam> <typeparam name="T6">The T6 component type.</typeparam> <typeparam name="T7">The T7 component type.</typeparam>
    public void Each<T0, T1, T2, T3, T4, T5, T6, T7>(Ecs.EachPointerCallback<T0, T1, T2, T3, T4, T5, T6, T7> callback)
    {
        using Query<T0, T1, T2, T3, T4, T5, T6, T7> query = Query<T0, T1, T2, T3, T4, T5, T6, T7>();
        query.Each(callback);   
    }
    ...
    /// <param name="callback">The callback.</param>
    /// <typeparam name="T0">The T0 component type.</typeparam> <typeparam name="T1">The T1 component type.</typeparam> <typeparam name="T2">The T2 component type.</typeparam> <typeparam name="T3">The T3 component type.</typeparam> <typeparam name="T4">The T4 component type.</typeparam> <typeparam name="T5">The T5 component type.</typeparam> <typeparam name="T6">The T6 component type.</typeparam> <typeparam name="T7">The T7 component type.</typeparam>
    public void Each<T0, T1, T2, T3, T4, T5, T6, T7>(Ecs.EachEntityPointerCallback<T0, T1, T2, T3, T4, T5, T6, T7> callback)
    {
        using Query<T0, T1, T2, T3, T4, T5, T6, T7> query = Query<T0, T1, T2, T3, T4, T5, T6, T7>();
        query.Each(callback);   
    }
    ...
    /// <param name="callback">The callback.</param>
    /// <typeparam name="T0">The T0 component type.</typeparam> <typeparam name="T1">The T1 component type.</typeparam> <typeparam name="T2">The T2 component type.</typeparam> <typeparam name="T3">The T3 component type.</typeparam> <typeparam name="T4">The T4 component type.</typeparam> <typeparam name="T5">The T5 component type.</typeparam> <typeparam name="T6">The T6 component type.</typeparam> <typeparam name="T7">The T7 component type.</typeparam>
    public void Each<T0, T1, T2, T3, T4, T5, T6, T7>(Ecs.EachIterPointerCallback<T0, T1, T2, T3, T4, T5, T6, T7> callback)
    {
        using Query<T0, T1, T2, T3, T4, T5, T6, T7> query = Query<T0, T1, T2, T3, T4, T5, T6, T7>();
        query.Each(callback);   
    }
    ...
    /// <param name="callback">The callback.</param>
    /// <typeparam name="T0">The T0 component type.</typeparam> <typeparam name="T1">The T1 component type.</typeparam> <typeparam name="T2">The T2 component type.</typeparam> <typeparam name="T3">The T3 component type.</typeparam> <typeparam name="T4">The T4 component type.</typeparam> <typeparam name="T5">The T5 component type.</typeparam> <typeparam name="T6">The T6 component type.</typeparam> <typeparam name="T7">The T7 component type.</typeparam>
    public void Each<T0, T1, T2, T3, T4, T5, T6, T7>(delegate*<T0*, T1*, T2*, T3*, T4*, T5*, T6*, T7*, void> callback)
    {
        using Query<T0, T1, T2, T3, T4, T5, T6, T7> query = Query<T0, T1, T2, T3, T4, T5, T6, T7>();
        query.Each(callback);   
    }
    ...
    /// <param name="callback">The callback.</param>
    /// <typeparam name="T0">The T0 component type.</typeparam> <typeparam name="T1">The T1 component type.</typeparam> <typeparam name="T2">The T2 component type.</typeparam> <typeparam name="T3">The T3 component type.</typeparam> <typeparam name="T4">The T4 component type.</typeparam> <typeparam name="T5">The T5 component type.</typeparam> <typeparam name="T6">The T6 component type.</typeparam> <typeparam name="T7">The T7 component type.</typeparam>
    public void Each<T0, T1, T2, T3, T4, T5, T6, T7>(delegate*<Entity, T0*, T1*, T2*, T3*, T4*, T5*, T6*, T7*, void> callback)
    {
        using Query<T0, T1, T2, T3, T4, T5, T6, T7> query = Query<T0, T1, T2, T3, T4, T5, T6, T7>();
        query.Each(callback);   
    }
    ...
    /// <param name="callback">The callback.</param>
    /// <typeparam name="T0">The T0 component type.</typeparam> <typeparam name="T1">The T1 component type.</typeparam> <typeparam name="T2">The T2 component type.</typeparam> <typeparam name="T3">The T3 component type.</typeparam> <typeparam name="T4">The T4 component type.</typeparam> <typeparam name="T5">The T5 component type.</typeparam> <typeparam name="T6">The T6 component type.</typeparam> <typeparam name="T7">The T7 component type.</typeparam>
    public void Each<T0, T1, T2, T3, T4, T5, T6, T7>(delegate*<Iter, int, T0*, T1*, T2*, T3*, T4*, T5*, T6*, T7*, void> callback)
    {
        using Query<T0, T1, T2, T3, T4, T5, T6, T7> query = Query<T0, T1, T2, T3, T4, T5, T6, T7>();
        query.Each(callback);   
    }
