// /_/src/Flecs.NET/Generated/World/Builders/T7.g.cs
...
{
    public AlertBuilder AlertBuilder<T0, T1, T2, T3, T4, T5, T6>()
    {
        return new AlertBuilder(Handle).With<T0>().With<T1>().With<T2>().With<T3>().With<T4>().With<T5>().With<T6>();
    }

    public AlertBuilder AlertBuilder<T0, T1, T2, T3, T4, T5, T6>(string name)
    {
        return new AlertBuilder(Handle, name).With<T0>().With<T1>().With<T2>().With<T3>().With<T4>().With<T5>().With<T6>();
    }

    public AlertBuilder AlertBuilder<T0, T1, T2, T3, T4, T5, T6>(ulong entity)
    {
        return new AlertBuilder(Handle, entity).With<T0>().With<T1>().With<T2>().With<T3>().With<T4>().With<T5>().With<T6>();
    }

    public Alert Alert<T0, T1, T2, T3, T4, T5, T6>()
    {
        return AlertBuilder<T0, T1, T2, T3, T4, T5, T6>().Build();
    }

    public Alert Alert<T0, T1, T2, T3, T4, T5, T6>(string name)
    {
        return AlertBuilder<T0, T1, T2, T3, T4, T5, T6>(name).Build();
    }

    public Alert Alert<T0, T1, T2, T3, T4, T5, T6>(ulong entity)
    {
    ...
    public SystemBuilder<T0, T1, T2, T3, T4, T5, T6> System<T0, T1, T2, T3, T4, T5, T6>()
    {
        return new SystemBuilder<T0, T1, T2, T3, T4, T5, T6>(Handle);
    }

    public SystemBuilder<T0, T1, T2, T3, T4, T5, T6> System<T0, T1, T2, T3, T4, T5, T6>(string name)
    {
        return new SystemBuilder<T0, T1, T2, T3, T4, T5, T6>(Handle, name);
    }
