// /_/src/Flecs.NET/Generated/QueryBuilder/QueryBuilder/T16.g.cs
...
/// <summary>
///     A type-safe wrapper around <see cref="QueryBuilder"/> that takes 16 type arguments.
/// </summary>
...
public unsafe partial struct QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> : IQueryBuilder<QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>, Query<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>>
{
    ...
    public QueryBuilder(ecs_world_t* world)
    {
        ...
        _queryBuilder = new QueryBuilder(world).With<T0>().With<T1>().With<T2>().With<T3>().With<T4>().With<T5>().With<T6>().With<T7>().With<T8>().With<T9>().With<T10>().With<T11>().With<T12>().With<T13>().With<T14>().With<T15>();
    }
    ...
    {
        Types<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>.AssertNoTags();
        _queryBuilder = new QueryBuilder(world, entity).With<T0>().With<T1>().With<T2>().With<T3>().With<T4>().With<T5>().With<T6>().With<T7>().With<T8>().With<T9>().With<T10>().With<T11>().With<T12>().With<T13>().With<T14>().With<T15>();
    }
    ...
    {
        Types<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>.AssertNoTags();
        _queryBuilder = new QueryBuilder(world, name).With<T0>().With<T1>().With<T2>().With<T3>().With<T4>().With<T5>().With<T6>().With<T7>().With<T8>().With<T9>().With<T10>().With<T11>().With<T12>().With<T13>().With<T14>().With<T15>();
    }

    /// <inheritdoc cref="QueryBuilder.Build()"/>
    public Query<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> Build()
    {
        return new Query<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>(_queryBuilder.Build());
    }
    
    /// <inheritdoc cref="QueryBuilder.Equals(QueryBuilder)"/>
    public bool Equals(QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> other)
    {
    ...
    {
        return obj is QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>  other && Equals(other);
    }
    ...
    public static bool operator ==(QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> left, QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> right)
    {
