// /_/src/Flecs.NET/Generated/QueryBuilder/QueryBuilder/T7.g.cs
...
/// <summary>
///     A type-safe wrapper around <see cref="QueryBuilder"/> that takes 7 type arguments.
/// </summary>
...
public unsafe partial struct QueryBuilder<T0, T1, T2, T3, T4, T5, T6> : IQueryBuilder<QueryBuilder<T0, T1, T2, T3, T4, T5, T6>, Query<T0, T1, T2, T3, T4, T5, T6>>
{
    ...
    public QueryBuilder(ecs_world_t* world)
    {
        ...
        _queryBuilder = new QueryBuilder(world).With<T0>().With<T1>().With<T2>().With<T3>().With<T4>().With<T5>().With<T6>();
    }
    ...
    {
        Types<T0, T1, T2, T3, T4, T5, T6, _, _, _, _, _, _, _, _, _>.AssertNoTags();
        _queryBuilder = new QueryBuilder(world, entity).With<T0>().With<T1>().With<T2>().With<T3>().With<T4>().With<T5>().With<T6>();
    }
    ...
    {
        Types<T0, T1, T2, T3, T4, T5, T6, _, _, _, _, _, _, _, _, _>.AssertNoTags();
        _queryBuilder = new QueryBuilder(world, name).With<T0>().With<T1>().With<T2>().With<T3>().With<T4>().With<T5>().With<T6>();
    }

    /// <inheritdoc cref="QueryBuilder.Build()"/>
    public Query<T0, T1, T2, T3, T4, T5, T6> Build()
    {
        return new Query<T0, T1, T2, T3, T4, T5, T6>(_queryBuilder.Build());
    }
    
    /// <inheritdoc cref="QueryBuilder.Equals(QueryBuilder)"/>
    public bool Equals(QueryBuilder<T0, T1, T2, T3, T4, T5, T6> other)
    {
    ...
    {
        return obj is QueryBuilder<T0, T1, T2, T3, T4, T5, T6>  other && Equals(other);
    }
    ...
    public static bool operator ==(QueryBuilder<T0, T1, T2, T3, T4, T5, T6> left, QueryBuilder<T0, T1, T2, T3, T4, T5, T6> right)
    {
