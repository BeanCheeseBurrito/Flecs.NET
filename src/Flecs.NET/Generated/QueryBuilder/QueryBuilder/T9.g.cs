// /_/src/Flecs.NET/Generated/QueryBuilder/QueryBuilder/T9.g.cs
...
/// <summary>
///     A type-safe wrapper around <see cref="QueryBuilder"/> that takes 9 type arguments.
/// </summary>
...
public unsafe partial struct QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8> : IQueryBuilder<QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8>, Query<T0, T1, T2, T3, T4, T5, T6, T7, T8>>
{
    ...
    public QueryBuilder(ecs_world_t* world)
    {
        ...
        _queryBuilder = new QueryBuilder(world).With<T0>().With<T1>().With<T2>().With<T3>().With<T4>().With<T5>().With<T6>().With<T7>().With<T8>();
    }
    ...
    {
        Types<T0, T1, T2, T3, T4, T5, T6, T7, T8, _, _, _, _, _, _, _>.AssertNoTags();
        _queryBuilder = new QueryBuilder(world, entity).With<T0>().With<T1>().With<T2>().With<T3>().With<T4>().With<T5>().With<T6>().With<T7>().With<T8>();
    }
    ...
    {
        Types<T0, T1, T2, T3, T4, T5, T6, T7, T8, _, _, _, _, _, _, _>.AssertNoTags();
        _queryBuilder = new QueryBuilder(world, name).With<T0>().With<T1>().With<T2>().With<T3>().With<T4>().With<T5>().With<T6>().With<T7>().With<T8>();
    }

    /// <inheritdoc cref="QueryBuilder.Build()"/>
    public Query<T0, T1, T2, T3, T4, T5, T6, T7, T8> Build()
    {
        return new Query<T0, T1, T2, T3, T4, T5, T6, T7, T8>(_queryBuilder.Build());
    }
    
    /// <inheritdoc cref="QueryBuilder.Equals(QueryBuilder)"/>
    public bool Equals(QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8> other)
    {
    ...
    {
        return obj is QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8>  other && Equals(other);
    }
    ...
    public static bool operator ==(QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8> left, QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8> right)
    {
