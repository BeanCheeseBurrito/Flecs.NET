// /_/src/Flecs.NET/Generated/QueryBuilder/QueryBuilder/T2.g.cs
...
/// <summary>
///     A type-safe wrapper around <see cref="QueryBuilder"/> that takes 2 type arguments.
/// </summary>
/// <typeparam name="T0">The T0 component type.</typeparam> <typeparam name="T1">The T1 component type.</typeparam>
public unsafe partial struct QueryBuilder<T0, T1> : IQueryBuilder<QueryBuilder<T0, T1>, Query<T0, T1>>
{
    ...
    public QueryBuilder(ecs_world_t* world)
    {
        ...
        _queryBuilder = new QueryBuilder(world).With<T0>().With<T1>();
    }
    ...
    {
        Types<T0, T1, _, _, _, _, _, _, _, _, _, _, _, _, _, _>.AssertNoTags();
        _queryBuilder = new QueryBuilder(world, entity).With<T0>().With<T1>();
    }
    ...
    {
        Types<T0, T1, _, _, _, _, _, _, _, _, _, _, _, _, _, _>.AssertNoTags();
        _queryBuilder = new QueryBuilder(world, name).With<T0>().With<T1>();
    }

    /// <inheritdoc cref="QueryBuilder.Build()"/>
    public Query<T0, T1> Build()
    {
        return new Query<T0, T1>(_queryBuilder.Build());
    }
    
    /// <inheritdoc cref="QueryBuilder.Equals(QueryBuilder)"/>
    public bool Equals(QueryBuilder<T0, T1> other)
    {
    ...
    {
        return obj is QueryBuilder<T0, T1>  other && Equals(other);
    }
    ...
    public static bool operator ==(QueryBuilder<T0, T1> left, QueryBuilder<T0, T1> right)
    {
