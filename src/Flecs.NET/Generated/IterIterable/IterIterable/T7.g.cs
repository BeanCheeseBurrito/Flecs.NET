// /_/src/Flecs.NET/Generated/IterIterable/IterIterable/T7.g.cs
...
public unsafe partial struct IterIterable<T0, T1, T2, T3, T4, T5, T6> : IEquatable<IterIterable<T0, T1, T2, T3, T4, T5, T6>>
{
    ...
    public ref IterIterable<T0, T1, T2, T3, T4, T5, T6> SetVar(int varId, ulong value)
    {
    ...
    public ref IterIterable<T0, T1, T2, T3, T4, T5, T6> SetVar(string name, ulong value)
    {
    ...
    public ref IterIterable<T0, T1, T2, T3, T4, T5, T6> SetVar(string name, ecs_table_t* value)
    {
        Underlying.SetVar(name, value);
        return ref this;
    }
    ...
    public ref IterIterable<T0, T1, T2, T3, T4, T5, T6> SetVar(string name, ecs_table_range_t value)
    {
        Underlying.SetVar(name, value);
        return ref this;
    }
    ...
    public ref IterIterable<T0, T1, T2, T3, T4, T5, T6> SetVar(string name, Table value)
    {
        Underlying.SetVar(name, value);
        return ref this;
    }
    ...
    public ref IterIterable<T0, T1, T2, T3, T4, T5, T6> SetGroup(ulong groupId)
    {
    ...
    public ref IterIterable<T0, T1, T2, T3, T4, T5, T6> SetGroup<T>()
    {
    ...
    public bool Equals(IterIterable<T0, T1, T2, T3, T4, T5, T6> other)
    {
    ...
    {
        return obj is IterIterable<T0, T1, T2, T3, T4, T5, T6> other && Equals(other);
    }
    ...
    public static bool operator ==(IterIterable<T0, T1, T2, T3, T4, T5, T6> left, IterIterable<T0, T1, T2, T3, T4, T5, T6> right)
    {
...
public unsafe partial struct IterIterable<T0, T1, T2, T3, T4, T5, T6> : IIterIterable
{
...
public unsafe partial struct IterIterable<T0, T1, T2, T3, T4, T5, T6> : IIterable<T0, T1, T2, T3, T4, T5, T6>
{
    ...
    /// <inheritdoc cref="IterIterable.SetVar(int, ulong)"/>
    IterIterable<T0, T1, T2, T3, T4, T5, T6> IIterable<T0, T1, T2, T3, T4, T5, T6>.SetVar(int varId, ulong value)
    {
        return new(Underlying.SetVar(varId, value));
    }
    
    /// <inheritdoc cref="IterIterable.SetVar(string, ulong)"/>
    IterIterable<T0, T1, T2, T3, T4, T5, T6> IIterable<T0, T1, T2, T3, T4, T5, T6>.SetVar(string name, ulong value)
    {
        return new(Underlying.SetVar(name, value));
    }
    
    /// <inheritdoc cref="IterIterable.SetVar(string, ecs_table_t*)"/>
    IterIterable<T0, T1, T2, T3, T4, T5, T6> IIterable<T0, T1, T2, T3, T4, T5, T6>.SetVar(string name, ecs_table_t* value)
    {
        return new(Underlying.SetVar(name, value));
    }
    
    /// <inheritdoc cref="IterIterable.SetVar(string, ecs_table_range_t)"/>
    IterIterable<T0, T1, T2, T3, T4, T5, T6> IIterable<T0, T1, T2, T3, T4, T5, T6>.SetVar(string name, ecs_table_range_t value)
    {
        return new(Underlying.SetVar(name, value));
    }
    
    /// <inheritdoc cref="IterIterable.SetVar(string, Table)"/>
    IterIterable<T0, T1, T2, T3, T4, T5, T6> IIterable<T0, T1, T2, T3, T4, T5, T6>.SetVar(string name, Table value)
    {
        return new(Underlying.SetVar(name, value));
    }
    
    /// <inheritdoc cref="IterIterable.SetGroup(ulong)"/>
    IterIterable<T0, T1, T2, T3, T4, T5, T6> IIterable<T0, T1, T2, T3, T4, T5, T6>.SetGroup(ulong groupId)
    {
        return new(Underlying.SetGroup(groupId));
    }
    
    /// <inheritdoc cref="IterIterable.SetGroup{T}()"/>
    IterIterable<T0, T1, T2, T3, T4, T5, T6> IIterable<T0, T1, T2, T3, T4, T5, T6>.SetGroup<T>()
    {
