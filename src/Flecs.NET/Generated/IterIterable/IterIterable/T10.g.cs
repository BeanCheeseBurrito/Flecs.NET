// /_/src/Flecs.NET/Generated/IterIterable/IterIterable/T10.g.cs
...
public unsafe partial struct IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> : IEquatable<IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>>
{
    ...
    public ref IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> SetVar(int varId, ulong value)
    {
    ...
    public ref IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> SetVar(string name, ulong value)
    {
    ...
    public ref IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> SetVar(string name, ecs_table_t* value)
    {
        Underlying.SetVar(name, value);
        return ref this;
    }
    ...
    public ref IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> SetVar(string name, ecs_table_range_t value)
    {
        Underlying.SetVar(name, value);
        return ref this;
    }
    ...
    public ref IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> SetVar(string name, Table value)
    {
        Underlying.SetVar(name, value);
        return ref this;
    }
    ...
    public ref IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> SetGroup(ulong groupId)
    {
    ...
    public ref IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> SetGroup<T>()
    {
    ...
    public bool Equals(IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> other)
    {
    ...
    {
        return obj is IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> other && Equals(other);
    }
    ...
    public static bool operator ==(IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> left, IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> right)
    {
...
public unsafe partial struct IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> : IIterIterable
{
    ref IterIterable IIterIterable.Underlying => ref Underlying;
}

// IIterableBase Interface
public unsafe partial struct IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> : IIterableBase
{
...
public unsafe partial struct IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> : IIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>
{
    /// <inheritdoc cref="IterIterable.Page(int, int)"/>
    public PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> Page(int offset, int limit)
    {
        return new PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(Underlying.Page(offset, limit));
    }
    ...
    {
        return new WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(Underlying.Worker(index, count));
    }
    ...
    /// <inheritdoc cref="IterIterable.SetVar(int, ulong)"/>
    IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> IIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>.SetVar(int varId, ulong value)
    {
        return new(Underlying.SetVar(varId, value));
    }
    
    /// <inheritdoc cref="IterIterable.SetVar(string, ulong)"/>
    IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> IIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>.SetVar(string name, ulong value)
    {
        return new(Underlying.SetVar(name, value));
    }
    
    /// <inheritdoc cref="IterIterable.SetVar(string, ecs_table_t*)"/>
    IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> IIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>.SetVar(string name, ecs_table_t* value)
    {
        return new(Underlying.SetVar(name, value));
    }
    
    /// <inheritdoc cref="IterIterable.SetVar(string, ecs_table_range_t)"/>
    IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> IIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>.SetVar(string name, ecs_table_range_t value)
    {
        return new(Underlying.SetVar(name, value));
    }
    
    /// <inheritdoc cref="IterIterable.SetVar(string, Table)"/>
    IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> IIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>.SetVar(string name, Table value)
    {
        return new(Underlying.SetVar(name, value));
    }
    
    /// <inheritdoc cref="IterIterable.SetGroup(ulong)"/>
    IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> IIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>.SetGroup(ulong groupId)
    {
        return new(Underlying.SetGroup(groupId));
    }
    
    /// <inheritdoc cref="IterIterable.SetGroup{T}()"/>
    IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> IIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>.SetGroup<T>()
    {
