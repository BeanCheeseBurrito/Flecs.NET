...
public unsafe partial struct IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> : IIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>
{
    ...
    {
        return new PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(_iterIterable.Page(offset, limit));
    }
    ...
    {
        return new WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(_iterIterable.Worker(index, count));
    }
