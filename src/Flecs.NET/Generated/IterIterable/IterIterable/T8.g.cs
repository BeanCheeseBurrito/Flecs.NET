// /_/src/Flecs.NET/Generated/IterIterable/IterIterable/T8.g.cs
...
public unsafe partial struct IterIterable<T0, T1, T2, T3, T4, T5, T6, T7> : IEquatable<IterIterable<T0, T1, T2, T3, T4, T5, T6, T7>>
{
    ...
    public ref IterIterable<T0, T1, T2, T3, T4, T5, T6, T7> SetVar(int varId, ulong value)
    {
    ...
    public ref IterIterable<T0, T1, T2, T3, T4, T5, T6, T7> SetVar(string name, ulong value)
    {
    ...
    public ref IterIterable<T0, T1, T2, T3, T4, T5, T6, T7> SetVar(string name, ecs_table_t* value)
    {
        _iterIterable.SetVar(name, value);
        return ref this;
    }
    ...
    public ref IterIterable<T0, T1, T2, T3, T4, T5, T6, T7> SetVar(string name, ecs_table_range_t value)
    {
        _iterIterable.SetVar(name, value);
        return ref this;
    }
    ...
    public ref IterIterable<T0, T1, T2, T3, T4, T5, T6, T7> SetVar(string name, Table value)
    {
        _iterIterable.SetVar(name, value);
        return ref this;
    }
    ...
    public ref IterIterable<T0, T1, T2, T3, T4, T5, T6, T7> SetGroup(ulong groupId)
    {
    ...
    public ref IterIterable<T0, T1, T2, T3, T4, T5, T6, T7> SetGroup<T>()
    {
    ...
    public bool Equals(IterIterable<T0, T1, T2, T3, T4, T5, T6, T7> other)
    {
    ...
    {
        return obj is IterIterable<T0, T1, T2, T3, T4, T5, T6, T7> other && Equals(other);
    }
    ...
    public static bool operator ==(IterIterable<T0, T1, T2, T3, T4, T5, T6, T7> left, IterIterable<T0, T1, T2, T3, T4, T5, T6, T7> right)
    {
...
public unsafe partial struct IterIterable<T0, T1, T2, T3, T4, T5, T6, T7> : IIterableBase
{
...
public unsafe partial struct IterIterable<T0, T1, T2, T3, T4, T5, T6, T7> : IIterable<T0, T1, T2, T3, T4, T5, T6, T7>
{
    /// <inheritdoc cref="IterIterable.Page(int, int)"/>
    public PageIterable<T0, T1, T2, T3, T4, T5, T6, T7> Page(int offset, int limit)
    {
        return new PageIterable<T0, T1, T2, T3, T4, T5, T6, T7>(_iterIterable.Page(offset, limit));
    }
    
    /// <inheritdoc cref="IterIterable.Worker(int, int)"/>
    public WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7> Worker(int index, int count)
    {
        return new WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7>(_iterIterable.Worker(index, count));
    }
    ...
    /// <inheritdoc cref="IterIterable.SetVar(int, ulong)"/>
    IterIterable<T0, T1, T2, T3, T4, T5, T6, T7> IIterable<T0, T1, T2, T3, T4, T5, T6, T7>.SetVar(int varId, ulong value)
    {
        return new(_iterIterable.SetVar(varId, value));
    }
    
    /// <inheritdoc cref="IterIterable.SetVar(string, ulong)"/>
    IterIterable<T0, T1, T2, T3, T4, T5, T6, T7> IIterable<T0, T1, T2, T3, T4, T5, T6, T7>.SetVar(string name, ulong value)
    {
        return new(_iterIterable.SetVar(name, value));
    }
    
    /// <inheritdoc cref="IterIterable.SetVar(string, ecs_table_t*)"/>
    IterIterable<T0, T1, T2, T3, T4, T5, T6, T7> IIterable<T0, T1, T2, T3, T4, T5, T6, T7>.SetVar(string name, ecs_table_t* value)
    {
        return new(_iterIterable.SetVar(name, value));
    }
    
    /// <inheritdoc cref="IterIterable.SetVar(string, ecs_table_range_t)"/>
    IterIterable<T0, T1, T2, T3, T4, T5, T6, T7> IIterable<T0, T1, T2, T3, T4, T5, T6, T7>.SetVar(string name, ecs_table_range_t value)
    {
        return new(_iterIterable.SetVar(name, value));
    }
    
    /// <inheritdoc cref="IterIterable.SetVar(string, Table)"/>
    IterIterable<T0, T1, T2, T3, T4, T5, T6, T7> IIterable<T0, T1, T2, T3, T4, T5, T6, T7>.SetVar(string name, Table value)
    {
        return new(_iterIterable.SetVar(name, value));
    }
    
    /// <inheritdoc cref="IterIterable.SetGroup(ulong)"/>
    IterIterable<T0, T1, T2, T3, T4, T5, T6, T7> IIterable<T0, T1, T2, T3, T4, T5, T6, T7>.SetGroup(ulong groupId)
    {
        return new(_iterIterable.SetGroup(groupId));
    }
    
    /// <inheritdoc cref="IterIterable.SetGroup{T}()"/>
    IterIterable<T0, T1, T2, T3, T4, T5, T6, T7> IIterable<T0, T1, T2, T3, T4, T5, T6, T7>.SetGroup<T>()
    {
