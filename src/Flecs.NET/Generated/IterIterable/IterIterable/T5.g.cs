// /_/src/Flecs.NET/Generated/IterIterable/IterIterable/T5.g.cs
...
public unsafe partial struct IterIterable<T0, T1, T2, T3, T4> : IEquatable<IterIterable<T0, T1, T2, T3, T4>>
{
    ...
    {
        return obj is IterIterable<T0, T1, T2, T3, T4> other && Equals(other);
    }
    ...
    public static bool operator ==(IterIterable<T0, T1, T2, T3, T4> left, IterIterable<T0, T1, T2, T3, T4> right)
    {
...
public unsafe partial struct IterIterable<T0, T1, T2, T3, T4> : IIterable<T0, T1, T2, T3, T4>
{
