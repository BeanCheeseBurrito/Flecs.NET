// /_/src/Flecs.NET/Generated/WorkerState/T0.g.cs
...
public static unsafe partial class WorkerState<T0>
{
    public struct RunCallbackDelegate
    {
        public CountdownEvent Countdown;
        public WorkerIterable<T0> Worker;
    ...
    public struct IterFieldCallbackDelegate
    {
        public CountdownEvent Countdown;
        public WorkerIterable<T0> Worker;
        public Ecs.IterFieldCallback<T0> Callback;
    }
    ...
    public struct IterSpanCallbackDelegate
    {
        public CountdownEvent Countdown;
        public WorkerIterable<T0> Worker;
        public Ecs.IterSpanCallback<T0> Callback;
    }
    ...
    public struct IterPointerCallbackDelegate
    {
        public CountdownEvent Countdown;
        public WorkerIterable<T0> Worker;
        public Ecs.IterPointerCallback<T0> Callback;
    }
    ...
    public struct IterFieldCallbackPointer
    {
        public CountdownEvent Countdown;
        public WorkerIterable<T0> Worker;
        public delegate*<Iter, Field<T0>, void> Callback;
    }
    ...
    public struct IterSpanCallbackPointer
    {
        public CountdownEvent Countdown;
        public WorkerIterable<T0> Worker;
        public delegate*<Iter, Span<T0>, void> Callback;
    }
    ...
    public struct IterPointerCallbackPointer
    {
        public CountdownEvent Countdown;
        public WorkerIterable<T0> Worker;
        public delegate*<Iter, T0*, void> Callback;
    }
    ...
    public struct EachRefCallbackDelegate
    {
        public CountdownEvent Countdown;
        public WorkerIterable<T0> Worker;
        public Ecs.EachRefCallback<T0> Callback;
    }
    ...
    public struct EachEntityRefCallbackDelegate
    {
        public CountdownEvent Countdown;
        public WorkerIterable<T0> Worker;
        public Ecs.EachEntityRefCallback<T0> Callback;
    }
    ...
    public struct EachIterRefCallbackDelegate
    {
        public CountdownEvent Countdown;
        public WorkerIterable<T0> Worker;
        public Ecs.EachIterRefCallback<T0> Callback;
    }
    ...
    public struct EachRefCallbackPointer
    {
        public CountdownEvent Countdown;
        public WorkerIterable<T0> Worker;
        public delegate*<ref T0, void> Callback;
    }
    ...
    public struct EachEntityRefCallbackPointer
    {
        public CountdownEvent Countdown;
        public WorkerIterable<T0> Worker;
        public delegate*<Entity, ref T0, void> Callback;
    }
    ...
    public struct EachIterRefCallbackPointer
    {
        public CountdownEvent Countdown;
        public WorkerIterable<T0> Worker;
        public delegate*<Iter, int, ref T0, void> Callback;
    }
    ...
    public struct EachPointerCallbackDelegate
    {
        public CountdownEvent Countdown;
        public WorkerIterable<T0> Worker;
        public Ecs.EachPointerCallback<T0> Callback;
    }
    ...
    public struct EachEntityPointerCallbackDelegate
    {
        public CountdownEvent Countdown;
        public WorkerIterable<T0> Worker;
        public Ecs.EachEntityPointerCallback<T0> Callback;
    }
    ...
    public struct EachIterPointerCallbackDelegate
    {
        public CountdownEvent Countdown;
        public WorkerIterable<T0> Worker;
        public Ecs.EachIterPointerCallback<T0> Callback;
    }
    ...
    public struct EachPointerCallbackPointer
    {
        public CountdownEvent Countdown;
        public WorkerIterable<T0> Worker;
        public delegate*<T0*, void> Callback;
    }
    ...
    public struct EachEntityPointerCallbackPointer
    {
        public CountdownEvent Countdown;
        public WorkerIterable<T0> Worker;
        public delegate*<Entity, T0*, void> Callback;
    }
    ...
    public struct EachIterPointerCallbackPointer
    {
        public CountdownEvent Countdown;
        public WorkerIterable<T0> Worker;
        public delegate*<Iter, int, T0*, void> Callback;
    }
}