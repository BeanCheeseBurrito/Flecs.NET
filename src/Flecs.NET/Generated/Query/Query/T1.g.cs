// /_/src/Flecs.NET/Generated/Query/Query/T1.g.cs
...
/// <summary>
///     A type-safe wrapper around <see cref="Query"/> that takes 1 type arguments.
/// </summary>
/// <typeparam name="T0">The T0 component type.</typeparam>
public unsafe partial struct Query<T0> : IDisposable, IEquatable<Query<T0>>
{
    ...
    public static ecs_query_t* To(Query<T0> query)
    {
        return query.Handle;
    }

    /// <inheritdoc cref="Query.ToBoolean(Query)"/>
    public static bool ToBoolean(Query<T0> query)
    {
        return query.Handle != null;
    }

    /// <inheritdoc cref="Query.To(Query)"/>
    public static implicit operator ecs_query_t*(Query<T0> query)
    {
        return To(query);
    }

    /// <inheritdoc cref="Query.ToBoolean(Query)"/>
    public static implicit operator bool(Query<T0> query)
    {
        return ToBoolean(query);
    }

    /// <inheritdoc cref="Query.Equals(Query)"/>
    public bool Equals(Query<T0> other)
    {
    ...
    {
        return obj is Query<T0> other && Equals(other);
    }
    ...
    public static bool operator ==(Query<T0> left, Query<T0> right)
    {
...
public unsafe partial struct Query<T0> : IQuery
{
...
public unsafe partial struct Query<T0> : IIterable<T0>
{
    ...
    {
        return new IterIterable<T0>(Underlying.SetVar(varId, value));
    }
    
    /// <inheritdoc cref="Query.SetVar(string, ulong)"/>
    public IterIterable<T0> SetVar(string name, ulong value)
    {
        return new IterIterable<T0>(Underlying.SetVar(name, value));
    }
    ...
    {
        return new IterIterable<T0>(Underlying.SetGroup(groupId));
    }
    
    /// <inheritdoc cref="Query.SetGroup{T}()"/>
    public IterIterable<T0> SetGroup<T>()
    {
        return new IterIterable<T0>(Underlying.SetGroup<T>());
    }
}