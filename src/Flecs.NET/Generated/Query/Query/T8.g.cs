// /_/src/Flecs.NET/Generated/Query/Query/T8.g.cs
...
/// <summary>
///     A type-safe wrapper around <see cref="Query"/> that takes 8 type arguments.
/// </summary>
...
public unsafe partial struct Query<T0, T1, T2, T3, T4, T5, T6, T7> : IDisposable, IEquatable<Query<T0, T1, T2, T3, T4, T5, T6, T7>>
{
    ...
    public static ecs_query_t* To(Query<T0, T1, T2, T3, T4, T5, T6, T7> query)
    {
        return query.Handle;
    }

    /// <inheritdoc cref="Query.ToBoolean(Query)"/>
    public static bool ToBoolean(Query<T0, T1, T2, T3, T4, T5, T6, T7> query)
    {
        return query.Handle != null;
    }

    /// <inheritdoc cref="Query.To(Query)"/>
    public static implicit operator ecs_query_t*(Query<T0, T1, T2, T3, T4, T5, T6, T7> query)
    {
        return To(query);
    }

    /// <inheritdoc cref="Query.ToBoolean(Query)"/>
    public static implicit operator bool(Query<T0, T1, T2, T3, T4, T5, T6, T7> query)
    {
        return ToBoolean(query);
    }

    /// <inheritdoc cref="Query.Equals(Query)"/>
    public bool Equals(Query<T0, T1, T2, T3, T4, T5, T6, T7> other)
    {
    ...
    {
        return obj is Query<T0, T1, T2, T3, T4, T5, T6, T7> other && Equals(other);
    }
    ...
    public static bool operator ==(Query<T0, T1, T2, T3, T4, T5, T6, T7> left, Query<T0, T1, T2, T3, T4, T5, T6, T7> right)
    {
...
public unsafe partial struct Query<T0, T1, T2, T3, T4, T5, T6, T7> : IIterableBase
{
...
public unsafe partial struct Query<T0, T1, T2, T3, T4, T5, T6, T7> : IIterable<T0, T1, T2, T3, T4, T5, T6, T7>
{
    ...
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5, T6, T7>(_query.SetVar(varId, value));
    }
    
    /// <inheritdoc cref="Query.SetVar(string, ulong)"/>
    public IterIterable<T0, T1, T2, T3, T4, T5, T6, T7> SetVar(string name, ulong value)
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5, T6, T7>(_query.SetVar(name, value));
    }
    ...
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5, T6, T7>(_query.SetGroup(groupId));
    }
    
    /// <inheritdoc cref="Query.SetGroup{T}()"/>
    public IterIterable<T0, T1, T2, T3, T4, T5, T6, T7> SetGroup<T>()
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5, T6, T7>(_query.SetGroup<T>());
    }
}