// /_/src/Flecs.NET/Generated/Query/Query/T10.g.cs
...
public unsafe partial struct Query<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> : IQuery
{
...
public unsafe partial struct Query<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> : IIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>
{
    ...
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(Underlying.SetVar(varId, value));
    }
    ...
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(Underlying.SetVar(name, value));
    }
    ...
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(Underlying.SetGroup(groupId));
    }
    
    /// <inheritdoc cref="Query.SetGroup{T}()"/>
    public IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> SetGroup<T>()
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(Underlying.SetGroup<T>());
    }
}