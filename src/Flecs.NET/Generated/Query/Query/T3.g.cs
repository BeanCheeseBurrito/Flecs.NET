...
public unsafe partial struct Query<T0, T1, T2> : IQuery
{
...
public unsafe partial struct Query<T0, T1, T2> : IIterable<T0, T1, T2>
{
    ...
    {
        return new IterIterable<T0, T1, T2>(Underlying.SetVar(varId, value));
    }
    
    /// <inheritdoc cref="Query.SetVar(string, ulong)"/>
    public IterIterable<T0, T1, T2> SetVar(string name, ulong value)
    {
        return new IterIterable<T0, T1, T2>(Underlying.SetVar(name, value));
    }
    ...
    {
        return new IterIterable<T0, T1, T2>(Underlying.SetGroup(groupId));
    }
    
    /// <inheritdoc cref="Query.SetGroup{T}()"/>
    public IterIterable<T0, T1, T2> SetGroup<T>()
    {
        return new IterIterable<T0, T1, T2>(Underlying.SetGroup<T>());
    }
}