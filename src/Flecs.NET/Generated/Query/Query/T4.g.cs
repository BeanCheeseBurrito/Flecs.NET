// /_/src/Flecs.NET/Generated/Query/Query/T4.g.cs
...
/// <summary>
///     A type-safe wrapper around <see cref="Query"/> that takes 4 type arguments.
/// </summary>
...
public unsafe partial struct Query<T0, T1, T2, T3> : IDisposable, IEquatable<Query<T0, T1, T2, T3>>
{
    ...
    public static ecs_query_t* To(Query<T0, T1, T2, T3> query)
    {
        return query.Handle;
    }

    /// <inheritdoc cref="Query.ToBoolean(Query)"/>
    public static bool ToBoolean(Query<T0, T1, T2, T3> query)
    {
        return query.Handle != null;
    }

    /// <inheritdoc cref="Query.To(Query)"/>
    public static implicit operator ecs_query_t*(Query<T0, T1, T2, T3> query)
    {
        return To(query);
    }

    /// <inheritdoc cref="Query.ToBoolean(Query)"/>
    public static implicit operator bool(Query<T0, T1, T2, T3> query)
    {
    ...
    {
        return obj is Query<T0, T1, T2, T3> other && Equals(other);
    }
    ...
    public static bool operator ==(Query<T0, T1, T2, T3> left, Query<T0, T1, T2, T3> right)
    {
...
public unsafe partial struct Query<T0, T1, T2, T3> : IIterable<T0, T1, T2, T3>
{
