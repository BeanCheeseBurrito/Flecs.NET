...
public unsafe partial struct Query<T0, T1, T2, T3, T4, T5> : IIterable<T0, T1, T2, T3, T4, T5>
{
    ...
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5>(_query.SetVar(varId, value));
    }
    
    /// <inheritdoc cref="Query.SetVar(string, ulong)"/>
    public IterIterable<T0, T1, T2, T3, T4, T5> SetVar(string name, ulong value)
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5>(_query.SetVar(name, value));
    }
    ...
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5>(_query.SetGroup(groupId));
    }
    
    /// <inheritdoc cref="Query.SetGroup{T}()"/>
    public IterIterable<T0, T1, T2, T3, T4, T5> SetGroup<T>()
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5>(_query.SetGroup<T>());
    }
}