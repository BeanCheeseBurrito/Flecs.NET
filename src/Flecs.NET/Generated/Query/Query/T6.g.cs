// /_/src/Flecs.NET/Generated/Query/Query/T6.g.cs
...
/// <summary>
///     A type-safe wrapper around <see cref="Query"/> that takes 6 type arguments.
/// </summary>
...
public unsafe partial struct Query<T0, T1, T2, T3, T4, T5> : IDisposable, IEquatable<Query<T0, T1, T2, T3, T4, T5>>
{
    ...
    public static ecs_query_t* To(Query<T0, T1, T2, T3, T4, T5> query)
    {
        return query.Handle;
    }

    /// <inheritdoc cref="Query.ToBoolean(Query)"/>
    public static bool ToBoolean(Query<T0, T1, T2, T3, T4, T5> query)
    {
        return query.Handle != null;
    }

    /// <inheritdoc cref="Query.To(Query)"/>
    public static implicit operator ecs_query_t*(Query<T0, T1, T2, T3, T4, T5> query)
    {
        return To(query);
    }

    /// <inheritdoc cref="Query.ToBoolean(Query)"/>
    public static implicit operator bool(Query<T0, T1, T2, T3, T4, T5> query)
    {
        return ToBoolean(query);
    }

    /// <inheritdoc cref="Query.Equals(Query)"/>
    public bool Equals(Query<T0, T1, T2, T3, T4, T5> other)
    {
    ...
    {
        return obj is Query<T0, T1, T2, T3, T4, T5> other && Equals(other);
    }
    ...
    public static bool operator ==(Query<T0, T1, T2, T3, T4, T5> left, Query<T0, T1, T2, T3, T4, T5> right)
    {
...
public unsafe partial struct Query<T0, T1, T2, T3, T4, T5> : IQuery
{
    ref Query IQuery.Underlying => ref Underlying;
}

// IIterableBase Interface
public unsafe partial struct Query<T0, T1, T2, T3, T4, T5> : IIterableBase
{
...
public unsafe partial struct Query<T0, T1, T2, T3, T4, T5> : IIterable<T0, T1, T2, T3, T4, T5>
{
    ...
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5>(Underlying.SetVar(varId, value));
    }
    
    /// <inheritdoc cref="Query.SetVar(string, ulong)"/>
    public IterIterable<T0, T1, T2, T3, T4, T5> SetVar(string name, ulong value)
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5>(Underlying.SetVar(name, value));
    }
    ...
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5>(Underlying.SetGroup(groupId));
    }
    
    /// <inheritdoc cref="Query.SetGroup{T}()"/>
    public IterIterable<T0, T1, T2, T3, T4, T5> SetGroup<T>()
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5>(Underlying.SetGroup<T>());
    }
}