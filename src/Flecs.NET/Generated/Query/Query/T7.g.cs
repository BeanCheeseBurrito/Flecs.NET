// /_/src/Flecs.NET/Generated/Query/Query/T7.g.cs
...
/// <summary>
///     A type-safe wrapper around <see cref="Query"/> that takes 7 type arguments.
/// </summary>
...
public unsafe partial struct Query<T0, T1, T2, T3, T4, T5, T6> : IDisposable, IEquatable<Query<T0, T1, T2, T3, T4, T5, T6>>
{
    ...
    public static ecs_query_t* To(Query<T0, T1, T2, T3, T4, T5, T6> query)
    {
        return query.Handle;
    }

    /// <inheritdoc cref="Query.ToBoolean(Query)"/>
    public static bool ToBoolean(Query<T0, T1, T2, T3, T4, T5, T6> query)
    {
        return query.Handle != null;
    }

    /// <inheritdoc cref="Query.To(Query)"/>
    public static implicit operator ecs_query_t*(Query<T0, T1, T2, T3, T4, T5, T6> query)
    {
        return To(query);
    }

    /// <inheritdoc cref="Query.ToBoolean(Query)"/>
    public static implicit operator bool(Query<T0, T1, T2, T3, T4, T5, T6> query)
    {
        return ToBoolean(query);
    }

    /// <inheritdoc cref="Query.Equals(Query)"/>
    public bool Equals(Query<T0, T1, T2, T3, T4, T5, T6> other)
    {
    ...
    {
        return obj is Query<T0, T1, T2, T3, T4, T5, T6> other && Equals(other);
    }
    ...
    public static bool operator ==(Query<T0, T1, T2, T3, T4, T5, T6> left, Query<T0, T1, T2, T3, T4, T5, T6> right)
    {
...
public unsafe partial struct Query<T0, T1, T2, T3, T4, T5, T6> : IQuery
{
    ref Query IQuery.Underlying => ref Underlying;
}

// IIterableBase Interface
public unsafe partial struct Query<T0, T1, T2, T3, T4, T5, T6> : IIterableBase
{
...
// IIterable<T0, T1, T2, T3, T4, T5, T6> Interface
public unsafe partial struct Query<T0, T1, T2, T3, T4, T5, T6> : IIterable<T0, T1, T2, T3, T4, T5, T6>
{
    /// <inheritdoc cref="Query.Page(int, int)"/>
    public PageIterable<T0, T1, T2, T3, T4, T5, T6> Page(int offset, int limit)
    {
        return new PageIterable<T0, T1, T2, T3, T4, T5, T6>(Underlying.Page(offset, limit));
    }
    
    /// <inheritdoc cref="Query.Worker(int, int)"/>
    public WorkerIterable<T0, T1, T2, T3, T4, T5, T6> Worker(int index, int count)
    {
        return new WorkerIterable<T0, T1, T2, T3, T4, T5, T6>(Underlying.Worker(index, count));
    }

    /// <inheritdoc cref="Query.Iter(Flecs.NET.Core.World)"/>
    public IterIterable<T0, T1, T2, T3, T4, T5, T6> Iter(World world = default)
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5, T6>(Underlying.Iter(world));
    }
    
    /// <inheritdoc cref="Query.Iter(Flecs.NET.Core.Iter)"/>
    public IterIterable<T0, T1, T2, T3, T4, T5, T6> Iter(Iter it)
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5, T6>(Underlying.Iter(it));
    }
    
    /// <inheritdoc cref="Query.Iter(Flecs.NET.Core.Entity)"/>
    public IterIterable<T0, T1, T2, T3, T4, T5, T6> Iter(Entity entity)
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5, T6>(Underlying.Iter(entity));
    }
    ...
    public IterIterable<T0, T1, T2, T3, T4, T5, T6> SetVar(int varId, ulong value)
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5, T6>(Underlying.SetVar(varId, value));
    }
    
    /// <inheritdoc cref="Query.SetVar(string, ulong)"/>
    public IterIterable<T0, T1, T2, T3, T4, T5, T6> SetVar(string name, ulong value)
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5, T6>(Underlying.SetVar(name, value));
    }
    
    /// <inheritdoc cref="Query.SetVar(string, ecs_table_t*)"/>
    public IterIterable<T0, T1, T2, T3, T4, T5, T6> SetVar(string name, ecs_table_t* value)
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5, T6>(Underlying.SetVar(name, value));
    }
    
    /// <inheritdoc cref="Query.SetVar(string, ecs_table_range_t)"/>
    public IterIterable<T0, T1, T2, T3, T4, T5, T6> SetVar(string name, ecs_table_range_t value)
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5, T6>(Underlying.SetVar(name, value));
    }
    
    /// <inheritdoc cref="Query.SetVar(string, Table)"/>
    public IterIterable<T0, T1, T2, T3, T4, T5, T6> SetVar(string name, Table value)
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5, T6>(Underlying.SetVar(name, value));
    }
    
    /// <inheritdoc cref="Query.SetGroup(ulong)"/>
    public IterIterable<T0, T1, T2, T3, T4, T5, T6> SetGroup(ulong groupId)
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5, T6>(Underlying.SetGroup(groupId));
    }
    
    /// <inheritdoc cref="Query.SetGroup{T}()"/>
    public IterIterable<T0, T1, T2, T3, T4, T5, T6> SetGroup<T>()
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5, T6>(Underlying.SetGroup<T>());
    }
}