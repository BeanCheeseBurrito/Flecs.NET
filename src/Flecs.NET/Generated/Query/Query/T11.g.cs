...
public unsafe partial struct Query<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : IIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
{
    ...
    {
        return new PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(_query.Page(offset, limit));
    }
    
    /// <inheritdoc cref="Query.Worker(int, int)"/>
    public WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> Worker(int index, int count)
    {
        return new WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(_query.Worker(index, count));
    }
    ...
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(_query.SetVar(varId, value));
    }
    ...
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(_query.SetVar(name, value));
    }
    ...
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(_query.SetGroup(groupId));
    }
    
    /// <inheritdoc cref="Query.SetGroup{T}()"/>
    public IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> SetGroup<T>()
    {
        return new IterIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(_query.SetGroup<T>());
    }
}