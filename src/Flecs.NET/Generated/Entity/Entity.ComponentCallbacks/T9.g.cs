// /_/src/Flecs.NET/Generated/Entity/Entity.ComponentCallbacks/T9.g.cs
...
{
    /// <summary>
    ///     Read 9 components using the provided callback. <br/><br/>
    /// 
    ...
    public bool Read<T0, T1, T2, T3, T4, T5, T6, T7, T8>(Ecs.ReadRefCallback<T0, T1, T2, T3, T4, T5, T6, T7, T8> callback)
    {
        return Invoker<T0, T1, T2, T3, T4, T5, T6, T7, T8, _, _, _, _, _, _, _>.Read<ReadRefCallbackDelegate<T0, T1, T2, T3, T4, T5, T6, T7, T8>>(new Entity(World, Id), callback);
    }

    /// <summary>
    ///     Write 9 components using the provided callback. <br/><br/>
    /// 
    ///     This operation accepts a callback with as arguments the components to
    ///     retrieve. The callback will only be invoked when the entity has all
    ///     the components. <br/><br/>
    ...
    /// <typeparam name="T0">The T0 component type.</typeparam> <typeparam name="T1">The T1 component type.</typeparam> <typeparam name="T2">The T2 component type.</typeparam> <typeparam name="T3">The T3 component type.</typeparam> <typeparam name="T4">The T4 component type.</typeparam> <typeparam name="T5">The T5 component type.</typeparam> <typeparam name="T6">The T6 component type.</typeparam> <typeparam name="T7">The T7 component type.</typeparam> <typeparam name="T8">The T8 component type.</typeparam>
    /// <returns>True if the entity has the specified components.</returns>
    public bool Write<T0, T1, T2, T3, T4, T5, T6, T7, T8>(Ecs.WriteRefCallback<T0, T1, T2, T3, T4, T5, T6, T7, T8> callback)
    {
        return Invoker<T0, T1, T2, T3, T4, T5, T6, T7, T8, _, _, _, _, _, _, _>.Write<WriteRefCallbackDelegate<T0, T1, T2, T3, T4, T5, T6, T7, T8>>(new Entity(World, Id), callback);
    }

    /// <summary>
    ///     Ensures 9 components using the provided callback.<br/><br/>
    /// 
    ///     This operation accepts a callback with as arguments the components to
    ...
    public ref Entity Insert<T0, T1, T2, T3, T4, T5, T6, T7, T8>(Ecs.InsertRefCallback<T0, T1, T2, T3, T4, T5, T6, T7, T8> callback)
    {
        Invoker<T0, T1, T2, T3, T4, T5, T6, T7, T8, _, _, _, _, _, _, _>.Insert<InsertRefCallbackDelegate<T0, T1, T2, T3, T4, T5, T6, T7, T8>>(new Entity(World, Id), callback);
        return ref this;
    }
}