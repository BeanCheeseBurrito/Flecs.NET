// /_/src/Flecs.NET/Generated/Entity/Entity.ComponentCallbacks/T6.g.cs
...
{
    /// <summary>
    ///     Read 6 components using the provided callback. <br/><br/>
    /// 
    ...
    /// <summary>
    ///     Write 6 components using the provided callback. <br/><br/>
    /// 
    ///     This operation accepts a callback with as arguments the components to
    ///     retrieve. The callback will only be invoked when the entity has all
    ///     the components. <br/><br/>
    ...
    /// <summary>
    ///     Ensures 6 components using the provided callback.<br/><br/>
    /// 
    ///     This operation accepts a callback with as arguments the components to
