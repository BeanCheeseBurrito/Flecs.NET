...
public unsafe partial struct Entity
{
    ...
    {
        return Invoker<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, _, _, _>.Read<ReadRefCallbackDelegate<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>>(new Entity(World, Id), callback);
    }
    ...
    {
        return Invoker<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, _, _, _>.Write<WriteRefCallbackDelegate<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>>(new Entity(World, Id), callback);
    }
    ...
    {
        Invoker<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, _, _, _>.Insert<InsertRefCallbackDelegate<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>>(new Entity(World, Id), callback);
        return ref this;
    }
}