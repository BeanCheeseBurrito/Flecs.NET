// /_/src/Flecs.NET/Generated/Entity/Entity.ComponentCallbacks/T12.g.cs
...
public unsafe partial struct Entity
{
    ...
    {
        return Invoker<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, _, _, _, _>.Read<ReadRefCallbackDelegate<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>>(new Entity(World, Id), callback);
    }
    ...
    {
        return Invoker<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, _, _, _, _>.Write<WriteRefCallbackDelegate<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>>(new Entity(World, Id), callback);
    }
    ...
    {
        Invoker<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, _, _, _, _>.Insert<InsertRefCallbackDelegate<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>>(new Entity(World, Id), callback);
        return ref this;
    }
}