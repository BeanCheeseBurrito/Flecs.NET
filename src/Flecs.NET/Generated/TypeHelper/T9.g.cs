// /_/src/Flecs.NET/Generated/TypeHelper/T9.g.cs
...
internal static unsafe partial class TypeHelper<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>
{
    private static string[]? _typeNames;
    public static string[] TypeNames => _typeNames ??= [ Type<T0>.FullName, Type<T1>.FullName, Type<T2>.FullName, Type<T3>.FullName, Type<T4>.FullName, Type<T5>.FullName, Type<T6>.FullName, Type<T7>.FullName, Type<T8>.FullName, Type<T9>.FullName ];
    
    public static readonly int Tags = (Type<T0>.IsTag ? 1 << 0 : 0) | (Type<T1>.IsTag ? 1 << 1 : 0) | (Type<T2>.IsTag ? 1 << 2 : 0) | (Type<T3>.IsTag ? 1 << 3 : 0) | (Type<T4>.IsTag ? 1 << 4 : 0) | (Type<T5>.IsTag ? 1 << 5 : 0) | (Type<T6>.IsTag ? 1 << 6 : 0) | (Type<T7>.IsTag ? 1 << 7 : 0) | (Type<T8>.IsTag ? 1 << 8 : 0) | (Type<T9>.IsTag ? 1 << 9 : 0);
    public static readonly int ReferenceTypes = (RuntimeHelpers.IsReferenceOrContainsReferences<T0>() ? 1 << 0 : 0) | (RuntimeHelpers.IsReferenceOrContainsReferences<T1>() ? 1 << 1 : 0) | (RuntimeHelpers.IsReferenceOrContainsReferences<T2>() ? 1 << 2 : 0) | (RuntimeHelpers.IsReferenceOrContainsReferences<T3>() ? 1 << 3 : 0) | (RuntimeHelpers.IsReferenceOrContainsReferences<T4>() ? 1 << 4 : 0) | (RuntimeHelpers.IsReferenceOrContainsReferences<T5>() ? 1 << 5 : 0) | (RuntimeHelpers.IsReferenceOrContainsReferences<T6>() ? 1 << 6 : 0) | (RuntimeHelpers.IsReferenceOrContainsReferences<T7>() ? 1 << 7 : 0) | (RuntimeHelpers.IsReferenceOrContainsReferences<T8>() ? 1 << 8 : 0) | (RuntimeHelpers.IsReferenceOrContainsReferences<T9>() ? 1 << 9 : 0);
