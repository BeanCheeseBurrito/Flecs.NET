// /_/src/Flecs.NET/Generated/Invoker/Write/T10.g.cs
// File was auto-generated by /_/src/Flecs.NET.Codegen/Generators/Invoker.cs
using System;

namespace Flecs.NET.Core.Invokers;

internal unsafe struct WriteRefCallbackDelegate<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> : IWriteInvoker
{
    public static void Invoke(void** pointers, InvokerCallback callback)
    {
        Ecs.WriteRefCallback<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> invoke = (Ecs.WriteRefCallback<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>)callback;
