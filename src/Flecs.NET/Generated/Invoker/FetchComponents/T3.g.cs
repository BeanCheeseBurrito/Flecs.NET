// /_/src/Flecs.NET/Generated/Invoker/FetchComponents/T3.g.cs
...
public static unsafe partial class Invoker
{
    ...
    public static bool Read<T0, T1, T2>(ecs_world_t* world, ulong entity, Ecs.ReadRefCallback<T0, T1, T2> callback)
    {
        ...
        void** pointers = stackalloc void*[3];
        bool hasComponents = Ecs.GetPointers<T0, T1, T2>(world, entity, record, table, pointers);
    ...
    /// <typeparam name="T0">The T0 component type.</typeparam> <typeparam name="T1">The T1 component type.</typeparam> <typeparam name="T2">The T2 component type.</typeparam>
    /// <returns>True if the entity has the specified components.</returns>
    public static bool Write<T0, T1, T2>(ecs_world_t* world, ulong entity, Ecs.WriteRefCallback<T0, T1, T2> callback)
    {
    ...
    /// <typeparam name="T0">The T0 component type.</typeparam> <typeparam name="T1">The T1 component type.</typeparam> <typeparam name="T2">The T2 component type.</typeparam>
    /// <returns></returns>
    public static bool Insert<T0, T1, T2>(World world, ulong entity, Ecs.InsertRefCallback<T0, T1, T2> callback)
    {
        ...
        if (!world.IsDeferred())
        {
            ...
            ulong* added = stackalloc ulong[3];
            int addedCount = 0;
            ...
            if (!Ecs.GetPointers<T0, T1, T2>(world, entity, record, table, pointers))
        ...
        {
            Ecs.EnsurePointers<T0, T1, T2>(world, entity, pointers);
        }
        ...
        ecs_modified_id(world, entity, ids[0]); ecs_modified_id(world, entity, ids[1]); ecs_modified_id(world, entity, ids[2]);
