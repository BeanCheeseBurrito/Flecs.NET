// /_/src/Flecs.NET/Generated/Pipeline/Pipeline.Entity/T4.g.cs
...
public unsafe partial struct Pipeline<T0, T1, T2, T3>
{
    ...
    public ref Pipeline<T0, T1, T2, T3> Add(ulong id)
    {
        Entity.Add(id);
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> Add(ulong first, ulong second)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Add<T>()
    {
        Entity.Add<T>();
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> Add<TFirst>(ulong second)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Add<T>(T value) where T : Enum
    {
        Entity.Add(value);
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> Add<TFirst, TSecond>()
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Add<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Add<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> AddSecond<TSecond>(ulong first)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> AddIf(bool cond, ulong id)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> AddIf(bool cond, ulong first, ulong second)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> AddIf<T>(bool cond)
    {
        Entity.AddIf<T>(cond);
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> AddIf<T>(bool cond, T value) where T : Enum
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> AddIf<TFirst>(bool cond, ulong second)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> AddIf<TFirst, TSecond>(bool cond)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> AddIf<TFirst, TSecond>(bool cond, TSecond second) where TSecond : Enum
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> AddIf<TFirst, TSecond>(bool cond, TFirst first) where TFirst : Enum
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> AddIfSecond<TSecond>(bool cond, ulong first)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> IsA(ulong id)
    {
        Entity.IsA(id);
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> IsA<T>()
    {
        Entity.IsA<T>();
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> IsA<T>(T value) where T : Enum
    {
        Entity.IsA(value);
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> ChildOf(ulong second)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> ChildOf<T>()
    {
        Entity.ChildOf<T>();
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> ChildOf<T>(T value) where T : Enum
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> DependsOn(ulong second)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> DependsOn<T>()
    {
        Entity.DependsOn<T>();
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> DependsOn<T>(T value) where T : Enum
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> SlotOf(ulong id)
    {
        Entity.SlotOf(id);
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> SlotOf<T>()
    {
        Entity.SlotOf<T>();
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> SlotOf<T>(T value) where T : Enum
    {
        Entity.SlotOf(value);
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> Slot()
    {
        Entity.Slot();
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> Remove(ulong id)
    {
        Entity.Remove(id);
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> Remove(ulong first, ulong second)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Remove<T>()
    {
        Entity.Remove<T>();
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> Remove<T>(T value) where T : Enum
    {
        Entity.Remove(value);
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> Remove<TFirst>(ulong second)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Remove<TFirst, TSecond>()
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Remove<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Remove<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> RemoveSecond<TSecond>(ulong first)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> AutoOverride(ulong id)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> AutoOverride(ulong first, ulong second)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> AutoOverride<T>()
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> AutoOverride<T>(T value) where T : Enum
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> AutoOverride<TFirst>(ulong second)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> AutoOverride<TFirst, TSecond>()
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> AutoOverride<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> AutoOverride<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> AutoOverrideSecond<TSecond>(ulong first)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Enable()
    {
        Entity.Enable();
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> Enable(ulong id)
    {
        Entity.Enable(id);
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> Enable(ulong first, ulong second)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Enable<T>()
    {
        Entity.Enable<T>();
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> Enable<T>(T value) where T : Enum
    {
        Entity.Enable(value);
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> Enable<TFirst>(ulong second)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Enable<TFirst, TSecond>()
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Enable<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Enable<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> EnableSecond<TSecond>(ulong first)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Disable()
    {
        Entity.Disable();
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> Disable(ulong id)
    {
        Entity.Disable(id);
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> Disable(ulong first, ulong second)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Disable<T>()
    {
        Entity.Disable<T>();
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> Disable<T>(T value) where T : Enum
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Disable<TFirst>(ulong second)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Disable<TFirst, TSecond>()
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Disable<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Disable<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> DisableSecond<TSecond>(ulong first)
    {
    ...
    ///
    public ref Pipeline<T0, T1, T2, T3> SetUntyped(ulong id, int size, void* data)
    {
    ...
    ///
    public ref Pipeline<T0, T1, T2, T3> SetUntyped(ulong id, void* data)
    {
    ...
    ///
    public ref Pipeline<T0, T1, T2, T3> SetUntyped(ulong first, ulong second, int size, void* data)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> SetPtr<T>(T* data)
    {
        Entity.SetPtr(data);
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> SetPtr<TFirst>(ulong second, TFirst* data)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> SetPtr<TFirst, TSecond>(TSecond* data)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> SetPtr<TFirst, TSecond>(TFirst* data)
    {
        Entity.SetPtr<TFirst, TSecond>(data);
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> SetPtr<TFirst, TSecond>(TSecond second, TFirst* data) where TSecond : Enum
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> SetPtr<TFirst, TSecond>(TFirst first, TSecond* data) where TFirst : Enum
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> SetPtrSecond<TSecond>(ulong first, TSecond* data)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> With(Action callback)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> With(ulong first, Action callback)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> With<TFirst>(Action callback)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> With(Ecs.WorldCallback callback)
    {
        Entity.With(callback);
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> With(ulong first, Ecs.WorldCallback callback)
    {
        Entity.With(first, callback);
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> With<TFirst>(Ecs.WorldCallback callback)
    {
        Entity.With<TFirst>(callback);
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> Scope(Action callback)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Scope(Ecs.WorldCallback callback)
    {
        Entity.Scope(callback);
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> SetName(string name)
    {
        Entity.SetName(name);
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> SetAlias(string alias)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> SetDocName(string name)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> SetDocBrief(string brief)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> SetDocDetail(string detail)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> SetDocLink(string link)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> SetDocColor(string color)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> SetDocUuid(string uuid)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Unit(
        string symbol,
        ulong prefix = 0,
        ulong @base = 0,
        ulong over = 0,
    ...
    public ref Pipeline<T0, T1, T2, T3> UnitPrefix(string symbol, int factor = 0, int power = 0)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Quantity(ulong quantity)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Quantity<T>()
    {
        Entity.Quantity<T>();
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> Quantity()
    {
        Entity.Quantity();
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> SetJson(ulong e, string json, ecs_from_json_desc_t* desc = null)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> SetJson(ulong first, ulong second, string json, ecs_from_json_desc_t* desc = null)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> SetJson<T>(string json, ecs_from_json_desc_t* desc = null)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> SetJson<TFirst>(ulong second, string json, ecs_from_json_desc_t* desc = null)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> SetJson<TFirst, TSecond>(string json, ecs_from_json_desc_t* desc = null)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> SetJson<TFirst, TSecond>(TSecond second, string json, ecs_from_json_desc_t* desc = null) where TSecond : Enum
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> SetJson<TFirst, TSecond>(TFirst first, string json, ecs_from_json_desc_t* desc = null) where TFirst : Enum
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> SetJsonSecond<TSecond>(ulong first, string json, ecs_from_json_desc_t* desc = null)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Observe(ulong eventId, Action callback)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Observe(ulong eventId, Ecs.ObserveEntityCallback callback)
    {
        Entity.Observe(eventId, callback);
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> Observe<T>(Action callback)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Observe<T>(Ecs.ObserveEntityCallback callback)
    {
        Entity.Observe<T>(callback);
        return ref this;
    }
    ...
    public ref Pipeline<T0, T1, T2, T3> Observe<T>(Ecs.ObserveRefCallback<T> callback)
    {
    ...
    public ref Pipeline<T0, T1, T2, T3> Observe<T>(Ecs.ObserveEntityRefCallback<T> callback)
    {
        Entity.Observe(callback);
        return ref this;
    }
