// /_/src/Flecs.NET/Generated/Pipeline/Pipeline/T3.g.cs
...
public unsafe partial struct Pipeline<T0, T1, T2> : IEquatable<Pipeline<T0, T1, T2>>, IEntity<Pipeline<T0, T1, T2>>
{
