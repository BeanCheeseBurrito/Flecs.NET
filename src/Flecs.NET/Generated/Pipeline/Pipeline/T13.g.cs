// /_/src/Flecs.NET/Generated/Pipeline/Pipeline/T13.g.cs
...
/// <summary>
///     A type-safe wrapper around <see cref="Pipeline"/> that takes 13 type arguments.
/// </summary>
...
public unsafe partial struct Pipeline<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> : IEquatable<Pipeline<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>>, IEntity<Pipeline<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>>
{
    ...
    public static implicit operator ulong(Pipeline<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> pipeline)
    {
        return ToUInt64(pipeline);
    }

    /// <inheritdoc cref="Pipeline.ToId(Pipeline)"/>
    public static implicit operator Id(Pipeline<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> pipeline)
    {
        return ToId(pipeline);
    }

    /// <inheritdoc cref="Pipeline.ToEntity(Pipeline)"/>
    public static implicit operator Entity(Pipeline<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> pipeline)
    {
        return ToEntity(pipeline);
    }

    /// <inheritdoc cref="Pipeline.ToUInt64(Pipeline)"/>
    public static ulong ToUInt64(Pipeline<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> pipeline)
    {
        return pipeline.Entity;
    }

    /// <inheritdoc cref="Pipeline.ToId(Pipeline)"/>
    public static Id ToId(Pipeline<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> pipeline)
    {
        return pipeline.Id;
    }

    /// <inheritdoc cref="Pipeline.ToEntity(Pipeline)"/>
    public static Entity ToEntity(Pipeline<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> pipeline)
    {
        return pipeline.Entity;
    }
    ...
    public bool Equals(Pipeline<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> other)
    {
    ...
    {
        return obj is Pipeline<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> other && Equals(other);
    }
    ...
    public static bool operator ==(Pipeline<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> left, Pipeline<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> right)
    {
