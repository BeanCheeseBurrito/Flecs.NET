...
public unsafe partial struct SystemBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8> : IDisposable, IEquatable<SystemBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8>>, IQueryBuilder<SystemBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8>, System<T0, T1, T2, T3, T4, T5, T6, T7, T8>>
{
    ...
    internal ref SystemBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8> SetCallback<T>(T callback, void* invoker) where T : Delegate
    {
        _systemBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8> SetCallback(void* callback, void* invoker)
    {
        _systemBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8> SetRun<T>(T callback, void* invoker) where T : Delegate
    {
        _systemBuilder.SetRun(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8> SetRun(void* callback, void* invoker)
    {
        _systemBuilder.SetRun(callback, invoker);
        return ref this;
    }
