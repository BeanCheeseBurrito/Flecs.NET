...
public unsafe partial struct SystemBuilder<T0, T1, T2> : IDisposable, IEquatable<SystemBuilder<T0, T1, T2>>, IQueryBuilder<SystemBuilder<T0, T1, T2>, System<T0, T1, T2>>
{
    ...
    internal ref SystemBuilder<T0, T1, T2> SetCallback(InvokerCallback callback, delegate*<ecs_iter_t*, void> invoker)
    {
        _systemBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0, T1, T2> SetRun(InvokerCallback callback, delegate*<ecs_iter_t*, void> invoker)
    {
