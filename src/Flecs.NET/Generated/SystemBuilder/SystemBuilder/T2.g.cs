// /_/src/Flecs.NET/Generated/SystemBuilder/SystemBuilder/T2.g.cs
...
/// <summary>
///     A type-safe wrapper over <see cref="SystemBuilder"/> that takes 2 type arguments.
/// </summary>
/// <typeparam name="T0">The T0 component type.</typeparam> <typeparam name="T1">The T1 component type.</typeparam>
public unsafe partial struct SystemBuilder<T0, T1> : IDisposable, IEquatable<SystemBuilder<T0, T1>>, IQueryBuilder<SystemBuilder<T0, T1>, System<T0, T1>>
{
    ...
    {
        TypeHelper<T0, T1>.AssertNoTags();
        _systemBuilder = new SystemBuilder(world).With<T0>().With<T1>();
    }
    ...
    {
        TypeHelper<T0, T1>.AssertNoTags();
        _systemBuilder = new SystemBuilder(world, name).With<T0>().With<T1>();
    }
    ...
    public ref SystemBuilder<T0, T1> Kind(ulong phase)
    {
    ...
    public ref SystemBuilder<T0, T1> Kind<T>()
    {
    ...
    public ref SystemBuilder<T0, T1> Kind<T>(T value) where T : Enum
    {
    ...
    public ref SystemBuilder<T0, T1> MultiThreaded(bool value = true)
    {
    ...
    public ref SystemBuilder<T0, T1> Immediate(bool value = true)
    {
    ...
    public ref SystemBuilder<T0, T1> Interval(float interval)
    {
    ...
    public ref SystemBuilder<T0, T1> Rate(ulong tickSource, int rate)
    {
    ...
    public ref SystemBuilder<T0, T1> Rate(int rate)
    {
    ...
    public ref SystemBuilder<T0, T1> TickSource(ulong tickSource)
    {
    ...
    public ref SystemBuilder<T0, T1> TickSource<T>()
    {
    ...
    public ref SystemBuilder<T0, T1> Ctx<T>(T value)
    {
    ...
    public ref SystemBuilder<T0, T1> Ctx<T>(T value, Ecs.UserContextFinish<T> callback)
    {
    ...
    /// <inheritdoc cref="SystemBuilder.Ctx{T}(T, Ecs.UserContextFinish{T})"/>
    public ref SystemBuilder<T0, T1> Ctx<T>(T value, delegate*<ref T, void> callback)
    {
        _systemBuilder.Ctx(ref value, callback);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1> Ctx<T>(ref T value)
    {
        _systemBuilder.Ctx(ref value);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1> Ctx<T>(ref T value, Ecs.UserContextFinish<T> callback)
    {
        _systemBuilder.Ctx(ref value, callback);
        return ref this;
    }
    ...
    /// <inheritdoc cref="SystemBuilder.Ctx{T}(ref T, Ecs.UserContextFinish{T})"/>
    public ref SystemBuilder<T0, T1> Ctx<T>(ref T value, delegate*<ref T, void> callback)
    {
        _systemBuilder.Ctx(ref value, callback);
        return ref this;
    }
    ...
    public System<T0, T1> Run(Action callback)
    {
        return new System<T0, T1>(_systemBuilder.Run(callback));
    }
    
    /// <inheritdoc cref="SystemBuilder.Run(System.Action)"/>
    public System<T0, T1> Run(delegate*<void> callback)
    {
        return new System<T0, T1>(_systemBuilder.Run(callback));
    }

    /// <inheritdoc cref="SystemBuilder.Run(Ecs.RunDelegateCallback)"/>
    public ref SystemBuilder<T0, T1> Run(Ecs.RunDelegateCallback callback)
    {
    ...
    /// <inheritdoc cref="SystemBuilder.Run(Ecs.RunDelegateCallback)"/>
    public ref SystemBuilder<T0, T1> Run(delegate*<Iter, Action<Iter>, void> callback)
    {
        _systemBuilder.Run(callback);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1> Run(Ecs.RunPointerCallback callback)
    {
        _systemBuilder.Run(callback);
        return ref this;
    }
    ...
    /// <inheritdoc cref="SystemBuilder.Run(Ecs.RunPointerCallback)"/>
    public ref SystemBuilder<T0, T1> Run(delegate*<Iter, delegate*<Iter, void>, void> callback)
    {
        _systemBuilder.Run(callback);
        return ref this;
    }

    internal ref SystemBuilder<T0, T1> SetCallback<T>(T callback, void* invoker) where T : Delegate
    {
        _systemBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0, T1> SetCallback(void* callback, void* invoker)
    {
        _systemBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0, T1> SetRun<T>(T callback, void* invoker) where T : Delegate
    {
        _systemBuilder.SetRun(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0, T1> SetRun(void* callback, void* invoker)
    {
        _systemBuilder.SetRun(callback, invoker);
        return ref this;
    }

    internal System<T0, T1> Build()
    {
        return new System<T0, T1>(_systemBuilder.Build());
    }
    
    System<T0, T1> IQueryBuilder<SystemBuilder<T0, T1>, System<T0, T1>>.Build()
    {
        return Build();
    }

    /// <inheritdoc cref="SystemBuilder.Equals(SystemBuilder)"/>
    public bool Equals(SystemBuilder<T0, T1> other)
    {
    ...
    {
        return obj is SystemBuilder<T0, T1> other && Equals(other);
    }
    ...
    public static bool operator ==(SystemBuilder<T0, T1> left, SystemBuilder<T0, T1> right)
    {
