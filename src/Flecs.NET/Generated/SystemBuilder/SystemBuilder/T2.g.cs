...
public unsafe partial struct SystemBuilder<T0, T1> : IDisposable, IEquatable<SystemBuilder<T0, T1>>, IQueryBuilder<SystemBuilder<T0, T1>, System<T0, T1>>
{
    ...
    internal ref SystemBuilder<T0, T1> SetCallback(InvokerCallback callback, delegate*<ecs_iter_t*, void> invoker)
    {
        _systemBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0, T1> SetRun(InvokerCallback callback, delegate*<ecs_iter_t*, void> invoker)
    {
