...
public unsafe partial struct SystemBuilder<T0, T1, T2, T3, T4, T5, T6, T7> : IDisposable, IEquatable<SystemBuilder<T0, T1, T2, T3, T4, T5, T6, T7>>, IQueryBuilder<SystemBuilder<T0, T1, T2, T3, T4, T5, T6, T7>, System<T0, T1, T2, T3, T4, T5, T6, T7>>
{
    ...
    {
        Types<T0, T1, T2, T3, T4, T5, T6, T7, _, _, _, _, _, _, _, _>.AssertNoTags();
    ...
    internal ref SystemBuilder<T0, T1, T2, T3, T4, T5, T6, T7> SetCallback(InvokerCallback callback, delegate*<ecs_iter_t*, void> invoker)
    {
        _systemBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0, T1, T2, T3, T4, T5, T6, T7> SetRun(InvokerCallback callback, delegate*<ecs_iter_t*, void> invoker)
    {
