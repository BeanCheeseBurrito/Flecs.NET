...
public unsafe partial struct SystemBuilder<T0, T1, T2, T3> : IDisposable, IEquatable<SystemBuilder<T0, T1, T2, T3>>, IQueryBuilder<SystemBuilder<T0, T1, T2, T3>, System<T0, T1, T2, T3>>
{
    ...
    internal ref SystemBuilder<T0, T1, T2, T3> SetCallback<T>(T callback, void* invoker) where T : Delegate
    {
        _systemBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0, T1, T2, T3> SetCallback(void* callback, void* invoker)
    {
        _systemBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0, T1, T2, T3> SetRun<T>(T callback, void* invoker) where T : Delegate
    {
        _systemBuilder.SetRun(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0, T1, T2, T3> SetRun(void* callback, void* invoker)
    {
        _systemBuilder.SetRun(callback, invoker);
        return ref this;
    }
