// /_/src/Flecs.NET/Generated/SystemBuilder/SystemBuilder/T4.g.cs
...
public unsafe partial struct SystemBuilder<T0, T1, T2, T3> : IDisposable, IEquatable<SystemBuilder<T0, T1, T2, T3>>, IQueryBuilder<SystemBuilder<T0, T1, T2, T3>, System<T0, T1, T2, T3>>
{
    ...
    public ref SystemBuilder<T0, T1, T2, T3> Ctx<T>(T value)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3> Ctx<T>(T value, Ecs.UserContextFinish<T> callback)
    {
    ...
    /// <inheritdoc cref="SystemBuilder.Ctx{T}(T, Ecs.UserContextFinish{T})"/>
    public ref SystemBuilder<T0, T1, T2, T3> Ctx<T>(T value, delegate*<ref T, void> callback)
    {
        _systemBuilder.Ctx(ref value, callback);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3> Ctx<T>(ref T value)
    {
        _systemBuilder.Ctx(ref value);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3> Ctx<T>(ref T value, Ecs.UserContextFinish<T> callback)
    {
        _systemBuilder.Ctx(ref value, callback);
        return ref this;
    }
    ...
    /// <inheritdoc cref="SystemBuilder.Ctx{T}(ref T, Ecs.UserContextFinish{T})"/>
    public ref SystemBuilder<T0, T1, T2, T3> Ctx<T>(ref T value, delegate*<ref T, void> callback)
    {
        _systemBuilder.Ctx(ref value, callback);
        return ref this;
    }
    ...
    internal ref SystemBuilder<T0, T1, T2, T3> SetCallback<T>(T callback, nint invoker) where T : Delegate
    {
        _systemBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0, T1, T2, T3> SetCallback(nint callback, nint invoker)
    {
        _systemBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0, T1, T2, T3> SetRun<T>(T callback, nint invoker) where T : Delegate
    {
        _systemBuilder.SetRun(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0, T1, T2, T3> SetRun(nint callback, nint invoker)
    {
        _systemBuilder.SetRun(callback, invoker);
        return ref this;
    }
