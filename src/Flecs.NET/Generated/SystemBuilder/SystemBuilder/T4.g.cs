...
public unsafe partial struct SystemBuilder<T0, T1, T2, T3> : IDisposable, IEquatable<SystemBuilder<T0, T1, T2, T3>>, IQueryBuilder<SystemBuilder<T0, T1, T2, T3>, System<T0, T1, T2, T3>>
{
    ...
    internal ref SystemBuilder<T0, T1, T2, T3> SetCallback(InvokerCallback callback, delegate*<ecs_iter_t*, void> invoker)
    {
        _systemBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0, T1, T2, T3> SetRun(InvokerCallback callback, delegate*<ecs_iter_t*, void> invoker)
    {
