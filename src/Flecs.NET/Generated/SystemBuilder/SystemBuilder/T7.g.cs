...
public unsafe partial struct SystemBuilder<T0, T1, T2, T3, T4, T5, T6> : IDisposable, IEquatable<SystemBuilder<T0, T1, T2, T3, T4, T5, T6>>, IQueryBuilder<SystemBuilder<T0, T1, T2, T3, T4, T5, T6>, System<T0, T1, T2, T3, T4, T5, T6>>
{
    ...
    public System<T0, T1, T2, T3, T4, T5, T6> Run(Action callback)
    {
        return new System<T0, T1, T2, T3, T4, T5, T6>(_systemBuilder.Run(callback));
    }
    
    /// <inheritdoc cref="SystemBuilder.Run(System.Action)"/>
    public System<T0, T1, T2, T3, T4, T5, T6> Run(delegate*<void> callback)
    {
        return new System<T0, T1, T2, T3, T4, T5, T6>(_systemBuilder.Run(callback));
    }
