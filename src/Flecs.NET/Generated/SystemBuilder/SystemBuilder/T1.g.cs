...
public unsafe partial struct SystemBuilder<T0> : IDisposable, IEquatable<SystemBuilder<T0>>, IQueryBuilder<SystemBuilder<T0>, System<T0>>
{
    ...
    internal ref SystemBuilder<T0> SetCallback(InvokerCallback callback, delegate*<ecs_iter_t*, void> invoker)
    {
        _systemBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0> SetRun(InvokerCallback callback, delegate*<ecs_iter_t*, void> invoker)
    {
