// /_/src/Flecs.NET/Generated/SystemBuilder/SystemBuilder/T1.g.cs
...
/// <summary>
///     A type-safe wrapper over <see cref="SystemBuilder"/> that takes 1 type arguments.
/// </summary>
/// <typeparam name="T0">The T0 component type.</typeparam>
public unsafe partial struct SystemBuilder<T0> : IDisposable, IEquatable<SystemBuilder<T0>>, IQueryBuilder<SystemBuilder<T0>, System<T0>>
{
    ...
    {
        TypeHelper<T0>.AssertNoTags();
        _systemBuilder = new SystemBuilder(world).With<T0>();
    }
    ...
    {
        TypeHelper<T0>.AssertNoTags();
        _systemBuilder = new SystemBuilder(world, name).With<T0>();
    }
    ...
    public ref SystemBuilder<T0> Kind(ulong phase)
    {
    ...
    public ref SystemBuilder<T0> Kind<T>()
    {
    ...
    public ref SystemBuilder<T0> Kind<T>(T value) where T : Enum
    {
    ...
    public ref SystemBuilder<T0> MultiThreaded(bool value = true)
    {
    ...
    public ref SystemBuilder<T0> Immediate(bool value = true)
    {
    ...
    public ref SystemBuilder<T0> Interval(float interval)
    {
    ...
    public ref SystemBuilder<T0> Rate(ulong tickSource, int rate)
    {
    ...
    public ref SystemBuilder<T0> Rate(int rate)
    {
    ...
    public ref SystemBuilder<T0> TickSource(ulong tickSource)
    {
    ...
    public ref SystemBuilder<T0> TickSource<T>()
    {
    ...
    public ref SystemBuilder<T0> Ctx<T>(T value)
    {
    ...
    public ref SystemBuilder<T0> Ctx<T>(T value, Ecs.UserContextFinish<T> callback)
    {
    ...
    /// <inheritdoc cref="SystemBuilder.Ctx{T}(T, Ecs.UserContextFinish{T})"/>
    public ref SystemBuilder<T0> Ctx<T>(T value, delegate*<ref T, void> callback)
    {
        _systemBuilder.Ctx(ref value, callback);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0> Ctx<T>(ref T value)
    {
        _systemBuilder.Ctx(ref value);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0> Ctx<T>(ref T value, Ecs.UserContextFinish<T> callback)
    {
        _systemBuilder.Ctx(ref value, callback);
        return ref this;
    }
    ...
    /// <inheritdoc cref="SystemBuilder.Ctx{T}(ref T, Ecs.UserContextFinish{T})"/>
    public ref SystemBuilder<T0> Ctx<T>(ref T value, delegate*<ref T, void> callback)
    {
        _systemBuilder.Ctx(ref value, callback);
        return ref this;
    }
    ...
    public System<T0> Run(Action callback)
    {
        return new System<T0>(_systemBuilder.Run(callback));
    }
    
    /// <inheritdoc cref="SystemBuilder.Run(System.Action)"/>
    public System<T0> Run(delegate*<void> callback)
    {
        return new System<T0>(_systemBuilder.Run(callback));
    }
    ...
    internal ref SystemBuilder<T0> SetCallback<T>(T callback, void* invoker) where T : Delegate
    {
        _systemBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0> SetCallback(void* callback, void* invoker)
    {
        _systemBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0> SetRun<T>(T callback, void* invoker) where T : Delegate
    {
        _systemBuilder.SetRun(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0> SetRun(void* callback, void* invoker)
    {
        _systemBuilder.SetRun(callback, invoker);
        return ref this;
    }

    internal System<T0> Build()
    {
        return new System<T0>(_systemBuilder.Build());
    }
    
    System<T0> IQueryBuilder<SystemBuilder<T0>, System<T0>>.Build()
    {
        return Build();
    }

    /// <inheritdoc cref="SystemBuilder.Equals(SystemBuilder)"/>
    public bool Equals(SystemBuilder<T0> other)
    {
    ...
    {
        return obj is SystemBuilder<T0> other && Equals(other);
    }
    ...
    public static bool operator ==(SystemBuilder<T0> left, SystemBuilder<T0> right)
    {
