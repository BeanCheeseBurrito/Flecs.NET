...
/// <summary>
///     A type-safe wrapper around <see cref="Routine"/> that takes 3 type arguments.
/// </summary>
...
public unsafe struct Routine<T0, T1, T2> : IEquatable<Routine<T0, T1, T2>>, IEntity
{
    ...
    public static implicit operator ulong(Routine<T0, T1, T2> routine)
    {
        return ToUInt64(routine);
    }

    /// <inheritdoc cref="Routine.ToId"/>
    public static implicit operator Id(Routine<T0, T1, T2> routine)
    {
        return ToId(routine);
    }

    /// <inheritdoc cref="Routine.ToEntity"/>
    public static implicit operator Entity(Routine<T0, T1, T2> routine)
    {
        return ToEntity(routine);
    }

    /// <inheritdoc cref="Routine.ToUInt64"/>
    public static ulong ToUInt64(Routine<T0, T1, T2> routine)
    {
        return routine.Entity;
    }

    /// <inheritdoc cref="Routine.ToId"/>
    public static Id ToId(Routine<T0, T1, T2> routine)
    {
        return routine.Id;
    }

    /// <inheritdoc cref="Routine.ToEntity"/>
    public static Entity ToEntity(Routine<T0, T1, T2> routine)
    {
        return routine.Entity;
    }
    ...
    public bool Equals(Routine<T0, T1, T2> other)
    {
    ...
    {
        return obj is Routine<T0, T1, T2> routine && Equals(routine);
    }
    ...
    public static bool operator ==(Routine<T0, T1, T2> left, Routine<T0, T1, T2> right)
    {
