...
public static unsafe partial class Invoker
{
    ...
    public static void Each<T0, T1, T2, T3, T4, T5, T6>(Iter it, Ecs.EachRefCallback<T0, T1, T2, T3, T4, T5, T6> callback)
    {
        ...
        if (it.IsLinear())
        {
            for (int i = 0; i < count; i++)
                callback(ref Managed.GetTypeRef<T0>(&pointer0[i]), ref Managed.GetTypeRef<T1>(&pointer1[i]), ref Managed.GetTypeRef<T2>(&pointer2[i]), ref Managed.GetTypeRef<T3>(&pointer3[i]), ref Managed.GetTypeRef<T4>(&pointer4[i]), ref Managed.GetTypeRef<T5>(&pointer5[i]), ref Managed.GetTypeRef<T6>(&pointer6[i]));
        }
        else
        {
    ...
    public static void Each<T0, T1, T2, T3, T4, T5, T6>(Iter it, Ecs.EachIterRefCallback<T0, T1, T2, T3, T4, T5, T6> callback)
    {
        ...
        {
            for (int i = 0; i < count; i++)
                callback(it, i, ref Managed.GetTypeRef<T0>(&pointer0[i]), ref Managed.GetTypeRef<T1>(&pointer1[i]), ref Managed.GetTypeRef<T2>(&pointer2[i]), ref Managed.GetTypeRef<T3>(&pointer3[i]), ref Managed.GetTypeRef<T4>(&pointer4[i]), ref Managed.GetTypeRef<T5>(&pointer5[i]), ref Managed.GetTypeRef<T6>(&pointer6[i]));
        }
        else
        {
            int step0 = it.Step<T0>(0); int step1 = it.Step<T1>(1); int step2 = it.Step<T2>(2); int step3 = it.Step<T3>(3); int step4 = it.Step<T4>(4); int step5 = it.Step<T5>(5); int step6 = it.Step<T6>(6);
    ...
    public static void Each<T0, T1, T2, T3, T4, T5, T6>(Iter it, Ecs.EachPointerCallback<T0, T1, T2, T3, T4, T5, T6> callback)
    {
        ...
        {
            for (int i = 0; i < count; i++)
                callback(&pointer0[i], &pointer1[i], &pointer2[i], &pointer3[i], &pointer4[i], &pointer5[i], &pointer6[i]);
        }
        else
        {
            int step0 = it.Step<T0>(0); int step1 = it.Step<T1>(1); int step2 = it.Step<T2>(2); int step3 = it.Step<T3>(3); int step4 = it.Step<T4>(4); int step5 = it.Step<T5>(5); int step6 = it.Step<T6>(6);
            for (int i = 0; i < count; i++)
                callback(&pointer0[i * step0], &pointer1[i * step1], &pointer2[i * step2], &pointer3[i * step3], &pointer4[i * step4], &pointer5[i * step5], &pointer6[i * step6]);
        }
    ...
    public static void Each<T0, T1, T2, T3, T4, T5, T6>(Iter it, Ecs.EachEntityPointerCallback<T0, T1, T2, T3, T4, T5, T6> callback)
    {
        ...
        {
            for (int i = 0; i < count; i++)
                callback(new Entity(it.Handle->world, it.Handle->entities[i]), &pointer0[i], &pointer1[i], &pointer2[i], &pointer3[i], &pointer4[i], &pointer5[i], &pointer6[i]);
        }
        else
        {
            int step0 = it.Step<T0>(0); int step1 = it.Step<T1>(1); int step2 = it.Step<T2>(2); int step3 = it.Step<T3>(3); int step4 = it.Step<T4>(4); int step5 = it.Step<T5>(5); int step6 = it.Step<T6>(6);
            for (int i = 0; i < count; i++)
                callback(new Entity(it.Handle->world, it.Handle->entities[i]), &pointer0[i * step0], &pointer1[i * step1], &pointer2[i * step2], &pointer3[i * step3], &pointer4[i * step4], &pointer5[i * step5], &pointer6[i * step6]);
        }
    ...
    public static void Each<T0, T1, T2, T3, T4, T5, T6>(Iter it, Ecs.EachIterPointerCallback<T0, T1, T2, T3, T4, T5, T6> callback)
    {
        ...
        {
            for (int i = 0; i < count; i++)
                callback(it, i, &pointer0[i], &pointer1[i], &pointer2[i], &pointer3[i], &pointer4[i], &pointer5[i], &pointer6[i]);
        }
        else
        {
            int step0 = it.Step<T0>(0); int step1 = it.Step<T1>(1); int step2 = it.Step<T2>(2); int step3 = it.Step<T3>(3); int step4 = it.Step<T4>(4); int step5 = it.Step<T5>(5); int step6 = it.Step<T6>(6);
            for (int i = 0; i < count; i++)
                callback(it, i, &pointer0[i * step0], &pointer1[i * step1], &pointer2[i * step2], &pointer3[i * step3], &pointer4[i * step4], &pointer5[i * step5], &pointer6[i * step6]);
        }
