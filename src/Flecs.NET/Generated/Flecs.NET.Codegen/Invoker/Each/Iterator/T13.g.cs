...
public static unsafe partial class Invoker
{
    ...
    public static void Each<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(Iter it, Ecs.EachRefCallback<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> callback)
    {
        ...
        if (it.IsLinear())
        {
            for (int i = 0; i < count; i++)
                callback(ref Managed.GetTypeRef<T0>(&pointer0[i]), ref Managed.GetTypeRef<T1>(&pointer1[i]), ref Managed.GetTypeRef<T2>(&pointer2[i]), ref Managed.GetTypeRef<T3>(&pointer3[i]), ref Managed.GetTypeRef<T4>(&pointer4[i]), ref Managed.GetTypeRef<T5>(&pointer5[i]), ref Managed.GetTypeRef<T6>(&pointer6[i]), ref Managed.GetTypeRef<T7>(&pointer7[i]), ref Managed.GetTypeRef<T8>(&pointer8[i]), ref Managed.GetTypeRef<T9>(&pointer9[i]), ref Managed.GetTypeRef<T10>(&pointer10[i]), ref Managed.GetTypeRef<T11>(&pointer11[i]), ref Managed.GetTypeRef<T12>(&pointer12[i]));
        }
        else
        {
    ...
    public static void Each<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(Iter it, Ecs.EachIterRefCallback<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> callback)
    {
        ...
        {
            for (int i = 0; i < count; i++)
                callback(it, i, ref Managed.GetTypeRef<T0>(&pointer0[i]), ref Managed.GetTypeRef<T1>(&pointer1[i]), ref Managed.GetTypeRef<T2>(&pointer2[i]), ref Managed.GetTypeRef<T3>(&pointer3[i]), ref Managed.GetTypeRef<T4>(&pointer4[i]), ref Managed.GetTypeRef<T5>(&pointer5[i]), ref Managed.GetTypeRef<T6>(&pointer6[i]), ref Managed.GetTypeRef<T7>(&pointer7[i]), ref Managed.GetTypeRef<T8>(&pointer8[i]), ref Managed.GetTypeRef<T9>(&pointer9[i]), ref Managed.GetTypeRef<T10>(&pointer10[i]), ref Managed.GetTypeRef<T11>(&pointer11[i]), ref Managed.GetTypeRef<T12>(&pointer12[i]));
        }
        else
        {
            int step0 = it.Step<T0>(0); int step1 = it.Step<T1>(1); int step2 = it.Step<T2>(2); int step3 = it.Step<T3>(3); int step4 = it.Step<T4>(4); int step5 = it.Step<T5>(5); int step6 = it.Step<T6>(6); int step7 = it.Step<T7>(7); int step8 = it.Step<T8>(8); int step9 = it.Step<T9>(9); int step10 = it.Step<T10>(10); int step11 = it.Step<T11>(11); int step12 = it.Step<T12>(12);
    ...
    public static void Each<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(Iter it, Ecs.EachPointerCallback<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> callback)
    {
        ...
        {
            for (int i = 0; i < count; i++)
                callback(&pointer0[i], &pointer1[i], &pointer2[i], &pointer3[i], &pointer4[i], &pointer5[i], &pointer6[i], &pointer7[i], &pointer8[i], &pointer9[i], &pointer10[i], &pointer11[i], &pointer12[i]);
        }
        else
        {
            int step0 = it.Step<T0>(0); int step1 = it.Step<T1>(1); int step2 = it.Step<T2>(2); int step3 = it.Step<T3>(3); int step4 = it.Step<T4>(4); int step5 = it.Step<T5>(5); int step6 = it.Step<T6>(6); int step7 = it.Step<T7>(7); int step8 = it.Step<T8>(8); int step9 = it.Step<T9>(9); int step10 = it.Step<T10>(10); int step11 = it.Step<T11>(11); int step12 = it.Step<T12>(12);
            for (int i = 0; i < count; i++)
                callback(&pointer0[i * step0], &pointer1[i * step1], &pointer2[i * step2], &pointer3[i * step3], &pointer4[i * step4], &pointer5[i * step5], &pointer6[i * step6], &pointer7[i * step7], &pointer8[i * step8], &pointer9[i * step9], &pointer10[i * step10], &pointer11[i * step11], &pointer12[i * step12]);
        }
    ...
    public static void Each<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(Iter it, Ecs.EachEntityPointerCallback<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> callback)
    {
        ...
        {
            for (int i = 0; i < count; i++)
                callback(new Entity(it.Handle->world, it.Handle->entities[i]), &pointer0[i], &pointer1[i], &pointer2[i], &pointer3[i], &pointer4[i], &pointer5[i], &pointer6[i], &pointer7[i], &pointer8[i], &pointer9[i], &pointer10[i], &pointer11[i], &pointer12[i]);
        }
        else
        {
            int step0 = it.Step<T0>(0); int step1 = it.Step<T1>(1); int step2 = it.Step<T2>(2); int step3 = it.Step<T3>(3); int step4 = it.Step<T4>(4); int step5 = it.Step<T5>(5); int step6 = it.Step<T6>(6); int step7 = it.Step<T7>(7); int step8 = it.Step<T8>(8); int step9 = it.Step<T9>(9); int step10 = it.Step<T10>(10); int step11 = it.Step<T11>(11); int step12 = it.Step<T12>(12);
            for (int i = 0; i < count; i++)
                callback(new Entity(it.Handle->world, it.Handle->entities[i]), &pointer0[i * step0], &pointer1[i * step1], &pointer2[i * step2], &pointer3[i * step3], &pointer4[i * step4], &pointer5[i * step5], &pointer6[i * step6], &pointer7[i * step7], &pointer8[i * step8], &pointer9[i * step9], &pointer10[i * step10], &pointer11[i * step11], &pointer12[i * step12]);
        }
    ...
    public static void Each<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(Iter it, Ecs.EachIterPointerCallback<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> callback)
    {
        ...
        {
            for (int i = 0; i < count; i++)
                callback(it, i, &pointer0[i], &pointer1[i], &pointer2[i], &pointer3[i], &pointer4[i], &pointer5[i], &pointer6[i], &pointer7[i], &pointer8[i], &pointer9[i], &pointer10[i], &pointer11[i], &pointer12[i]);
        }
        else
        {
            int step0 = it.Step<T0>(0); int step1 = it.Step<T1>(1); int step2 = it.Step<T2>(2); int step3 = it.Step<T3>(3); int step4 = it.Step<T4>(4); int step5 = it.Step<T5>(5); int step6 = it.Step<T6>(6); int step7 = it.Step<T7>(7); int step8 = it.Step<T8>(8); int step9 = it.Step<T9>(9); int step10 = it.Step<T10>(10); int step11 = it.Step<T11>(11); int step12 = it.Step<T12>(12);
            for (int i = 0; i < count; i++)
                callback(it, i, &pointer0[i * step0], &pointer1[i * step1], &pointer2[i * step2], &pointer3[i * step3], &pointer4[i * step4], &pointer5[i * step5], &pointer6[i * step6], &pointer7[i * step7], &pointer8[i * step8], &pointer9[i * step9], &pointer10[i * step10], &pointer11[i * step11], &pointer12[i * step12]);
        }
