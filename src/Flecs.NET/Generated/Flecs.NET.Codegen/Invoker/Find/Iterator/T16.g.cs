...
public static unsafe partial class Invoker
{
    ...
    public static Entity Find<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>(Iter it, Ecs.FindPointerCallback<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> callback)
    {
        ...
        if (it.IsLinear())
        {
            for (int i = 0; i < count; i++)
            {
                if (!callback(&pointer0[i], &pointer1[i], &pointer2[i], &pointer3[i], &pointer4[i], &pointer5[i], &pointer6[i], &pointer7[i], &pointer8[i], &pointer9[i], &pointer10[i], &pointer11[i], &pointer12[i], &pointer13[i], &pointer14[i], &pointer15[i]))
                    continue;
        ...
        else
        {
            ...
            for (int i = 0; i < count; i++)
            {
                if (!callback(&pointer0[i * step0], &pointer1[i * step1], &pointer2[i * step2], &pointer3[i * step3], &pointer4[i * step4], &pointer5[i * step5], &pointer6[i * step6], &pointer7[i * step7], &pointer8[i * step8], &pointer9[i * step9], &pointer10[i * step10], &pointer11[i * step11], &pointer12[i * step12], &pointer13[i * step13], &pointer14[i * step14], &pointer15[i * step15]))
                    continue;
    ...
    public static Entity Find<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>(Iter it, Ecs.FindEntityPointerCallback<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> callback)
    {
        ...
        if (it.IsLinear())
        {
            for (int i = 0; i < count; i++)
            {
                if (!callback(new Entity(it.Handle->world, it.Handle->entities[i]), &pointer0[i], &pointer1[i], &pointer2[i], &pointer3[i], &pointer4[i], &pointer5[i], &pointer6[i], &pointer7[i], &pointer8[i], &pointer9[i], &pointer10[i], &pointer11[i], &pointer12[i], &pointer13[i], &pointer14[i], &pointer15[i]))
                    continue;
    ...
    public static Entity Find<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>(Iter it, Ecs.FindIterPointerCallback<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> callback)
    {
        ...
        if (it.IsLinear())
        {
            for (int i = 0; i < count; i++)
            {
                if (!callback(it, i, &pointer0[i], &pointer1[i], &pointer2[i], &pointer3[i], &pointer4[i], &pointer5[i], &pointer6[i], &pointer7[i], &pointer8[i], &pointer9[i], &pointer10[i], &pointer11[i], &pointer12[i], &pointer13[i], &pointer14[i], &pointer15[i]))
                    continue;
        ...
        else
        {
            ...
            for (int i = 0; i < count; i++)
            {
                if (!callback(it, i, &pointer0[i * step0], &pointer1[i * step1], &pointer2[i * step2], &pointer3[i * step3], &pointer4[i * step4], &pointer5[i * step5], &pointer6[i * step6], &pointer7[i * step7], &pointer8[i * step8], &pointer9[i * step9], &pointer10[i * step10], &pointer11[i * step11], &pointer12[i * step12], &pointer13[i * step13], &pointer14[i * step14], &pointer15[i * step15]))
                    continue;
