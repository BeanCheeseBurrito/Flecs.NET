...
public static unsafe partial class Invoker
{
    ...
    public static Entity Find<T0, T1, T2, T3>(Iter it, Ecs.FindRefCallback<T0, T1, T2, T3> callback)
    {
        ...
        {
            if (!callback(ref Managed.GetTypeRef<T0>(pointer0), ref Managed.GetTypeRef<T1>(pointer1), ref Managed.GetTypeRef<T2>(pointer2), ref Managed.GetTypeRef<T3>(pointer3)))
                continue;
    ...
    public static Entity Find<T0, T1, T2, T3>(Iter it, Ecs.FindEntityRefCallback<T0, T1, T2, T3> callback)
    {
        ...
        for (int i = 0; i < count; i++, pointer0 = &pointer0[step0], pointer1 = &pointer1[step1], pointer2 = &pointer2[step2], pointer3 = &pointer3[step3])
        {
            if (!callback(new Entity(it.Handle->world, it.Handle->entities[i]), ref Managed.GetTypeRef<T0>(pointer0), ref Managed.GetTypeRef<T1>(pointer1), ref Managed.GetTypeRef<T2>(pointer2), ref Managed.GetTypeRef<T3>(pointer3)))
                continue;
    ...
    public static Entity Find<T0, T1, T2, T3>(Iter it, Ecs.FindIterRefCallback<T0, T1, T2, T3> callback)
    {
        ...
        for (int i = 0; i < count; i++, pointer0 = &pointer0[step0], pointer1 = &pointer1[step1], pointer2 = &pointer2[step2], pointer3 = &pointer3[step3])
        {
            if (!callback(it, i, ref Managed.GetTypeRef<T0>(pointer0), ref Managed.GetTypeRef<T1>(pointer1), ref Managed.GetTypeRef<T2>(pointer2), ref Managed.GetTypeRef<T3>(pointer3)))
                continue;
    ...
    public static Entity Find<T0, T1, T2, T3>(Iter it, Ecs.FindPointerCallback<T0, T1, T2, T3> callback)
    {
        ...
        for (int i = 0; i < count; i++, pointer0 = &pointer0[step0], pointer1 = &pointer1[step1], pointer2 = &pointer2[step2], pointer3 = &pointer3[step3])
        {
            if (!callback((T0*)pointer0, (T1*)pointer1, (T2*)pointer2, (T3*)pointer3))
                continue;
    ...
    public static Entity Find<T0, T1, T2, T3>(Iter it, Ecs.FindEntityPointerCallback<T0, T1, T2, T3> callback)
    {
        ...
        for (int i = 0; i < count; i++, pointer0 = &pointer0[step0], pointer1 = &pointer1[step1], pointer2 = &pointer2[step2], pointer3 = &pointer3[step3])
        {
            if (!callback(new Entity(it.Handle->world, it.Handle->entities[i]), (T0*)pointer0, (T1*)pointer1, (T2*)pointer2, (T3*)pointer3))
                continue;
    ...
    public static Entity Find<T0, T1, T2, T3>(Iter it, Ecs.FindIterPointerCallback<T0, T1, T2, T3> callback)
    {
        ...
        for (int i = 0; i < count; i++, pointer0 = &pointer0[step0], pointer1 = &pointer1[step1], pointer2 = &pointer2[step2], pointer3 = &pointer3[step3])
        {
            if (!callback(it, i, (T0*)pointer0, (T1*)pointer1, (T2*)pointer2, (T3*)pointer3))
                continue;
