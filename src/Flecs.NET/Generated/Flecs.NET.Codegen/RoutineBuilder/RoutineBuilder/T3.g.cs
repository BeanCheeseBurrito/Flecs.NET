...
/// <summary>
///     A type-safe wrapper over <see cref="RoutineBuilder"/> that takes 3 type arguments.
/// </summary>
...
public unsafe partial struct RoutineBuilder<T0, T1, T2> : IDisposable, IEquatable<RoutineBuilder<T0, T1, T2>>, IQueryBuilder<RoutineBuilder<T0, T1, T2>, Routine<T0, T1, T2>>
{
    ...
    {
        TypeHelper<T0, T1, T2>.AssertNoTags();
        _routineBuilder = new RoutineBuilder(world).With<T0>().With<T1>().With<T2>();
    }
    ...
    {
        TypeHelper<T0, T1, T2>.AssertNoTags();
        _routineBuilder = new RoutineBuilder(world, name).With<T0>().With<T1>().With<T2>();
    }
    ...
    public ref RoutineBuilder<T0, T1, T2> Kind(ulong phase)
    {
    ...
    public ref RoutineBuilder<T0, T1, T2> Kind<T>()
    {
    ...
    public ref RoutineBuilder<T0, T1, T2> Kind<T>(T value) where T : Enum
    {
    ...
    public ref RoutineBuilder<T0, T1, T2> MultiThreaded(bool value = true)
    {
    ...
    public ref RoutineBuilder<T0, T1, T2> Immediate(bool value = true)
    {
    ...
    public ref RoutineBuilder<T0, T1, T2> Interval(float interval)
    {
    ...
    public ref RoutineBuilder<T0, T1, T2> Rate(ulong tickSource, int rate)
    {
    ...
    public ref RoutineBuilder<T0, T1, T2> Rate(int rate)
    {
    ...
    public ref RoutineBuilder<T0, T1, T2> TickSource(ulong tickSource)
    {
    ...
    public ref RoutineBuilder<T0, T1, T2> TickSource<T>()
    {
    ...
    public ref RoutineBuilder<T0, T1, T2> Ctx(void* ctx)
    {
    ...
    public Routine<T0, T1, T2> Run(Action callback)
    {
        return new Routine<T0, T1, T2>(_routineBuilder.Run(callback));
    }
    
    /// <inheritdoc cref="RoutineBuilder.Run(System.Action)"/>
    public Routine<T0, T1, T2> Run(delegate*<void> callback)
    {
        return new Routine<T0, T1, T2>(_routineBuilder.Run(callback));
    }

    /// <inheritdoc cref="RoutineBuilder.Run(Ecs.RunDelegateCallback)"/>
    public ref RoutineBuilder<T0, T1, T2> Run(Ecs.RunDelegateCallback callback)
    {
    ...
    /// <inheritdoc cref="RoutineBuilder.Run(Ecs.RunDelegateCallback)"/>
    public ref RoutineBuilder<T0, T1, T2> Run(delegate*<Iter, Action<Iter>, void> callback)
    {
        _routineBuilder.Run(callback);
        return ref this;
    }
    ...
    public ref RoutineBuilder<T0, T1, T2> Run(Ecs.RunPointerCallback callback)
    {
        _routineBuilder.Run(callback);
        return ref this;
    }
    ...
    /// <inheritdoc cref="RoutineBuilder.Run(Ecs.RunPointerCallback)"/>
    public ref RoutineBuilder<T0, T1, T2> Run(delegate*<Iter, delegate*<Iter, void>, void> callback)
    {
        _routineBuilder.Run(callback);
        return ref this;
    }

    internal ref RoutineBuilder<T0, T1, T2> SetCallback<T>(T callback, IntPtr invoker) where T : Delegate
    {
        _routineBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    internal ref RoutineBuilder<T0, T1, T2> SetCallback(IntPtr callback, IntPtr invoker)
    {
        _routineBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    internal ref RoutineBuilder<T0, T1, T2> SetRun<T>(T callback, IntPtr invoker) where T : Delegate
    {
        _routineBuilder.SetRun(callback, invoker);
        return ref this;
    }

    internal ref RoutineBuilder<T0, T1, T2> SetRun(IntPtr callback, IntPtr invoker)
    {
        _routineBuilder.SetRun(callback, invoker);
        return ref this;
    }

    internal Routine<T0, T1, T2> Build()
    {
        return new Routine<T0, T1, T2>(_routineBuilder.Build());
    }
    
    Routine<T0, T1, T2> IQueryBuilder<RoutineBuilder<T0, T1, T2>, Routine<T0, T1, T2>>.Build()
    {
        return Build();
    }

    /// <inheritdoc cref="RoutineBuilder.Equals(RoutineBuilder)"/>
    public bool Equals(RoutineBuilder<T0, T1, T2> other)
    {
    ...
    {
        return obj is RoutineBuilder<T0, T1, T2> other && Equals(other);
    }
    ...
    public static bool operator ==(RoutineBuilder<T0, T1, T2> left, RoutineBuilder<T0, T1, T2> right)
    {
