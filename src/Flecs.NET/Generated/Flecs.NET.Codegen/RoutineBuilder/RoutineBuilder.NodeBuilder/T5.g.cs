// RoutineBuilder.NodeBuilder/T5.g.cs
...
public unsafe partial struct RoutineBuilder<T0, T1, T2, T3, T4>
{
    ...
    public Routine<T0, T1, T2, T3, T4> Run(Ecs.RunCallback callback)
    {
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1, T2, T3, T4> Run(delegate*<Iter, void> callback)
    {
        TypeHelper<T0, T1, T2, T3, T4>.AssertReferenceTypes(true);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1, T2, T3, T4> Iter(Ecs.IterFieldCallback<T0, T1, T2, T3, T4> callback)
    {
        TypeHelper<T0, T1, T2, T3, T4>.AssertReferenceTypes(true);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1, T2, T3, T4> Iter(Ecs.IterSpanCallback<T0, T1, T2, T3, T4> callback)
    {
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1, T2, T3, T4> Iter(Ecs.IterPointerCallback<T0, T1, T2, T3, T4> callback)
    {
        TypeHelper<T0, T1, T2, T3, T4>.AssertReferenceTypes(false);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1, T2, T3, T4> Iter(delegate*<Iter, Field<T0>, Field<T1>, Field<T2>, Field<T3>, Field<T4>, void> callback)
    {
        TypeHelper<T0, T1, T2, T3, T4>.AssertReferenceTypes(true);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1, T2, T3, T4> Iter(delegate*<Iter, Span<T0>, Span<T1>, Span<T2>, Span<T3>, Span<T4>, void> callback)
    {
        TypeHelper<T0, T1, T2, T3, T4>.AssertReferenceTypes(false);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1, T2, T3, T4> Iter(delegate*<Iter, T0*, T1*, T2*, T3*, T4*, void> callback)
    {
        TypeHelper<T0, T1, T2, T3, T4>.AssertReferenceTypes(false);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1, T2, T3, T4> Each(Ecs.EachRefCallback<T0, T1, T2, T3, T4> callback)
    {
        TypeHelper<T0, T1, T2, T3, T4>.AssertReferenceTypes(true);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1, T2, T3, T4> Each(Ecs.EachEntityRefCallback<T0, T1, T2, T3, T4> callback)
    {
        TypeHelper<T0, T1, T2, T3, T4>.AssertReferenceTypes(true);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1, T2, T3, T4> Each(Ecs.EachIterRefCallback<T0, T1, T2, T3, T4> callback)
    {
        TypeHelper<T0, T1, T2, T3, T4>.AssertReferenceTypes(true);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1, T2, T3, T4> Each(delegate*<ref T0, ref T1, ref T2, ref T3, ref T4, void> callback)
    {
        TypeHelper<T0, T1, T2, T3, T4>.AssertReferenceTypes(true);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1, T2, T3, T4> Each(delegate*<Entity, ref T0, ref T1, ref T2, ref T3, ref T4, void> callback)
    {
        TypeHelper<T0, T1, T2, T3, T4>.AssertReferenceTypes(true);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1, T2, T3, T4> Each(delegate*<Iter, int, ref T0, ref T1, ref T2, ref T3, ref T4, void> callback)
    {
        TypeHelper<T0, T1, T2, T3, T4>.AssertReferenceTypes(true);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1, T2, T3, T4> Each(Ecs.EachPointerCallback<T0, T1, T2, T3, T4> callback)
    {
        TypeHelper<T0, T1, T2, T3, T4>.AssertReferenceTypes(false);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1, T2, T3, T4> Each(Ecs.EachEntityPointerCallback<T0, T1, T2, T3, T4> callback)
    {
        TypeHelper<T0, T1, T2, T3, T4>.AssertReferenceTypes(false);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1, T2, T3, T4> Each(Ecs.EachIterPointerCallback<T0, T1, T2, T3, T4> callback)
    {
        TypeHelper<T0, T1, T2, T3, T4>.AssertReferenceTypes(false);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1, T2, T3, T4> Each(delegate*<T0*, T1*, T2*, T3*, T4*, void> callback)
    {
        TypeHelper<T0, T1, T2, T3, T4>.AssertReferenceTypes(false);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1, T2, T3, T4> Each(delegate*<Entity, T0*, T1*, T2*, T3*, T4*, void> callback)
    {
        TypeHelper<T0, T1, T2, T3, T4>.AssertReferenceTypes(false);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1, T2, T3, T4> Each(delegate*<Iter, int, T0*, T1*, T2*, T3*, T4*, void> callback)
    {
        TypeHelper<T0, T1, T2, T3, T4>.AssertReferenceTypes(false);
