// RoutineBuilder.NodeBuilder/T2.g.cs
...
public unsafe partial struct RoutineBuilder<T0, T1>
{
    ...
    public Routine<T0, T1> Run(Ecs.RunCallback callback)
    {
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1> Run(delegate*<Iter, void> callback)
    {
        TypeHelper<T0, T1>.AssertReferenceTypes(true);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1> Iter(Ecs.IterFieldCallback<T0, T1> callback)
    {
        TypeHelper<T0, T1>.AssertReferenceTypes(true);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1> Iter(Ecs.IterSpanCallback<T0, T1> callback)
    {
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1> Iter(Ecs.IterPointerCallback<T0, T1> callback)
    {
        TypeHelper<T0, T1>.AssertReferenceTypes(false);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1> Iter(delegate*<Iter, Field<T0>, Field<T1>, void> callback)
    {
        TypeHelper<T0, T1>.AssertReferenceTypes(true);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1> Iter(delegate*<Iter, Span<T0>, Span<T1>, void> callback)
    {
        TypeHelper<T0, T1>.AssertReferenceTypes(false);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1> Iter(delegate*<Iter, T0*, T1*, void> callback)
    {
        TypeHelper<T0, T1>.AssertReferenceTypes(false);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1> Each(Ecs.EachRefCallback<T0, T1> callback)
    {
        TypeHelper<T0, T1>.AssertReferenceTypes(true);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1> Each(Ecs.EachEntityRefCallback<T0, T1> callback)
    {
        TypeHelper<T0, T1>.AssertReferenceTypes(true);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1> Each(Ecs.EachIterRefCallback<T0, T1> callback)
    {
        TypeHelper<T0, T1>.AssertReferenceTypes(true);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1> Each(delegate*<ref T0, ref T1, void> callback)
    {
        TypeHelper<T0, T1>.AssertReferenceTypes(true);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1> Each(delegate*<Entity, ref T0, ref T1, void> callback)
    {
        TypeHelper<T0, T1>.AssertReferenceTypes(true);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1> Each(delegate*<Iter, int, ref T0, ref T1, void> callback)
    {
        TypeHelper<T0, T1>.AssertReferenceTypes(true);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1> Each(Ecs.EachPointerCallback<T0, T1> callback)
    {
        TypeHelper<T0, T1>.AssertReferenceTypes(false);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1> Each(Ecs.EachEntityPointerCallback<T0, T1> callback)
    {
        TypeHelper<T0, T1>.AssertReferenceTypes(false);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1> Each(Ecs.EachIterPointerCallback<T0, T1> callback)
    {
        TypeHelper<T0, T1>.AssertReferenceTypes(false);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1> Each(delegate*<T0*, T1*, void> callback)
    {
        TypeHelper<T0, T1>.AssertReferenceTypes(false);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1> Each(delegate*<Entity, T0*, T1*, void> callback)
    {
        TypeHelper<T0, T1>.AssertReferenceTypes(false);
    ...
    /// </summary>
    /// <param name="callback">The callback.</param>
    public Routine<T0, T1> Each(delegate*<Iter, int, T0*, T1*, void> callback)
    {
        TypeHelper<T0, T1>.AssertReferenceTypes(false);
