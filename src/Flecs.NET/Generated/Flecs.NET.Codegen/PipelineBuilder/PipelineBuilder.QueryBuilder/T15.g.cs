// PipelineBuilder.QueryBuilder/T15.g.cs
...
public unsafe partial struct PipelineBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>
{
    ...
    public ref PipelineBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> OrderBy(ulong component, Ecs.OrderByAction compare)
    {
    ...
    public ref PipelineBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> OrderBy<T>(Ecs.OrderByAction compare)
    {
    ...
    public ref PipelineBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> GroupBy(ulong component, Ecs.GroupByAction callback)
    {
    ...
    public ref PipelineBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> GroupBy<T>(Ecs.GroupByAction callback)
    {
    ...
    ///
    public ref PipelineBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> GroupByCtx(void* ctx, Ecs.ContextFree contextFree)
    {
    ...
    ///
    public ref PipelineBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> GroupByCtx(void* ctx)
    {
    ...
    public ref PipelineBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> OnGroupCreate(Ecs.GroupCreateAction onGroupCreate)
    {
    ...
    public ref PipelineBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> OnGroupDelete(Ecs.GroupDeleteAction onGroupDelete)
    {
