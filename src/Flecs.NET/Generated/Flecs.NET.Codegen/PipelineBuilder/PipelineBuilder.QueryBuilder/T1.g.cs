// PipelineBuilder.QueryBuilder/T1.g.cs
...
public unsafe partial struct PipelineBuilder<T0>
{
    ...
    public ref PipelineBuilder<T0> OrderBy(ulong component, Ecs.OrderByAction compare)
    {
    ...
    public ref PipelineBuilder<T0> OrderBy<T>(Ecs.OrderByAction compare)
    {
    ...
    public ref PipelineBuilder<T0> GroupBy(ulong component, Ecs.GroupByAction callback)
    {
    ...
    public ref PipelineBuilder<T0> GroupBy<T>(Ecs.GroupByAction callback)
    {
    ...
    ///
    public ref PipelineBuilder<T0> GroupByCtx(void* ctx, Ecs.ContextFree contextFree)
    {
    ...
    ///
    public ref PipelineBuilder<T0> GroupByCtx(void* ctx)
    {
    ...
    public ref PipelineBuilder<T0> OnGroupCreate(Ecs.GroupCreateAction onGroupCreate)
    {
    ...
    public ref PipelineBuilder<T0> OnGroupDelete(Ecs.GroupDeleteAction onGroupDelete)
    {
