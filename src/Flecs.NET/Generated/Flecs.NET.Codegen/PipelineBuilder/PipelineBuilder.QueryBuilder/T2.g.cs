// PipelineBuilder.QueryBuilder/T2.g.cs
...
public unsafe partial struct PipelineBuilder<T0, T1>
{
    ...
    public ref PipelineBuilder<T0, T1> OrderBy(ulong component, Ecs.OrderByAction compare)
    {
    ...
    public ref PipelineBuilder<T0, T1> OrderBy<T>(Ecs.OrderByAction compare)
    {
    ...
    public ref PipelineBuilder<T0, T1> GroupBy(ulong component, Ecs.GroupByAction callback)
    {
    ...
    public ref PipelineBuilder<T0, T1> GroupBy<T>(Ecs.GroupByAction callback)
    {
    ...
    ///
    public ref PipelineBuilder<T0, T1> GroupByCtx(void* ctx, Ecs.ContextFree contextFree)
    {
    ...
    ///
    public ref PipelineBuilder<T0, T1> GroupByCtx(void* ctx)
    {
    ...
    public ref PipelineBuilder<T0, T1> OnGroupCreate(Ecs.GroupCreateAction onGroupCreate)
    {
    ...
    public ref PipelineBuilder<T0, T1> OnGroupDelete(Ecs.GroupDeleteAction onGroupDelete)
    {
