// PipelineBuilder.QueryBuilder/T3.g.cs
...
public unsafe partial struct PipelineBuilder<T0, T1, T2>
{
    ...
    public ref PipelineBuilder<T0, T1, T2> OrderBy(ulong component, Ecs.OrderByAction compare)
    {
    ...
    public ref PipelineBuilder<T0, T1, T2> OrderBy<T>(Ecs.OrderByAction compare)
    {
    ...
    public ref PipelineBuilder<T0, T1, T2> GroupBy(ulong component, Ecs.GroupByAction callback)
    {
    ...
    public ref PipelineBuilder<T0, T1, T2> GroupBy<T>(Ecs.GroupByAction callback)
    {
    ...
    ///
    public ref PipelineBuilder<T0, T1, T2> GroupByCtx(void* ctx, Ecs.ContextFree contextFree)
    {
    ...
    ///
    public ref PipelineBuilder<T0, T1, T2> GroupByCtx(void* ctx)
    {
    ...
    public ref PipelineBuilder<T0, T1, T2> OnGroupCreate(Ecs.GroupCreateAction onGroupCreate)
    {
    ...
    public ref PipelineBuilder<T0, T1, T2> OnGroupDelete(Ecs.GroupDeleteAction onGroupDelete)
    {
