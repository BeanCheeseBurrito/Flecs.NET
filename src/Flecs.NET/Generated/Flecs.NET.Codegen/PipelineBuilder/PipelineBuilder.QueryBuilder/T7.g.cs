// PipelineBuilder.QueryBuilder/T7.g.cs
...
public unsafe partial struct PipelineBuilder<T0, T1, T2, T3, T4, T5, T6>
{
    ...
    public ref PipelineBuilder<T0, T1, T2, T3, T4, T5, T6> OrderBy(ulong component, Ecs.OrderByAction compare)
    {
    ...
    public ref PipelineBuilder<T0, T1, T2, T3, T4, T5, T6> OrderBy<T>(Ecs.OrderByAction compare)
    {
    ...
    public ref PipelineBuilder<T0, T1, T2, T3, T4, T5, T6> GroupBy(ulong component, Ecs.GroupByAction callback)
    {
    ...
    public ref PipelineBuilder<T0, T1, T2, T3, T4, T5, T6> GroupBy<T>(Ecs.GroupByAction callback)
    {
    ...
    ///
    public ref PipelineBuilder<T0, T1, T2, T3, T4, T5, T6> GroupByCtx(void* ctx, Ecs.ContextFree contextFree)
    {
    ...
    ///
    public ref PipelineBuilder<T0, T1, T2, T3, T4, T5, T6> GroupByCtx(void* ctx)
    {
    ...
    public ref PipelineBuilder<T0, T1, T2, T3, T4, T5, T6> OnGroupCreate(Ecs.GroupCreateAction onGroupCreate)
    {
    ...
    public ref PipelineBuilder<T0, T1, T2, T3, T4, T5, T6> OnGroupDelete(Ecs.GroupDeleteAction onGroupDelete)
    {
