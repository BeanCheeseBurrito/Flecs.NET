...
internal static unsafe partial class Functions<T0, T1, T2, T3, T4, T5, T6>
{
    internal static void IterFieldCallbackDelegate(ecs_iter_t* iter)
    {
        ...
        Invoker.Iter(iter, (Ecs.IterFieldCallback<T0, T1, T2, T3, T4, T5, T6>)context->Callback.GcHandle.Target!);
    }

    internal static void IterSpanCallbackDelegate(ecs_iter_t* iter)
    {
        IteratorContext* context = (IteratorContext*)iter->callback_ctx;
        Invoker.Iter(iter, (Ecs.IterSpanCallback<T0, T1, T2, T3, T4, T5, T6>)context->Callback.GcHandle.Target!);
    }

    internal static void IterPointerCallbackDelegate(ecs_iter_t* iter)
    {
        IteratorContext* context = (IteratorContext*)iter->callback_ctx;
        Invoker.Iter(iter, (Ecs.IterPointerCallback<T0, T1, T2, T3, T4, T5, T6>)context->Callback.GcHandle.Target!);
    }
    ...
    {
        IteratorContext* context = (IteratorContext*)iter->callback_ctx;
        Invoker.Each(iter, (Ecs.EachRefCallback<T0, T1, T2, T3, T4, T5, T6>)context->Callback.GcHandle.Target!);
    }

    internal static void EachEntityRefCallbackDelegate(ecs_iter_t* iter)
    {
        IteratorContext* context = (IteratorContext*)iter->callback_ctx;
        Invoker.Each(iter, (Ecs.EachEntityRefCallback<T0, T1, T2, T3, T4, T5, T6>)context->Callback.GcHandle.Target!);
    }

    internal static void EachIterRefCallbackDelegate(ecs_iter_t* iter)
    {
        IteratorContext* context = (IteratorContext*)iter->callback_ctx;
        Invoker.Each(iter, (Ecs.EachIterRefCallback<T0, T1, T2, T3, T4, T5, T6>)context->Callback.GcHandle.Target!);
    }
    ...
    {
        IteratorContext* context = (IteratorContext*)iter->callback_ctx;
        Invoker.Each(iter, (Ecs.EachPointerCallback<T0, T1, T2, T3, T4, T5, T6>)context->Callback.GcHandle.Target!);
    }

    internal static void EachEntityPointerCallbackDelegate(ecs_iter_t* iter)
    {
        IteratorContext* context = (IteratorContext*)iter->callback_ctx;
        Invoker.Each(iter, (Ecs.EachEntityPointerCallback<T0, T1, T2, T3, T4, T5, T6>)context->Callback.GcHandle.Target!);
    }

    internal static void EachIterPointerCallbackDelegate(ecs_iter_t* iter)
    {
        IteratorContext* context = (IteratorContext*)iter->callback_ctx;
        Invoker.Each(iter, (Ecs.EachIterPointerCallback<T0, T1, T2, T3, T4, T5, T6>)context->Callback.GcHandle.Target!);
    }
