...
public unsafe partial struct Query
{
    ...
    {
        Invoker.Iter<Query, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(ref this, callback);
    }
    ...
    {
        Invoker.Each<Query, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(ref this, callback);
    }
    ...
    {
        return Invoker.Find<Query, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(ref this, callback);
    }
