...
public unsafe partial struct IterIterable
{
    ...
    {
        Invoker.Iter<IterIterable, T0, T1>(ref this, callback);
    }
    ...
    {
        Invoker.Each<IterIterable, T0, T1>(ref this, callback);
    }
    ...
    {
        return Invoker.Find<IterIterable, T0, T1>(ref this, callback);
    }
