...
public unsafe partial struct IterIterable
{
    ...
    {
        Invoker.Iter<IterIterable, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(ref this, callback);
    }
    ...
    {
        Invoker.Each<IterIterable, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(ref this, callback);
    }
    ...
    {
        return Invoker.Find<IterIterable, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(ref this, callback);
    }
