...
public unsafe partial struct PageIterable
{
    ...
    {
        Invoker.Iter<PageIterable, T0, T1, T2, T3, T4, T5, T6, T7>(ref this, callback);
    }
    ...
    {
        Invoker.Each<PageIterable, T0, T1, T2, T3, T4, T5, T6, T7>(ref this, callback);
    }
    ...
    {
        return Invoker.Find<PageIterable, T0, T1, T2, T3, T4, T5, T6, T7>(ref this, callback);
    }
