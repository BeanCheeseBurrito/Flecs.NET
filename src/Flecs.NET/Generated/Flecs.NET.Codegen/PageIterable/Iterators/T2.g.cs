...
public unsafe partial struct PageIterable
{
    ...
    {
        Invoker.Iter<PageIterable, T0, T1>(ref this, callback);
    }
    ...
    {
        Invoker.Each<PageIterable, T0, T1>(ref this, callback);
    }
    ...
    {
        return Invoker.Find<PageIterable, T0, T1>(ref this, callback);
    }
