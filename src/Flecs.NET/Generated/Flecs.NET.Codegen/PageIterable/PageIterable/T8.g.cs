...
public partial struct PageIterable<T0, T1, T2, T3, T4, T5, T6, T7> : IEquatable<PageIterable<T0, T1, T2, T3, T4, T5, T6, T7>>
{
...
public unsafe partial struct PageIterable<T0, T1, T2, T3, T4, T5, T6, T7> : IIterable<T0, T1, T2, T3, T4, T5, T6, T7>
{
    ...
    {
        return new PageIterable<T0, T1, T2, T3, T4, T5, T6, T7>(_pageIterable.Page(offset, limit));
    }
    
    /// <inheritdoc cref="PageIterable.Worker(int, int)"/>
    public WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7> Worker(int index, int count)
    {
        return new WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7>(_pageIterable.Worker(index, count));
    }
