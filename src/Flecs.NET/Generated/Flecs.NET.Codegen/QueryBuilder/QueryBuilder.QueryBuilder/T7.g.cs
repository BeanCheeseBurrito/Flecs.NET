// QueryBuilder.QueryBuilder/T7.g.cs
...
public unsafe partial struct QueryBuilder<T0, T1, T2, T3, T4, T5, T6>
{
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> OrderBy(ulong component, Ecs.OrderByAction compare)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> OrderBy<T>(Ecs.OrderByAction compare)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> GroupBy(ulong component, Ecs.GroupByAction callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> GroupBy<T>(Ecs.GroupByAction callback)
    {
    ...
    ///
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> GroupByCtx(void* ctx, Ecs.ContextFree contextFree)
    {
    ...
    ///
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> GroupByCtx(void* ctx)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> OnGroupCreate(Ecs.GroupCreateAction onGroupCreate)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> OnGroupDelete(Ecs.GroupDeleteAction onGroupDelete)
    {
