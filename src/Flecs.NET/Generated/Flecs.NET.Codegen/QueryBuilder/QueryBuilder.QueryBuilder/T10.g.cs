// QueryBuilder.QueryBuilder/T10.g.cs
...
public unsafe partial struct QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>
{
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> OrderBy(ulong component, Ecs.OrderByAction compare)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> OrderBy<T>(Ecs.OrderByAction compare)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> GroupBy(ulong component, Ecs.GroupByAction callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> GroupBy<T>(Ecs.GroupByAction callback)
    {
    ...
    ///
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> GroupByCtx(void* ctx, Ecs.ContextFree contextFree)
    {
    ...
    ///
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> GroupByCtx(void* ctx)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> OnGroupCreate(Ecs.GroupCreateAction onGroupCreate)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> OnGroupDelete(Ecs.GroupDeleteAction onGroupDelete)
    {
