// QueryBuilder.QueryBuilder/T1.g.cs
...
public unsafe partial struct QueryBuilder<T0>
{
    ...
    public ref QueryBuilder<T0> OrderBy(ulong component, Ecs.OrderByAction compare)
    {
    ...
    public ref QueryBuilder<T0> OrderBy<T>(Ecs.OrderByAction compare)
    {
    ...
    public ref QueryBuilder<T0> GroupBy(ulong component, Ecs.GroupByAction callback)
    {
    ...
    public ref QueryBuilder<T0> GroupBy<T>(Ecs.GroupByAction callback)
    {
    ...
    ///
    public ref QueryBuilder<T0> GroupByCtx(void* ctx, Ecs.ContextFree contextFree)
    {
    ...
    ///
    public ref QueryBuilder<T0> GroupByCtx(void* ctx)
    {
    ...
    public ref QueryBuilder<T0> OnGroupCreate(Ecs.GroupCreateAction onGroupCreate)
    {
    ...
    public ref QueryBuilder<T0> OnGroupDelete(Ecs.GroupDeleteAction onGroupDelete)
    {
