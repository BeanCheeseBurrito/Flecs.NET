...
public unsafe partial struct ObserverBuilder
{
    ...
    public Observer Iter<T0>(Ecs.IterFieldCallback<T0> callback) 
    {
    ...
    /// <param name="callback">The callback.</param>
    /// <typeparam name="T0">The T0 component type.</typeparam>
    public Observer Iter<T0>(Ecs.IterSpanCallback<T0> callback) where T0 : unmanaged
    {
    ...
    /// <param name="callback">The callback.</param>
    /// <typeparam name="T0">The T0 component type.</typeparam>
    public Observer Iter<T0>(Ecs.IterPointerCallback<T0> callback) where T0 : unmanaged
    {
    ...
    /// <param name="callback">The callback.</param>
    /// <typeparam name="T0">The T0 component type.</typeparam>
    public Observer Iter<T0>(delegate*<Iter, Field<T0>, void> callback) 
    {
    ...
    /// <param name="callback">The callback.</param>
    /// <typeparam name="T0">The T0 component type.</typeparam>
    public Observer Iter<T0>(delegate*<Iter, Span<T0>, void> callback) where T0 : unmanaged
    {
    ...
    /// <param name="callback">The callback.</param>
    /// <typeparam name="T0">The T0 component type.</typeparam>
    public Observer Iter<T0>(delegate*<Iter, T0*, void> callback) where T0 : unmanaged
    {
    ...
    /// <param name="callback">The callback.</param>
    /// <typeparam name="T0">The T0 component type.</typeparam>
    public Observer Each<T0>(Ecs.EachRefCallback<T0> callback) 
    {
    ...
    /// <param name="callback">The callback.</param>
    /// <typeparam name="T0">The T0 component type.</typeparam>
    public Observer Each<T0>(Ecs.EachEntityRefCallback<T0> callback) 
    {
    ...
    /// <param name="callback">The callback.</param>
    /// <typeparam name="T0">The T0 component type.</typeparam>
    public Observer Each<T0>(Ecs.EachIterRefCallback<T0> callback) 
    {
    ...
    /// <param name="callback">The callback.</param>
    /// <typeparam name="T0">The T0 component type.</typeparam>
    public Observer Each<T0>(delegate*<ref T0, void> callback) 
    {
    ...
    /// <param name="callback">The callback.</param>
    /// <typeparam name="T0">The T0 component type.</typeparam>
    public Observer Each<T0>(delegate*<Entity, ref T0, void> callback) 
    {
    ...
    /// <param name="callback">The callback.</param>
    /// <typeparam name="T0">The T0 component type.</typeparam>
    public Observer Each<T0>(delegate*<Iter, int, ref T0, void> callback) 
    {
    ...
    /// <param name="callback">The callback.</param>
    /// <typeparam name="T0">The T0 component type.</typeparam>
    public Observer Each<T0>(Ecs.EachPointerCallback<T0> callback) where T0 : unmanaged
    {
    ...
    /// <param name="callback">The callback.</param>
    /// <typeparam name="T0">The T0 component type.</typeparam>
    public Observer Each<T0>(Ecs.EachEntityPointerCallback<T0> callback) where T0 : unmanaged
    {
    ...
    /// <param name="callback">The callback.</param>
    /// <typeparam name="T0">The T0 component type.</typeparam>
    public Observer Each<T0>(Ecs.EachIterPointerCallback<T0> callback) where T0 : unmanaged
    {
    ...
    /// <param name="callback">The callback.</param>
    /// <typeparam name="T0">The T0 component type.</typeparam>
    public Observer Each<T0>(delegate*<T0*, void> callback) where T0 : unmanaged
    {
    ...
    /// <param name="callback">The callback.</param>
    /// <typeparam name="T0">The T0 component type.</typeparam>
    public Observer Each<T0>(delegate*<Entity, T0*, void> callback) where T0 : unmanaged
    {
    ...
    /// <param name="callback">The callback.</param>
    /// <typeparam name="T0">The T0 component type.</typeparam>
    public Observer Each<T0>(delegate*<Iter, int, T0*, void> callback) where T0 : unmanaged
    {
