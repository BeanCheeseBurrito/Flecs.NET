// ObserverBuilder.QueryBuilder/T6.g.cs
...
public unsafe partial struct ObserverBuilder<T0, T1, T2, T3, T4, T5>
{
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5> OrderBy(ulong component, Ecs.OrderByAction compare)
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5> OrderBy<T>(Ecs.OrderByAction compare)
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5> GroupBy(ulong component, Ecs.GroupByAction callback)
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5> GroupBy<T>(Ecs.GroupByAction callback)
    {
    ...
    ///
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5> GroupByCtx(void* ctx, Ecs.ContextFree contextFree)
    {
    ...
    ///
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5> GroupByCtx(void* ctx)
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5> OnGroupCreate(Ecs.GroupCreateAction onGroupCreate)
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5> OnGroupDelete(Ecs.GroupDeleteAction onGroupDelete)
    {
