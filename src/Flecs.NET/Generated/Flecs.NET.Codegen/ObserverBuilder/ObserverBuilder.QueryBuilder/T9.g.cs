// ObserverBuilder.QueryBuilder/T9.g.cs
...
public unsafe partial struct ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8>
{
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8> OrderBy(ulong component, Ecs.OrderByAction compare)
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8> OrderBy<T>(Ecs.OrderByAction compare)
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8> GroupBy(ulong component, Ecs.GroupByAction callback)
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8> GroupBy<T>(Ecs.GroupByAction callback)
    {
    ...
    ///
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8> GroupByCtx(void* ctx, Ecs.ContextFree contextFree)
    {
    ...
    ///
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8> GroupByCtx(void* ctx)
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8> OnGroupCreate(Ecs.GroupCreateAction onGroupCreate)
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8> OnGroupDelete(Ecs.GroupDeleteAction onGroupDelete)
    {
