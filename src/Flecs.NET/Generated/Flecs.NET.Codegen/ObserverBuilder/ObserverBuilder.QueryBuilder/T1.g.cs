// ObserverBuilder.QueryBuilder/T1.g.cs
...
public unsafe partial struct ObserverBuilder<T0>
{
    ...
    public ref ObserverBuilder<T0> OrderBy(ulong component, Ecs.OrderByAction compare)
    {
    ...
    public ref ObserverBuilder<T0> OrderBy<T>(Ecs.OrderByAction compare)
    {
    ...
    public ref ObserverBuilder<T0> GroupBy(ulong component, Ecs.GroupByAction callback)
    {
    ...
    public ref ObserverBuilder<T0> GroupBy<T>(Ecs.GroupByAction callback)
    {
    ...
    ///
    public ref ObserverBuilder<T0> GroupByCtx(void* ctx, Ecs.ContextFree contextFree)
    {
    ...
    ///
    public ref ObserverBuilder<T0> GroupByCtx(void* ctx)
    {
    ...
    public ref ObserverBuilder<T0> OnGroupCreate(Ecs.GroupCreateAction onGroupCreate)
    {
    ...
    public ref ObserverBuilder<T0> OnGroupDelete(Ecs.GroupDeleteAction onGroupDelete)
    {
