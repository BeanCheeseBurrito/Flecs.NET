// ObserverBuilder.QueryBuilder/T4.g.cs
...
public unsafe partial struct ObserverBuilder<T0, T1, T2, T3>
{
    ...
    public ref ObserverBuilder<T0, T1, T2, T3> OrderBy(ulong component, Ecs.OrderByAction compare)
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3> OrderBy<T>(Ecs.OrderByAction compare)
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3> GroupBy(ulong component, Ecs.GroupByAction callback)
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3> GroupBy<T>(Ecs.GroupByAction callback)
    {
    ...
    ///
    public ref ObserverBuilder<T0, T1, T2, T3> GroupByCtx(void* ctx, Ecs.ContextFree contextFree)
    {
    ...
    ///
    public ref ObserverBuilder<T0, T1, T2, T3> GroupByCtx(void* ctx)
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3> OnGroupCreate(Ecs.GroupCreateAction onGroupCreate)
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3> OnGroupDelete(Ecs.GroupDeleteAction onGroupDelete)
    {
