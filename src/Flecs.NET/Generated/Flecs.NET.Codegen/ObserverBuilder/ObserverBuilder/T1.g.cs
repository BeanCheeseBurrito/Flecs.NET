...
public unsafe partial struct ObserverBuilder<T0> : IDisposable, IEquatable<ObserverBuilder<T0>>, IQueryBuilder<ObserverBuilder<T0>, Observer<T0>>
{
    ...
    ///
    public ref ObserverBuilder<T0> Ctx(void* data)
    {
    ...
    private ref ObserverBuilder<T0> SetCallback<T>(T callback, IntPtr invoker) where T : Delegate
    {
        _observerBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    private ref ObserverBuilder<T0> SetCallback(IntPtr callback, IntPtr invoker)
    {
        _observerBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    private ref ObserverBuilder<T0> SetRun<T>(T callback, IntPtr invoker) where T : Delegate
    {
        _observerBuilder.SetRun(callback, invoker);
        return ref this;
    }

    private ref ObserverBuilder<T0> SetRun(IntPtr callback, IntPtr invoker)
    {
        _observerBuilder.SetRun(callback, invoker);
        return ref this;
    }
