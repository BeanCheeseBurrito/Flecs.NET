...
public unsafe partial struct ObserverBuilder<T0, T1, T2> : IDisposable, IEquatable<ObserverBuilder<T0, T1, T2>>, IQueryBuilder<ObserverBuilder<T0, T1, T2>, Observer<T0, T1, T2>>
{
    ...
    private ref ObserverBuilder<T0, T1, T2> SetCallback<T>(T callback, IntPtr invoker) where T : Delegate
    {
        _observerBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    private ref ObserverBuilder<T0, T1, T2> SetCallback(IntPtr callback, IntPtr invoker)
    {
        _observerBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    private ref ObserverBuilder<T0, T1, T2> SetRun<T>(T callback, IntPtr invoker) where T : Delegate
    {
        _observerBuilder.SetRun(callback, invoker);
        return ref this;
    }

    private ref ObserverBuilder<T0, T1, T2> SetRun(IntPtr callback, IntPtr invoker)
    {
        _observerBuilder.SetRun(callback, invoker);
        return ref this;
    }
