...
public unsafe partial struct ObserverBuilder<T0, T1, T2, T3, T4, T5, T6> : IDisposable, IEquatable<ObserverBuilder<T0, T1, T2, T3, T4, T5, T6>>, IQueryBuilder<ObserverBuilder<T0, T1, T2, T3, T4, T5, T6>, Observer<T0, T1, T2, T3, T4, T5, T6>>
{
    ...
    ///
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6> Ctx(void* data)
    {
    ...
    private ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6> SetCallback<T>(T callback, IntPtr invoker) where T : Delegate
    {
        _observerBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    private ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6> SetCallback(IntPtr callback, IntPtr invoker)
    {
        _observerBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    private ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6> SetRun<T>(T callback, IntPtr invoker) where T : Delegate
    {
        _observerBuilder.SetRun(callback, invoker);
        return ref this;
    }

    private ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6> SetRun(IntPtr callback, IntPtr invoker)
    {
        _observerBuilder.SetRun(callback, invoker);
        return ref this;
    }
