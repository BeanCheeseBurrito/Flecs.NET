...
public unsafe partial struct SystemBuilder<T0, T1, T2, T3, T4, T5> : IDisposable, IEquatable<SystemBuilder<T0, T1, T2, T3, T4, T5>>, IQueryBuilder<SystemBuilder<T0, T1, T2, T3, T4, T5>, System<T0, T1, T2, T3, T4, T5>>
{
    ...
    internal ref SystemBuilder<T0, T1, T2, T3, T4, T5> SetCallback<T>(T callback, IntPtr invoker) where T : Delegate
    {
        _systemBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0, T1, T2, T3, T4, T5> SetCallback(IntPtr callback, IntPtr invoker)
    {
        _systemBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0, T1, T2, T3, T4, T5> SetRun<T>(T callback, IntPtr invoker) where T : Delegate
    {
        _systemBuilder.SetRun(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0, T1, T2, T3, T4, T5> SetRun(IntPtr callback, IntPtr invoker)
    {
        _systemBuilder.SetRun(callback, invoker);
        return ref this;
    }
