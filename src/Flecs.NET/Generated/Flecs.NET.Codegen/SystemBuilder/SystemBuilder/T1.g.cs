...
public unsafe partial struct SystemBuilder<T0> : IDisposable, IEquatable<SystemBuilder<T0>>, IQueryBuilder<SystemBuilder<T0>, System<T0>>
{
    ...
    internal ref SystemBuilder<T0> SetCallback<T>(T callback, IntPtr invoker) where T : Delegate
    {
        _systemBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0> SetCallback(IntPtr callback, IntPtr invoker)
    {
        _systemBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0> SetRun<T>(T callback, IntPtr invoker) where T : Delegate
    {
        _systemBuilder.SetRun(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0> SetRun(IntPtr callback, IntPtr invoker)
    {
        _systemBuilder.SetRun(callback, invoker);
        return ref this;
    }
