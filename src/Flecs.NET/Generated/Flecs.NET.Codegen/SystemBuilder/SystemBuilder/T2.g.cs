...
public unsafe partial struct SystemBuilder<T0, T1> : IDisposable, IEquatable<SystemBuilder<T0, T1>>, IQueryBuilder<SystemBuilder<T0, T1>, System<T0, T1>>
{
    ...
    internal ref SystemBuilder<T0, T1> SetCallback<T>(T callback, IntPtr invoker) where T : Delegate
    {
        _systemBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0, T1> SetCallback(IntPtr callback, IntPtr invoker)
    {
        _systemBuilder.SetCallback(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0, T1> SetRun<T>(T callback, IntPtr invoker) where T : Delegate
    {
        _systemBuilder.SetRun(callback, invoker);
        return ref this;
    }

    internal ref SystemBuilder<T0, T1> SetRun(IntPtr callback, IntPtr invoker)
    {
        _systemBuilder.SetRun(callback, invoker);
        return ref this;
    }
