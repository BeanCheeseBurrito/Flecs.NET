// SystemBuilder.QueryBuilder/T5.g.cs
...
public unsafe partial struct SystemBuilder<T0, T1, T2, T3, T4>
{
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> OrderBy(ulong component, Ecs.OrderByAction compare)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> OrderBy<T>(Ecs.OrderByAction compare)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> GroupBy(ulong component, Ecs.GroupByAction callback)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> GroupBy<T>(Ecs.GroupByAction callback)
    {
    ...
    ///
    public ref SystemBuilder<T0, T1, T2, T3, T4> GroupByCtx(void* ctx, Ecs.ContextFree contextFree)
    {
    ...
    ///
    public ref SystemBuilder<T0, T1, T2, T3, T4> GroupByCtx(void* ctx)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> OnGroupCreate(Ecs.GroupCreateAction onGroupCreate)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> OnGroupDelete(Ecs.GroupDeleteAction onGroupDelete)
    {
