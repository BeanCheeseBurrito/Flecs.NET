// SystemBuilder.QueryBuilder/T1.g.cs
...
public unsafe partial struct SystemBuilder<T0>
{
    ...
    public ref SystemBuilder<T0> OrderBy(ulong component, Ecs.OrderByAction compare)
    {
    ...
    public ref SystemBuilder<T0> OrderBy<T>(Ecs.OrderByAction compare)
    {
    ...
    public ref SystemBuilder<T0> GroupBy(ulong component, Ecs.GroupByAction callback)
    {
    ...
    public ref SystemBuilder<T0> GroupBy<T>(Ecs.GroupByAction callback)
    {
    ...
    ///
    public ref SystemBuilder<T0> GroupByCtx(void* ctx, Ecs.ContextFree contextFree)
    {
    ...
    ///
    public ref SystemBuilder<T0> GroupByCtx(void* ctx)
    {
    ...
    public ref SystemBuilder<T0> OnGroupCreate(Ecs.GroupCreateAction onGroupCreate)
    {
    ...
    public ref SystemBuilder<T0> OnGroupDelete(Ecs.GroupDeleteAction onGroupDelete)
    {
