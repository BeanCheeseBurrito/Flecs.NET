...
public unsafe partial struct World
{
    ...
    public RoutineBuilder<T0, T1, T2, T3, T4> Routine<T0, T1, T2, T3, T4>()
    {
        return new RoutineBuilder<T0, T1, T2, T3, T4>(Handle);
    }

    public RoutineBuilder<T0, T1, T2, T3, T4> Routine<T0, T1, T2, T3, T4>(string name)
    {
        return new RoutineBuilder<T0, T1, T2, T3, T4>(Handle, name);
    }
