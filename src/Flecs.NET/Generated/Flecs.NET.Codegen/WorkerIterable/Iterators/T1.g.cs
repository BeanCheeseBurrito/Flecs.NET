...
public unsafe partial struct WorkerIterable
{
    ...
    {
        Invoker.Iter<WorkerIterable, T0>(ref this, callback);
    }
    ...
    {
        Invoker.Each<WorkerIterable, T0>(ref this, callback);
    }
    ...
    {
        return Invoker.Find<WorkerIterable, T0>(ref this, callback);
    }
