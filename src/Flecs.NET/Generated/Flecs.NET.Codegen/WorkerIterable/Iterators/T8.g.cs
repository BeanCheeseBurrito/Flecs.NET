...
public unsafe partial struct WorkerIterable
{
    ...
    {
        Invoker.Iter<WorkerIterable, T0, T1, T2, T3, T4, T5, T6, T7>(ref this, callback);
    }
    ...
    {
        Invoker.Each<WorkerIterable, T0, T1, T2, T3, T4, T5, T6, T7>(ref this, callback);
    }
    ...
    {
        return Invoker.Find<WorkerIterable, T0, T1, T2, T3, T4, T5, T6, T7>(ref this, callback);
    }
