...
public partial struct WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8> : IEquatable<WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8>>
{
...
public unsafe partial struct WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8> : IIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8>
{
    ...
    {
        return new PageIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8>(_workerIterable.Page(offset, limit));
    }
    
    /// <inheritdoc cref="WorkerIterable.Worker(int, int)"/>
    public WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8> Worker(int index, int count)
    {
        return new WorkerIterable<T0, T1, T2, T3, T4, T5, T6, T7, T8>(_workerIterable.Worker(index, count));
    }
