// /_/src/Flecs.NET/Generated/Component/Component.Entity.g.cs
// File was auto-generated by /_/src/Flecs.NET.Codegen/Generators/Component.cs
using System;
...
public unsafe partial struct Component<TComponent>
{
    ...
    public ref Component<TComponent> Add(ulong id)
    {
        Entity.Add(id);
        return ref this;
    }
    ...
    public ref Component<TComponent> Add(ulong first, ulong second)
    {
    ...
    public ref Component<TComponent> Add<T>()
    {
        Entity.Add<T>();
        return ref this;
    }
    ...
    public ref Component<TComponent> Add<TFirst>(ulong second)
    {
    ...
    public ref Component<TComponent> Add<T>(T value) where T : Enum
    {
        Entity.Add(value);
        return ref this;
    }
    ...
    public ref Component<TComponent> Add<TFirst, TSecond>()
    {
    ...
    public ref Component<TComponent> Add<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref Component<TComponent> Add<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref Component<TComponent> AddSecond<TSecond>(ulong first)
    {
    ...
    public ref Component<TComponent> AddIf(bool cond, ulong id)
    {
    ...
    public ref Component<TComponent> AddIf(bool cond, ulong first, ulong second)
    {
    ...
    public ref Component<TComponent> AddIf<T>(bool cond)
    {
        Entity.AddIf<T>(cond);
        return ref this;
    }
    ...
    public ref Component<TComponent> AddIf<T>(bool cond, T value) where T : Enum
    {
    ...
    public ref Component<TComponent> AddIf<TFirst>(bool cond, ulong second)
    {
    ...
    public ref Component<TComponent> AddIf<TFirst, TSecond>(bool cond)
    {
    ...
    public ref Component<TComponent> AddIf<TFirst, TSecond>(bool cond, TSecond second) where TSecond : Enum
    {
    ...
    public ref Component<TComponent> AddIf<TFirst, TSecond>(bool cond, TFirst first) where TFirst : Enum
    {
    ...
    public ref Component<TComponent> AddIfSecond<TSecond>(bool cond, ulong first)
    {
    ...
    public ref Component<TComponent> IsA(ulong id)
    {
        Entity.IsA(id);
        return ref this;
    }
    ...
    public ref Component<TComponent> IsA<T>()
    {
        Entity.IsA<T>();
        return ref this;
    }
    ...
    public ref Component<TComponent> IsA<T>(T value) where T : Enum
    {
        Entity.IsA(value);
        return ref this;
    }
    ...
    public ref Component<TComponent> ChildOf(ulong second)
    {
    ...
    public ref Component<TComponent> ChildOf<T>()
    {
        Entity.ChildOf<T>();
        return ref this;
    }
    ...
    public ref Component<TComponent> ChildOf<T>(T value) where T : Enum
    {
    ...
    public ref Component<TComponent> DependsOn(ulong second)
    {
    ...
    public ref Component<TComponent> DependsOn<T>()
    {
        Entity.DependsOn<T>();
        return ref this;
    }
    ...
    public ref Component<TComponent> DependsOn<T>(T value) where T : Enum
    {
    ...
    public ref Component<TComponent> SlotOf(ulong id)
    {
        Entity.SlotOf(id);
        return ref this;
    }
    ...
    public ref Component<TComponent> SlotOf<T>()
    {
        Entity.SlotOf<T>();
        return ref this;
    }
    ...
    public ref Component<TComponent> SlotOf<T>(T value) where T : Enum
    {
        Entity.SlotOf(value);
        return ref this;
    }
    ...
    public ref Component<TComponent> Slot()
    {
        Entity.Slot();
        return ref this;
    }
    ...
    public ref Component<TComponent> Remove(ulong id)
    {
        Entity.Remove(id);
        return ref this;
    }
    ...
    public ref Component<TComponent> Remove(ulong first, ulong second)
    {
    ...
    public ref Component<TComponent> Remove<T>()
    {
        Entity.Remove<T>();
        return ref this;
    }
    ...
    public ref Component<TComponent> Remove<T>(T value) where T : Enum
    {
        Entity.Remove(value);
        return ref this;
    }
    ...
    public ref Component<TComponent> Remove<TFirst>(ulong second)
    {
    ...
    public ref Component<TComponent> Remove<TFirst, TSecond>()
    {
    ...
    public ref Component<TComponent> Remove<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref Component<TComponent> Remove<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref Component<TComponent> RemoveSecond<TSecond>(ulong first)
    {
    ...
    public ref Component<TComponent> AutoOverride(ulong id)
    {
    ...
    public ref Component<TComponent> AutoOverride(ulong first, ulong second)
    {
    ...
    public ref Component<TComponent> AutoOverride<T>()
    {
    ...
    public ref Component<TComponent> AutoOverride<T>(T value) where T : Enum
    {
    ...
    public ref Component<TComponent> AutoOverride<TFirst>(ulong second)
    {
    ...
    public ref Component<TComponent> AutoOverride<TFirst, TSecond>()
    {
    ...
    public ref Component<TComponent> AutoOverride<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref Component<TComponent> AutoOverride<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref Component<TComponent> AutoOverrideSecond<TSecond>(ulong first)
    {
    ...
    public ref Component<TComponent> Enable()
    {
        Entity.Enable();
        return ref this;
    }
    ...
    public ref Component<TComponent> Enable(ulong id)
    {
        Entity.Enable(id);
        return ref this;
    }
    ...
    public ref Component<TComponent> Enable(ulong first, ulong second)
    {
    ...
    public ref Component<TComponent> Enable<T>()
    {
        Entity.Enable<T>();
        return ref this;
    }
    ...
    public ref Component<TComponent> Enable<T>(T value) where T : Enum
    {
        Entity.Enable(value);
        return ref this;
    }
    ...
    public ref Component<TComponent> Enable<TFirst>(ulong second)
    {
    ...
    public ref Component<TComponent> Enable<TFirst, TSecond>()
    {
    ...
    public ref Component<TComponent> Enable<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref Component<TComponent> Enable<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref Component<TComponent> EnableSecond<TSecond>(ulong first)
    {
    ...
    public ref Component<TComponent> Disable()
    {
        Entity.Disable();
        return ref this;
    }
    ...
    public ref Component<TComponent> Disable(ulong id)
    {
        Entity.Disable(id);
        return ref this;
    }
    ...
    public ref Component<TComponent> Disable(ulong first, ulong second)
    {
    ...
    public ref Component<TComponent> Disable<T>()
    {
        Entity.Disable<T>();
        return ref this;
    }
    ...
    public ref Component<TComponent> Disable<T>(T value) where T : Enum
    {
    ...
    public ref Component<TComponent> Disable<TFirst>(ulong second)
    {
    ...
    public ref Component<TComponent> Disable<TFirst, TSecond>()
    {
    ...
    public ref Component<TComponent> Disable<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref Component<TComponent> Disable<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref Component<TComponent> DisableSecond<TSecond>(ulong first)
    {
    ...
    ///
    public ref Component<TComponent> SetUntyped(ulong id, int size, void* data)
    {
    ...
    ///
    public ref Component<TComponent> SetUntyped(ulong id, void* data)
    {
    ...
    ///
    public ref Component<TComponent> SetUntyped(ulong first, ulong second, int size, void* data)
    {
    ...
    public ref Component<TComponent> SetPtr<T>(T* data)
    {
        Entity.SetPtr(data);
        return ref this;
    }
    ...
    public ref Component<TComponent> SetPtr<TFirst>(ulong second, TFirst* data)
    {
    ...
    public ref Component<TComponent> SetPtr<TFirst, TSecond>(TSecond* data)
    {
    ...
    public ref Component<TComponent> SetPtr<TFirst, TSecond>(TFirst* data)
    {
        Entity.SetPtr<TFirst, TSecond>(data);
        return ref this;
    }
    ...
    public ref Component<TComponent> SetPtr<TFirst, TSecond>(TSecond second, TFirst* data) where TSecond : Enum
    {
    ...
    public ref Component<TComponent> SetPtr<TFirst, TSecond>(TFirst first, TSecond* data) where TFirst : Enum
    {
    ...
    public ref Component<TComponent> SetPtrSecond<TSecond>(ulong first, TSecond* data)
    {
    ...
    public ref Component<TComponent> With(Action callback)
    {
    ...
    public ref Component<TComponent> With(ulong first, Action callback)
    {
    ...
    public ref Component<TComponent> With<TFirst>(Action callback)
    {
    ...
    public ref Component<TComponent> With(Ecs.WorldCallback callback)
    {
        Entity.With(callback);
        return ref this;
    }
    ...
    public ref Component<TComponent> With(ulong first, Ecs.WorldCallback callback)
    {
        Entity.With(first, callback);
        return ref this;
    }
    ...
    public ref Component<TComponent> With<TFirst>(Ecs.WorldCallback callback)
    {
        Entity.With<TFirst>(callback);
        return ref this;
    }
    ...
    public ref Component<TComponent> Scope(Action callback)
    {
    ...
    public ref Component<TComponent> Scope(Ecs.WorldCallback callback)
    {
        Entity.Scope(callback);
        return ref this;
    }
    ...
    public ref Component<TComponent> SetName(string name)
    {
        Entity.SetName(name);
        return ref this;
    }
    ...
    public ref Component<TComponent> SetAlias(string alias)
    {
    ...
    public ref Component<TComponent> SetDocName(string name)
    {
    ...
    public ref Component<TComponent> SetDocBrief(string brief)
    {
    ...
    public ref Component<TComponent> SetDocDetail(string detail)
    {
    ...
    public ref Component<TComponent> SetDocLink(string link)
    {
    ...
    public ref Component<TComponent> SetDocColor(string color)
    {
    ...
    public ref Component<TComponent> SetDocUuid(string uuid)
    {
    ...
    public ref Component<TComponent> Unit(
        string symbol,
        ulong prefix = 0,
        ulong @base = 0,
        ulong over = 0,
    ...
    public ref Component<TComponent> UnitPrefix(string symbol, int factor = 0, int power = 0)
    {
    ...
    public ref Component<TComponent> Quantity(ulong quantity)
    {
    ...
    public ref Component<TComponent> Quantity<T>()
    {
        Entity.Quantity<T>();
        return ref this;
    }
    ...
    public ref Component<TComponent> Quantity()
    {
        Entity.Quantity();
        return ref this;
    }
    ...
    public ref Component<TComponent> SetJson(ulong e, string json, ecs_from_json_desc_t* desc = null)
    {
    ...
    public ref Component<TComponent> SetJson(ulong first, ulong second, string json, ecs_from_json_desc_t* desc = null)
    {
    ...
    public ref Component<TComponent> SetJson<T>(string json, ecs_from_json_desc_t* desc = null)
    {
    ...
    public ref Component<TComponent> SetJson<TFirst>(ulong second, string json, ecs_from_json_desc_t* desc = null)
    {
    ...
    public ref Component<TComponent> SetJson<TFirst, TSecond>(string json, ecs_from_json_desc_t* desc = null)
    {
    ...
    public ref Component<TComponent> SetJson<TFirst, TSecond>(TSecond second, string json, ecs_from_json_desc_t* desc = null) where TSecond : Enum
    {
    ...
    public ref Component<TComponent> SetJson<TFirst, TSecond>(TFirst first, string json, ecs_from_json_desc_t* desc = null) where TFirst : Enum
    {
    ...
    public ref Component<TComponent> SetJsonSecond<TSecond>(ulong first, string json, ecs_from_json_desc_t* desc = null)
    {
    ...
    public ref Component<TComponent> Observe(ulong eventId, Action callback)
    {
    ...
    public ref Component<TComponent> Observe(ulong eventId, Ecs.ObserveEntityCallback callback)
    {
        Entity.Observe(eventId, callback);
        return ref this;
    }
    ...
    public ref Component<TComponent> Observe<T>(Action callback)
    {
    ...
    public ref Component<TComponent> Observe<T>(Ecs.ObserveEntityCallback callback)
    {
        Entity.Observe<T>(callback);
        return ref this;
    }
    ...
    public ref Component<TComponent> Observe<T>(Ecs.ObserveRefCallback<T> callback)
    {
    ...
    public ref Component<TComponent> Observe<T>(Ecs.ObserveEntityRefCallback<T> callback)
    {
        Entity.Observe(callback);
        return ref this;
    }
