...
public class Ecs : IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        context.RegisterPostInitializationOutput((IncrementalGeneratorPostInitializationContext postContext) =>
        {
            ...
            {
                Generator.AddSource(postContext, $"Delegates/T{i + 1}.g.cs", GenerateDelegates(i));
                Generator.AddSource(postContext, $"FetchPointers/T{i + 1}.g.cs", GenerateFetchPointers(i));
            }
        });
    }
