...
public class PageIterable : IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        context.RegisterPostInitializationOutput((IncrementalGeneratorPostInitializationContext postContext) =>
        {
            ...
            {
                Generator.AddSource(postContext, $"PageIterable/T{i + 1}.g.cs", GeneratePageIterable(i));
                Generator.AddSource(postContext, $"PageIterable.IIterable/T{i + 1}.g.cs", IIterable.GenerateExtensions(Type.PageIterable, i));
            }
        });
    }
