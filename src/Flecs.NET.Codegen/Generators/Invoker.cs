...
public class Invoker : GeneratorBase
{
    public override void Generate()
    {
        ...
        {
            // Iterator Invokers
            AddSource($"Iter/Iterator/T{i + 1}.g.cs", GenerateIterIteratorInvokers(i));
            AddSource($"Each/Iterator/T{i + 1}.g.cs", GenerateEachIteratorInvokers(i));
            ...
            AddSource($"FetchComponents/T{i + 1}.g.cs", GenerateFetchComponentInvokers(i));
        }
    }
