...
public class WorkerIterable : IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        context.RegisterPostInitializationOutput((IncrementalGeneratorPostInitializationContext postContext) =>
        {
            ...
            {
                Generator.AddSource(postContext, $"WorkerIterable/T{i + 1}.g.cs", GenerateWorkerIterable(i));
                Generator.AddSource(postContext, $"WorkerIterable.IIterable/T{i + 1}.g.cs", IIterable.GenerateExtensions(Type.WorkerIterable, i));
            }
        });
    }
