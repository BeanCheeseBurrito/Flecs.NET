...
public class IterIterable : IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        context.RegisterPostInitializationOutput((IncrementalGeneratorPostInitializationContext postContext) =>
        {
            ...
            {
                Generator.AddSource(postContext, $"IterIterable/T{i + 1}.g.cs", GenerateIterIterable(i));
                Generator.AddSource(postContext, $"IterIterable.IIterable/T{i + 1}.g.cs", IIterable.GenerateExtensions(Type.IterIterable, i));
            }
        });
    }
